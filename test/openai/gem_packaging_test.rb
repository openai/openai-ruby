...
class OpenAI::Test::GemPackagingTest < Minitest::Test
  ...
  def test_packages_every_relative_readme_link
    ...
    Dir.mktmpdir("openai-gem-packaging-test") do |directory|
      ...
      assert_includes(package.contents, "docs/architecture/security-model.md")
      ...
      assert_includes(package.contents, "examples/realtime/sideband.rb")
      assert_includes(package.contents, "lib/openai/helpers/realtime/sideband_connection.rb")
      assert_includes(package.contents, "rbi/openai/helpers/realtime/sideband_connection.rbi")
      assert_includes(package.contents, "sig/openai/helpers/realtime/sideband_connection.rbs")
