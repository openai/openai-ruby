...
class OpenAI::Test::Resources::Beta::Agents::Sessions::Subagents::ItemsTest < OpenAI::Test::ResourceTest
  def test_list_required_params
    response = @openai.beta.agents.sessions.subagents.items.list("subagent_id", session_id: "session_id")
