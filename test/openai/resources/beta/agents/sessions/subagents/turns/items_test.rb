...
class OpenAI::Test::Resources::Beta::Agents::Sessions::Subagents::Turns::ItemsTest < OpenAI::Test::ResourceTest
  def test_list_required_params
    response = @openai.beta.agents.sessions.subagents.turns.items.list(
      "turn_id",
