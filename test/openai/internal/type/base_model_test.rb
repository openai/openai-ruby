...
class OpenAI::Test::PrimitiveModelTest < Minitest::Test
  ...
  def test_coerce
    cases = {
      ...
      [OpenAI::Internal::Type::BooleanModel, true] => [{yes: 1}, true],
      [OpenAI::Internal::Type::BooleanModel, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
  ...
  def test_dump
    cases = {
      ...
      [OpenAI::Internal::Type::BooleanModel, true] => true,
      [OpenAI::Internal::Type::BooleanModel, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
...
class OpenAI::Test::BaseModelQoLTest < Minitest::Test
  ...
  def test_equality
    cases = {
      ...
      [OpenAI::Internal::Type::BooleanModel, OpenAI::Internal::Type::BooleanModel] => true,
      [OpenAI::Internal::Type::Unknown, OpenAI::Internal::Type::BooleanModel] => false,
      [E1, E2] => true,
      [E1, E3] => false,
      [M1, M2] => false,
      [M1, M3] => true
