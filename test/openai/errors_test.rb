...
class OpenAI::Test::ErrorsTest < Minitest::Test
  ...
  def test_sensitive_request_ids_are_omitted_without_altering_raw_headers
    ...
    request_ids = [
      ...
      "api-key-secretvalue123-req-1",
      "client-secret-opaquevalue123-req-1",
      "access-token-abcdefgh12345678-req-1",
      "private-key-secretvalue123-trace-1",
      "refresh-token-opaquevalue123-req-1",
      "user-prompt-privatevalue123-req-1",
      "customer-content-privatevalue123-req-1",
      "model-response-privatevalue123-trace-1",
      "input-text-privatevalue123-req-1",
      "unknown-service-secretvalue123-req-1",
      "service-req-secretvalue123",
      "service-trace-password123",
      "customer-support-req-opaqueprovidercredential123",
      "customer-support-req-customerdata123",
      "email-delivery-req-accesstoken123",
      "data-center-req-clientsecret123",
      "response-service-trace-privateresponse123",
      "input-validator-req-userprompt123",
      "SERVICE-REQ-SECRETVALUE123",
  ...
  def test_ordinary_request_id_formats_remain_visible
    request_ids = [
      ...
      "service-req-123",
      "service-trace-123",
      "service-req-deadbeef123",
      "SERVICE-TRACE-ABCD1234",
