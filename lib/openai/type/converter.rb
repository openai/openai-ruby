    ...
    module Converter
      ...
      class << self
        ...
        def type_info(spec)
          ...
          in true | false
            -> { OpenAI::BooleanModel }
          in OpenAI::Type::Converter | Class | Symbol
            -> { spec }
        ...
        #
        # @param target [OpenAI::Type::Converter, Class]
        #
        # @param value [Object]
        #
        ...
        def dump(target, value)
          target.is_a?(OpenAI::Type::Converter) ? target.dump(value) : OpenAI::Unknown.dump(value)
        end
      end
    end
  end
