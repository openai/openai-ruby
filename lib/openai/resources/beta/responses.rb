  ...
  module Resources
    class Beta
      class Responses
        ...
        #
        # @param model [Symbol, String, OpenAI::Models::Beta::ResponseCreateParams::Model] Body param: Model ID used to generate the response, like `gpt-6-astra`. OpenAI
        #
        ...
        #
        # @param model [Symbol, String, OpenAI::Models::Beta::ResponseCompactParams::Model, nil] Body param: Model ID used to generate the response, like `gpt-6-astra`. OpenAI o
        #
