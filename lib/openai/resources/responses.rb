  ...
  module Resources
    class Responses
      ...
      class WithRawResponse
        # @return [OpenAI::Resources::Responses::InputItems::WithRawResponse]
        attr_reader :input_items

        # @return [OpenAI::Resources::Responses::InputTokens::WithRawResponse]
        attr_reader :input_tokens
        ...
        def initialize(resource:)
          ...
          @input_items =
            OpenAI::Resources::Responses::InputItems::WithRawResponse.new(
              resource: @resource.input_items
            )

          @input_tokens =
            OpenAI::Resources::Responses::InputTokens::WithRawResponse.new(
