  ...
  module Models
    module Chat
      class ChatCompletionNamedToolChoice < OpenAI::Internal::Type::BaseModel
        # @!attribute function
        #
        #   @return [OpenAI::Chat::ChatCompletionNamedToolChoice::Function]
        ...
        #   function.
        #
        #   @param function [OpenAI::Chat::ChatCompletionNamedToolChoice::Function]
        #
        #   @param type [Symbol, :function] The type of the tool. Currently, only `function` is supported.

        # @see OpenAI::Chat::ChatCompletionNamedToolChoice#function
