  ...
  module Models
    module Chat
      class ChatCompletionChunk < OpenAI::BaseModel
        ...
        required :choices, -> { OpenAI::ArrayOf[OpenAI::Models::Chat::ChatCompletionChunk::Choice] }
        ...
        class Choice < OpenAI::BaseModel
          ...
          class Delta < OpenAI::BaseModel
            ...
            optional :tool_calls,
                     -> { OpenAI::ArrayOf[OpenAI::Models::Chat::ChatCompletionChunk::Choice::Delta::ToolCall] }
