  ...
  module Models
    module Chat
      ...
      class ChatCompletion < OpenAI::Internal::Type::BaseModel
        ...
        #   than 1.
        #
        #   @return [Array<OpenAI::Chat::ChatCompletion::Choice>]
        ...
        #   utilized.
        #
        #   @return [Symbol, OpenAI::Chat::ChatCompletion::ServiceTier, nil]
        ...
        #   {OpenAI::Chat::ChatCompletion} for more details.
        #
        ...
        #
        #   @param choices [Array<OpenAI::Chat::ChatCompletion::Choice>] A list of chat completion choices. Can be more than one if `n` is greater than 1
        #
        ...
        #
        #   @param service_tier [Symbol, OpenAI::Chat::ChatCompletion::ServiceTier, nil] Specifies the latency tier to use for processing the request. This parameter is
        #
        ...
        class Choice < OpenAI::Internal::Type::BaseModel
          ...
          #   function.
          #
          #   @return [Symbol, OpenAI::Chat::ChatCompletion::Choice::FinishReason]
          ...
          #
          #   @return [OpenAI::Chat::ChatCompletion::Choice::Logprobs, nil]
          required :logprobs, -> { OpenAI::Chat::ChatCompletion::Choice::Logprobs }, nil?: true

          # @!attribute message
          #   A chat completion message generated by the model.
          #
          #   @return [OpenAI::Chat::ChatCompletionMessage]
          required :message, -> { OpenAI::Chat::ChatCompletionMessage }

          # @!method initialize(finish_reason:, index:, logprobs:, message:)
          #   Some parameter documentations has been truncated, see
          #   {OpenAI::Chat::ChatCompletion::Choice} for more details.
          #
          #   @param finish_reason [Symbol, OpenAI::Chat::ChatCompletion::Choice::FinishReason] The reason the model stopped generating tokens. This will be `stop` if the model
          #
          #   @param index [Integer] The index of the choice in the list of choices.
          #
          #   @param logprobs [OpenAI::Chat::ChatCompletion::Choice::Logprobs, nil] Log probability information for the choice.
          #
          #   @param message [OpenAI::Chat::ChatCompletionMessage] A chat completion message generated by the model.
          ...
          # function.
          #
          # @see OpenAI::Chat::ChatCompletion::Choice#finish_reason
          module FinishReason
          ...
          # @see OpenAI::Chat::ChatCompletion::Choice#logprobs
        ...
        # utilized.
        #
        # @see OpenAI::Chat::ChatCompletion#service_tier
        module ServiceTier
          extend OpenAI::Internal::Type::Enum
