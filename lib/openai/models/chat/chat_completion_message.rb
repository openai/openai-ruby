  ...
  module Models
    module Chat
      class ChatCompletionMessage < OpenAI::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<OpenAI::Chat::ChatCompletionMessage::Annotation>, nil]
        ...
        #
        #   @return [OpenAI::Chat::ChatCompletionAudio, nil]
        ...
        #
        #   @return [OpenAI::Chat::ChatCompletionMessage::FunctionCall, nil]
        ...
        #   {OpenAI::Chat::ChatCompletionMessage} for more details.
        #
        ...
        #
        #   @param annotations [Array<OpenAI::Chat::ChatCompletionMessage::Annotation>] Annotations for the message, when applicable, as when using the
        #
        #   @param audio [OpenAI::Chat::ChatCompletionAudio, nil] If the audio output modality is requested, this object contains data
        #
        #   @param function_call [OpenAI::Chat::ChatCompletionMessage::FunctionCall] Deprecated and replaced by `tool_calls`. The name and arguments of a function th
        #
        ...
        class Annotation < OpenAI::Internal::Type::BaseModel
          ...
          #
          #   @return [OpenAI::Chat::ChatCompletionMessage::Annotation::URLCitation]
          ...
          #   A URL citation when using web search.
          #
          #   @param url_citation [OpenAI::Chat::ChatCompletionMessage::Annotation::URLCitation] A URL citation when using web search.
          #
          #   @param type [Symbol, :url_citation] The type of the URL citation. Always `url_citation`.

          # @see OpenAI::Chat::ChatCompletionMessage::Annotation#url_citation
        ...
        # @deprecated
        #
        # @see OpenAI::Chat::ChatCompletionMessage#function_call
        class FunctionCall < OpenAI::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {OpenAI::Chat::ChatCompletionMessage::FunctionCall} for more details.
          #
          #   Deprecated and replaced by `tool_calls`. The name and arguments of a function
          #   that should be called, as generated by the model.
          #
