  ...
  module Models
    module Chat
      ...
      class CompletionCreateParams < OpenAI::Internal::Type::BaseModel
        ...
        #     model-specific support.
        #
        #   @param response_format [OpenAI::Models::ResponseFormatText, OpenAI::Models::ResponseFormatJSONSchema, OpenAI::StructuredOutput::JsonSchemaConverter, OpenAI::Models::ResponseFormatJSONObject]
        #     An object specifying the format that the model must output.
        #
        #     Setting to `{ "type": "json_schema", "json_schema": {...} }` enables Structured
        #     Outputs which ensures the model will match your supplied JSON schema. Learn more
        ...
        #     are present.
        #
        #   @param tools [Array<OpenAI::StructuredOutput::JsonSchemaConverter, OpenAI::Models::Chat::ChatCompletionFunctionTool, OpenAI::Models::Chat::ChatCompletionCustomTool>]
        #     A list of tools the model may call. You can provide either
        #     [custom tools](https://developers.openai.com/api/docs/guides/function-calling#custom-tools)
        #     or
        #     [function tools](https://developers.openai.com/api/docs/guides/function-calling).
        ...
        class Moderation < OpenAI::Internal::Type::BaseModel
          ...
          #     'omni-moderation-latest'.
          #
          #   @param policy [OpenAI::Models::Chat::CompletionCreateParams::Moderation::Policy, nil]
          #     The policy to apply to moderated response input and output.
          ...
          class Policy < OpenAI::Internal::Type::BaseModel
            ...
            #   The policy to apply to moderated response input and output.
            #
            #   @param input [OpenAI::Models::Chat::CompletionCreateParams::Moderation::Policy::Input, nil]
            #     The moderation policy for the response input.
            #
            #   @param output [OpenAI::Models::Chat::CompletionCreateParams::Moderation::Policy::Output, nil]
            #     The moderation policy for the response output.
        ...
        class PromptCacheOptions < OpenAI::Internal::Type::BaseModel
          ...
          #   for current details.
          #
          #   @param mode [Symbol, OpenAI::Models::Chat::CompletionCreateParams::PromptCacheOptions::Mode]
          #     Controls whether OpenAI automatically creates an implicit cache breakpoint.
          #     Defaults to `implicit`. With `implicit`, OpenAI creates one implicit breakpoint
          #     and writes up to the latest three explicit breakpoints in the request. With
          #     `explicit`, OpenAI does not create an implicit breakpoint and writes up to the
          ...
          #     request does not use prompt caching.
          #
          #   @param ttl [Symbol, OpenAI::Models::Chat::CompletionCreateParams::PromptCacheOptions::Ttl]
          #     The minimum lifetime applied to every implicit and explicit cache breakpoint
          #     written by the request. Defaults to `30m`, which is currently the only supported
          #     value. The backend may retain cache entries for longer.
