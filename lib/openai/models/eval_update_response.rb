...
module OpenAI
  module Models
    ...
    class EvalUpdateResponse < OpenAI::Internal::Type::BaseModel
      ...
      #     The Unix timestamp (in seconds) for when the eval was created.
      #
      #   @param data_source_config [OpenAI::Models::EvalCustomDataSourceConfig, OpenAI::Models::EvalUpdateResponse::DataSourceConfig::Logs, OpenAI::Models::EvalStoredCompletionsDataSourceConfig]
      #     Configuration of data sources used in runs of the evaluation.
      #
