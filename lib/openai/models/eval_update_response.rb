...
module OpenAI
  module Models
    ...
    class EvalUpdateResponse < OpenAI::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<OpenAI::EvalLabelModelGrader, OpenAI::EvalStringCheckGrader, OpenAI::EvalTextSimilarityGrader, OpenAI::Models::EvalUpdateResponse::TestingCriterion::Python, OpenAI::Models::EvalUpdateResponse::TestingCriterion::ScoreModel>]
      ...
      #
      #   @param testing_criteria [Array<OpenAI::EvalLabelModelGrader, OpenAI::EvalStringCheckGrader, OpenAI::EvalTextSimilarityGrader, OpenAI::Models::EvalUpdateResponse::TestingCriterion::Python, OpenAI::Models::EvalUpdateResponse::TestingCriterion::ScoreModel>] A list of testing criteria.
      #
      ...
      module TestingCriterion
        ...
        class ScoreModel < OpenAI::Internal::Type::BaseModel
          ...
          class Input < OpenAI::Internal::Type::BaseModel
            ...
            #
            #   @return [String, OpenAI::Responses::ResponseInputText, OpenAI::Models::EvalUpdateResponse::TestingCriterion::ScoreModel::Input::Content::OutputText]
            required :content,
            ...
            #   interactions.
            #
            #   @param content [String, OpenAI::Responses::ResponseInputText, OpenAI::Models::EvalUpdateResponse::TestingCriterion::ScoreModel::Input::Content::OutputText] Text inputs to the model - can contain template strings.
            #
            ...
            module Content
              ...
              # @!method self.variants
              #   @return [Array(String, OpenAI::Responses::ResponseInputText, OpenAI::Models::EvalUpdateResponse::TestingCriterion::ScoreModel::Input::Content::OutputText)]
            end
