...
module OpenAI
  module Models
    ...
    class EvalUpdateResponse < OpenAI::Internal::Type::BaseModel
      ...
      #
      #   @return [OpenAI::EvalCustomDataSourceConfig, OpenAI::Models::EvalUpdateResponse::DataSourceConfig::Logs, OpenAI::EvalStoredCompletionsDataSourceConfig]
      ...
      #
      #   @param data_source_config [OpenAI::EvalCustomDataSourceConfig, OpenAI::Models::EvalUpdateResponse::DataSourceConfig::Logs, OpenAI::EvalStoredCompletionsDataSourceConfig] Configuration of data sources used in runs of the evaluation.
      #
      ...
      module DataSourceConfig
        ...
        #   @return [Array(OpenAI::EvalCustomDataSourceConfig, OpenAI::Models::EvalUpdateResponse::DataSourceConfig::Logs, OpenAI::EvalStoredCompletionsDataSourceConfig)]
