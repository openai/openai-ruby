...
module OpenAI
  module Models
    ...
    class EvalUpdateResponse < OpenAI::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<OpenAI::Models::EvalLabelModelGrader, OpenAI::Models::EvalStringCheckGrader, OpenAI::Models::EvalTextSimilarityGrader, OpenAI::Models::EvalUpdateResponse::TestingCriterion::Python, OpenAI::Models::EvalUpdateResponse::TestingCriterion::ScoreModel>]
      ...
      #
      #   @param testing_criteria [Array<OpenAI::Models::EvalLabelModelGrader, OpenAI::Models::EvalStringCheckGrader, OpenAI::Models::EvalTextSimilarityGrader, OpenAI::Models::EvalUpdateResponse::TestingCriterion::Python, OpenAI::Models::EvalUpdateResponse::TestingCriterion::ScoreModel>] A list of testing criteria.
      #
