    ...
    module Graders
      class ScoreModelGrader < OpenAI::Internal::Type::BaseModel
        ...
        class Input < OpenAI::Internal::Type::BaseModel
          ...
          #
          #   @return [String, OpenAI::Models::Responses::ResponseInputText, OpenAI::Models::Graders::ScoreModelGrader::Input::Content::OutputText, OpenAI::Models::Graders::ScoreModelGrader::Input::Content::EvalItemInputImage, OpenAI::Models::Responses::ResponseInputAudio, Array<String, OpenAI::Models::Responses::ResponseInputText, OpenAI::Models::Graders::ScoreModelGrader::Input::Content::AnArrayOfInputTextOutputTextInputImageAndInputAudio::OutputText, OpenAI::Models::Graders::ScoreModelGrader::Input::Content::AnArrayOfInputTextOutputTextInputImageAndInputAudio::EvalItemInputImage, OpenAI::Models::Responses::ResponseInputAudio>]
          ...
          #   interactions.
          #
          #   @param content [String, OpenAI::Models::Responses::ResponseInputText, OpenAI::Models::Graders::ScoreModelGrader::Input::Content::OutputText, OpenAI::Models::Graders::ScoreModelGrader::Input::Content::EvalItemInputImage, OpenAI::Models::Responses::ResponseInputAudio, Array<String, OpenAI::Models::Responses::ResponseInputText, OpenAI::Models::Graders::ScoreModelGrader::Input::Content::AnArrayOfInputTextOutputTextInputImageAndInputAudio::OutputText, OpenAI::Models::Graders::ScoreModelGrader::Input::Content::AnArrayOfInputTextOutputTextInputImageAndInputAudio::EvalItemInputImage, OpenAI::Models::Responses::ResponseInputAudio>] Inputs to the model - can contain template strings. Supports text, output text,
          #
          ...
          module Content
            ...
            variant -> { OpenAI::Graders::ScoreModelGrader::Input::Content::EvalItemInputImage }
            ...
            variant -> { OpenAI::Models::Graders::ScoreModelGrader::Input::Content::AnArrayOfInputTextOutputTextInputImageAndInputAudioArray }
            ...
            class EvalItemInputImage < OpenAI::Internal::Type::BaseModel
              ...
              #   Some parameter documentations has been truncated, see
              #   {OpenAI::Models::Graders::ScoreModelGrader::Input::Content::EvalItemInputImage}
              #   for more details.
              #
              #   An image input block used within EvalItem content arrays.
              #
            ...
            module AnArrayOfInputTextOutputTextInputImageAndInputAudio
              ...
              # A text output from the model.
              variant -> { OpenAI::Graders::ScoreModelGrader::Input::Content::AnArrayOfInputTextOutputTextInputImageAndInputAudio::OutputText }

              # An image input block used within EvalItem content arrays.
              variant -> { OpenAI::Graders::ScoreModelGrader::Input::Content::AnArrayOfInputTextOutputTextInputImageAndInputAudio::EvalItemInputImage }
              ...
              class OutputText < OpenAI::Internal::Type::BaseModel
                ...
                # @!method initialize(text:, type: :output_text)
                #   Some parameter documentations has been truncated, see
                #   {OpenAI::Models::Graders::ScoreModelGrader::Input::Content::AnArrayOfInputTextOutputTextInputImageAndInputAudio::OutputText}
                #   for more details.
                #
                #   A text output from the model.
                #
              ...
              class EvalItemInputImage < OpenAI::Internal::Type::BaseModel
                ...
                # @!method initialize(image_url:, detail: nil, type: :input_image)
                #   Some parameter documentations has been truncated, see
                #   {OpenAI::Models::Graders::ScoreModelGrader::Input::Content::AnArrayOfInputTextOutputTextInputImageAndInputAudio::EvalItemInputImage}
                #   for more details.
                #
                #   An image input block used within EvalItem content arrays.
                #
              ...
              #   @return [Array(String, OpenAI::Models::Responses::ResponseInputText, OpenAI::Models::Graders::ScoreModelGrader::Input::Content::AnArrayOfInputTextOutputTextInputImageAndInputAudio::OutputText, OpenAI::Models::Graders::ScoreModelGrader::Input::Content::AnArrayOfInputTextOutputTextInputImageAndInputAudio::EvalItemInputImage, OpenAI::Models::Responses::ResponseInputAudio)]
            end
            ...
            AnArrayOfInputTextOutputTextInputImageAndInputAudioArray =
              OpenAI::Internal::Type::ArrayOf[
                union: -> { OpenAI::Graders::ScoreModelGrader::Input::Content::AnArrayOfInputTextOutputTextInputImageAndInputAudio }
              ]
          end
