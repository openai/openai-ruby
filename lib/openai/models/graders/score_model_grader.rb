    ...
    module Graders
      class ScoreModelGrader < OpenAI::Internal::Type::BaseModel
        ...
        class Input < OpenAI::Internal::Type::BaseModel
          ...
          #     input images, and input audio, either as a single item or an array of items.
          #
          #   @param role [Symbol, OpenAI::Models::Graders::ScoreModelGrader::Input::Role]
          #     The role of the message input. One of `user`, `assistant`, `system`, or
          #     `developer`.
          #
          #   @param type [Symbol, OpenAI::Models::Graders::ScoreModelGrader::Input::Type]
          #     The type of the message input. Always `message`.
        ...
        class SamplingParams < OpenAI::Internal::Type::BaseModel
          ...
          #   The sampling parameters for the model.
          #
          #   @param max_completions_tokens [Integer, nil]
          #     The maximum number of tokens the grader model may generate in its response.
          #
