  ...
  module Models
    module Realtime
      class RealtimeResponse < OpenAI::Internal::Type::BaseModel
        ...
        #     The unique ID of the response, will look like `resp_1234`.
        #
        #   @param audio [OpenAI::Models::Realtime::RealtimeResponse::Audio]
        #     Configuration for audio output.
        #
        ...
        #     a maximum length of 512 characters.
        #
        #   @param object [Symbol, OpenAI::Models::Realtime::RealtimeResponse::Object]
        #     The object type, must be `realtime.response`.
        #
        #   @param output [Array<OpenAI::Models::Realtime::RealtimeConversationItemSystemMessage, OpenAI::Models::Realtime::RealtimeConversationItemUserMessage, OpenAI::Models::Realtime::RealtimeConversationItemAssistantMessage, OpenAI::Models::Realtime::RealtimeConversationItemFunctionCall, OpenAI::Models::Realtime::RealtimeConversationItemFunctionCallOutput, OpenAI::Models::Realtime::RealtimeMcpApprovalResponse, OpenAI::Models::Realtime::RealtimeMcpListTools, OpenAI::Models::Realtime::RealtimeMcpToolCall, OpenAI::Models::Realtime::RealtimeMcpApprovalRequest>]
        #     The list of output items generated by the response.
        #
        #   @param output_modalities [Array<Symbol, OpenAI::Models::Realtime::RealtimeResponse::OutputModality>]
        #     The set of modalities the model used to respond, currently the only possible
        #     values are `[\"audio\"]`, `[\"text\"]`. Audio output always include a text
        #     transcript. Setting the output to mode `text` will disable audio output from the
        #     model.
        #
        #   @param status [Symbol, OpenAI::Models::Realtime::RealtimeResponse::Status]
        #     The final status of the response (`completed`, `cancelled`, `failed`, or
        #     `incomplete`, `in_progress`).
        #
        #   @param status_details [OpenAI::Models::Realtime::RealtimeResponseStatus]
        #     Additional details about the status.
        #
        #   @param usage [OpenAI::Models::Realtime::RealtimeResponseUsage]
        #     Usage statistics for the Response, this will correspond to billing. A Realtime
        #     API session will maintain a conversation context and append new Items to the
        #     Conversation, thus output from previous turns (text and audio tokens) will
        #     become the input for later turns.
        ...
        class Audio < OpenAI::Internal::Type::BaseModel
          ...
          class Output < OpenAI::Internal::Type::BaseModel
            ...
            #     The format of the output audio.
            #
            #   @param voice [String, Symbol, OpenAI::Models::Realtime::RealtimeResponse::Audio::Output::Voice]
            #     The voice the model uses to respond. Voice cannot be changed during the session
            #     once the model has responded with audio at least once. Current voice options are
            #     `alloy`, `ash`, `ballad`, `coral`, `echo`, `sage`, `shimmer`, `verse`, `marin`,
            #     and `cedar`. We recommend `marin` and `cedar` for best quality.
