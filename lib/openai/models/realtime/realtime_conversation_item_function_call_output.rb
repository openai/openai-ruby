  ...
  module Models
    module Realtime
      class RealtimeConversationItemFunctionCallOutput < OpenAI::Internal::Type::BaseModel
        ...
        #     the server.
        #
        #   @param object [Symbol, OpenAI::Models::Realtime::RealtimeConversationItemFunctionCallOutput::Object]
        #     Identifier for the API object being returned - always `realtime.item`. Optional
        #     when creating a new item.
        #
        #   @param status [Symbol, OpenAI::Models::Realtime::RealtimeConversationItemFunctionCallOutput::Status]
        #     The status of the item. Has no effect on the conversation.
        #
