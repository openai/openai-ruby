  ...
  module Models
    module Realtime
      class ConversationItemInputAudioTranscriptionFailedEvent < OpenAI::Internal::Type::BaseModel
        ...
        #     The index of the content part containing the audio.
        #
        #   @param error [OpenAI::Models::Realtime::ConversationItemInputAudioTranscriptionFailedEvent::Error]
        #     Details of the transcription error.
        #
        ...
        #     The ID of the user message item.
        #
        #   @param type [Symbol, :"conversation.item.input_audio_transcription.failed"]
        #     The event type, must be `conversation.item.input_audio_transcription.failed`.
