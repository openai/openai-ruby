  ...
  module Models
    module Realtime
      class RealtimeConversationItemFunctionCall < OpenAI::Internal::Type::BaseModel
        ...
        #     The ID of the function call.
        #
        #   @param object [Symbol, OpenAI::Models::Realtime::RealtimeConversationItemFunctionCall::Object]
        #     Identifier for the API object being returned - always `realtime.item`. Optional
        #     when creating a new item.
        #
        #   @param status [Symbol, OpenAI::Models::Realtime::RealtimeConversationItemFunctionCall::Status]
        #     The status of the item. Has no effect on the conversation.
        #
