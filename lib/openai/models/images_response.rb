...
module OpenAI
  module Models
    ...
    class ImagesResponse < OpenAI::Internal::Type::BaseModel
      ...
      #     The Unix timestamp (in seconds) of when the image was created.
      #
      #   @param background [Symbol, OpenAI::Models::ImagesResponse::Background]
      #     The background parameter used for the image generation. Either `transparent` or
      #     `opaque`.
      #
      ...
      #     The list of generated images.
      #
      #   @param output_format [Symbol, OpenAI::Models::ImagesResponse::OutputFormat]
      #     The output format of the image generation. Either `png`, `webp`, or `jpeg`.
      #
      #   @param quality [Symbol, OpenAI::Models::ImagesResponse::Quality]
      #     The quality of the image generated. One of `low`, `medium`, `high`, `xhigh`, or
      #     `max`.
      #
      #   @param size [String, Symbol, OpenAI::Models::ImagesResponse::Size]
      #     The image dimensions as a `WIDTHxHEIGHT` string, for example `1536x864`.
      #
      ...
      class Usage < OpenAI::Internal::Type::BaseModel
        ...
        #     The total number of tokens (images and text) used for the image generation.
        #
        #   @param output_tokens_details [OpenAI::Models::ImagesResponse::Usage::OutputTokensDetails]
        #     The output token details for the image generation.
