  ...
  module Models
    module Beta
      class BetaResponseUsage < OpenAI::Internal::Type::BaseModel
        ...
        #     The number of input tokens.
        #
        #   @param input_tokens_details [OpenAI::Models::Beta::BetaResponseUsage::InputTokensDetails]
        #     A detailed breakdown of the input tokens.
        #
        #   @param output_tokens [Integer]
        #     The number of output tokens.
        #
        #   @param output_tokens_details [OpenAI::Models::Beta::BetaResponseUsage::OutputTokensDetails]
        #     A detailed breakdown of the output tokens.
        #
