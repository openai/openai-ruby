  ...
  module Models
    module Beta
      class BetaResponseUsage < OpenAI::Internal::Type::BaseModel
        ...
        #
        #   @return [OpenAI::Models::Beta::BetaResponseUsage::InputTokensDetails]
        required :input_tokens_details, -> { OpenAI::Beta::BetaResponseUsage::InputTokensDetails }
        ...
        #
        #   @return [OpenAI::Models::Beta::BetaResponseUsage::OutputTokensDetails]
        required :output_tokens_details, -> { OpenAI::Beta::BetaResponseUsage::OutputTokensDetails }
        ...
        #
        #   @param input_tokens_details [OpenAI::Models::Beta::BetaResponseUsage::InputTokensDetails] A detailed breakdown of the input tokens.
        #
        ...
        class InputTokensDetails < OpenAI::Internal::Type::BaseModel
          ...
          #   {OpenAI::Models::Beta::BetaResponseUsage::InputTokensDetails} for more details.
          #
          #   A detailed breakdown of the input tokens.
          #
        ...
        # @see OpenAI::Models::Beta::BetaResponseUsage#output_tokens_details
    ...
    BetaResponseUsage = Beta::BetaResponseUsage
  end
end
