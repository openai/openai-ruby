  ...
  module Models
    module Beta
      ...
      class ResponseCreateParams < OpenAI::Internal::Type::BaseModel
        ...
        optional :conversation, union: -> { OpenAI::Beta::ResponseCreateParams::Conversation }, nil?: true
        ...
        optional :input, union: -> { OpenAI::Beta::ResponseCreateParams::Input }
        ...
        #   available models.
        #
        #   @return [Symbol, String, OpenAI::Models::Beta::ResponseCreateParams::Model, nil]
        optional :model, union: -> { OpenAI::Beta::ResponseCreateParams::Model }

        # @!attribute moderation
        #   Configuration for running moderation on the input and output of this response.
        #
        #   @return [OpenAI::Models::Beta::ResponseCreateParams::Moderation, nil]
        optional :moderation, -> { OpenAI::Beta::ResponseCreateParams::Moderation }, nil?: true

        # @!attribute multi_agent
        #   Configuration for server-hosted multi-agent execution.
        #
        #   @return [OpenAI::Models::Beta::ResponseCreateParams::MultiAgent, nil]
        optional :multi_agent, -> { OpenAI::Beta::ResponseCreateParams::MultiAgent }, nil?: true
        ...
        #   for current details.
        #
        #   @return [OpenAI::Models::Beta::ResponseCreateParams::PromptCacheOptions, nil]
        optional :prompt_cache_options, -> { OpenAI::Beta::ResponseCreateParams::PromptCacheOptions }
        ...
        #
        #   @return [OpenAI::Models::Beta::ResponseCreateParams::Reasoning, nil]
        optional :reasoning, -> { OpenAI::Beta::ResponseCreateParams::Reasoning }, nil?: true
        ...
        #   parameter.
        #
        #   @return [Symbol, OpenAI::Models::Beta::ResponseCreateParams::ServiceTier, nil]
        optional :service_tier, enum: -> { OpenAI::Beta::ResponseCreateParams::ServiceTier }, nil?: true
        ...
        #
        #   @return [OpenAI::Models::Beta::ResponseCreateParams::StreamOptions, nil]
        optional :stream_options, -> { OpenAI::Beta::ResponseCreateParams::StreamOptions }, nil?: true
        ...
        #   can call.
        #
        #   @return [Symbol, OpenAI::Models::Beta::BetaToolChoiceOptions, OpenAI::Models::Beta::BetaToolChoiceAllowed, OpenAI::Models::Beta::BetaToolChoiceTypes, OpenAI::Models::Beta::BetaToolChoiceFunction, OpenAI::Models::Beta::BetaToolChoiceMcp, OpenAI::Models::Beta::BetaToolChoiceCustom, OpenAI::Models::Beta::ResponseCreateParams::ToolChoice::BetaSpecificProgrammaticToolCallingParam, OpenAI::Models::Beta::BetaToolChoiceApplyPatch, OpenAI::Models::Beta::BetaToolChoiceShell, nil]
        optional :tool_choice, union: -> { OpenAI::Beta::ResponseCreateParams::ToolChoice }
        ...
        #
        #   @return [Symbol, OpenAI::Models::Beta::ResponseCreateParams::Truncation, nil]
        optional :truncation, enum: -> { OpenAI::Beta::ResponseCreateParams::Truncation }, nil?: true
        ...
        #
        #   @param context_management [Array<OpenAI::Models::Beta::ResponseCreateParams::ContextManagement>, nil] Context management configuration for this request.
        #
        ...
        #
        #   @param model [Symbol, String, OpenAI::Models::Beta::ResponseCreateParams::Model] Model ID used to generate the response, like `gpt-6-astra`. OpenAI
        #
        #   @param moderation [OpenAI::Models::Beta::ResponseCreateParams::Moderation, nil] Configuration for running moderation on the input and output of this response.
        #
        #   @param multi_agent [OpenAI::Models::Beta::ResponseCreateParams::MultiAgent, nil] Configuration for server-hosted multi-agent execution.
        #
        ...
        #
        #   @param prompt_cache_retention [Symbol, OpenAI::Models::Beta::ResponseCreateParams::PromptCacheRetention, nil] Deprecated. Use `prompt_cache_options.ttl` instead.
        #
        #   @param reasoning [OpenAI::Models::Beta::ResponseCreateParams::Reasoning, nil] Configuration options for
        #
        ...
        #
        #   @param stream_options [OpenAI::Models::Beta::ResponseCreateParams::StreamOptions, nil] Options for streaming responses. Only set this when you set `stream: true`.
        #
        ...
        #
        #   @param tool_choice [Symbol, OpenAI::Models::Beta::BetaToolChoiceOptions, OpenAI::Models::Beta::BetaToolChoiceAllowed, OpenAI::Models::Beta::BetaToolChoiceTypes, OpenAI::Models::Beta::BetaToolChoiceFunction, OpenAI::Models::Beta::BetaToolChoiceMcp, OpenAI::Models::Beta::BetaToolChoiceCustom, OpenAI::Models::Beta::ResponseCreateParams::ToolChoice::BetaSpecificProgrammaticToolCallingParam, OpenAI::Models::Beta::BetaToolChoiceApplyPatch, OpenAI::Models::Beta::BetaToolChoiceShell] How the model should select which tool (or tools) to use when generating
        #
        ...
        #
        #   @param truncation [Symbol, OpenAI::Models::Beta::ResponseCreateParams::Truncation, nil] The truncation strategy to use for the model response.
        #
        ...
        module Model
          ...
          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_5_4_NANO }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_5_4_MINI_2026_03_17 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_5_4_NANO_2026_03_17 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_5_3_CHAT_LATEST }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_5_2 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_5_2_2025_12_11 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_5_2_CHAT_LATEST }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_5_2_PRO }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_5_2_PRO_2025_12_11 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_5_1 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_5_1_2025_11_13 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_5_1_CODEX }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_5_1_MINI }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_5_1_CHAT_LATEST }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_5 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_5_MINI }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_5_NANO }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_5_2025_08_07 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_5_MINI_2025_08_07 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_5_NANO_2025_08_07 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_5_CHAT_LATEST }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_4_1 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_4_1_MINI }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_4_1_NANO }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_4_1_2025_04_14 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_4_1_MINI_2025_04_14 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_4_1_NANO_2025_04_14 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::O4_MINI }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::O4_MINI_2025_04_16 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::O3 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::O3_2025_04_16 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::O3_MINI }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::O3_MINI_2025_01_31 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::O1 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::O1_2024_12_17 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::O1_PREVIEW }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::O1_PREVIEW_2024_09_12 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::O1_MINI }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::O1_MINI_2024_09_12 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_4O }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_4O_2024_11_20 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_4O_2024_08_06 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_4O_2024_05_13 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_4O_AUDIO_PREVIEW }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_4O_AUDIO_PREVIEW_2024_10_01 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_4O_AUDIO_PREVIEW_2024_12_17 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_4O_AUDIO_PREVIEW_2025_06_03 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_4O_MINI_AUDIO_PREVIEW }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_4O_MINI_AUDIO_PREVIEW_2024_12_17 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_4O_SEARCH_PREVIEW }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_4O_MINI_SEARCH_PREVIEW }
          ...
          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::CODEX_MINI_LATEST }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_4O_MINI }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_4O_MINI_2024_07_18 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_4_TURBO }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_4_TURBO_2024_04_09 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_4_0125_PREVIEW }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_4_TURBO_PREVIEW }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_4_1106_PREVIEW }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_4_VISION_PREVIEW }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_4 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_4_0314 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_4_0613 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_4_32K }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_4_32K_0314 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_4_32K_0613 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_3_5_TURBO }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_3_5_TURBO_16K }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_3_5_TURBO_0301 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_3_5_TURBO_0613 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_3_5_TURBO_1106 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_3_5_TURBO_0125 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_3_5_TURBO_16K_0613 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::O1_PRO }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::O1_PRO_2025_03_19 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::O3_PRO }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::O3_PRO_2025_06_10 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::O3_DEEP_RESEARCH }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::O3_DEEP_RESEARCH_2025_06_26 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::O4_MINI_DEEP_RESEARCH }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::O4_MINI_DEEP_RESEARCH_2025_06_26 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::COMPUTER_USE_PREVIEW }
          ...
          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_5_PRO_2025_10_06 }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_5_1_CODEX_MAX }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_DAYBREAK_BLUE_LATEST }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_DAYBREAK_RED_LATEST }

          variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Model::GPT_5_6_CYBER }
          ...
          define_sorbet_constant!(:Variants) do
            T.type_alias { T.any(OpenAI::Beta::ResponseCreateParams::Model::TaggedSymbol, String) }
          end
        ...
        class Moderation < OpenAI::Internal::Type::BaseModel
          ...
          #
          #   @return [OpenAI::Models::Beta::ResponseCreateParams::Moderation::Policy, nil]
          optional :policy, -> { OpenAI::Beta::ResponseCreateParams::Moderation::Policy }, nil?: true

          # @!method initialize(model:, policy: nil)
          #   Some parameter documentations has been truncated, see
          #   {OpenAI::Models::Beta::ResponseCreateParams::Moderation} for more details.
          #
          #   Configuration for running moderation on the input and output of this response.
          #
          #   @param model [String] The moderation model to use for moderated completions, e.g. 'omni-moderation-lat
          #
          #   @param policy [OpenAI::Models::Beta::ResponseCreateParams::Moderation::Policy, nil] The policy to apply to moderated response input and output.

          # @see OpenAI::Models::Beta::ResponseCreateParams::Moderation#policy
          class Policy < OpenAI::Internal::Type::BaseModel
            # @!attribute input
            #   The moderation policy for the response input.
            #
            #   @return [OpenAI::Models::Beta::ResponseCreateParams::Moderation::Policy::Input, nil]
            optional :input, -> { OpenAI::Beta::ResponseCreateParams::Moderation::Policy::Input }, nil?: true
            ...
            #   The policy to apply to moderated response input and output.
            #
            #   @param input [OpenAI::Models::Beta::ResponseCreateParams::Moderation::Policy::Input, nil] The moderation policy for the response input.
            #
            #   @param output [OpenAI::Models::Beta::ResponseCreateParams::Moderation::Policy::Output, nil] The moderation policy for the response output.

            # @see OpenAI::Models::Beta::ResponseCreateParams::Moderation::Policy#input
            class Input < OpenAI::Internal::Type::BaseModel
              # @!attribute mode
              #
              #   @return [Symbol, OpenAI::Models::Beta::ResponseCreateParams::Moderation::Policy::Input::Mode]
              required :mode, enum: -> { OpenAI::Beta::ResponseCreateParams::Moderation::Policy::Input::Mode }

              # @!method initialize(mode:)
              #   The moderation policy for the response input.
              #
              #   @param mode [Symbol, OpenAI::Models::Beta::ResponseCreateParams::Moderation::Policy::Input::Mode]

              # @see OpenAI::Models::Beta::ResponseCreateParams::Moderation::Policy::Input#mode
              module Mode
            ...
            # @see OpenAI::Models::Beta::ResponseCreateParams::Moderation::Policy#output
            class Output < OpenAI::Internal::Type::BaseModel
              # @!attribute mode
              #
              #   @return [Symbol, OpenAI::Models::Beta::ResponseCreateParams::Moderation::Policy::Output::Mode]
              required :mode, enum: -> { OpenAI::Beta::ResponseCreateParams::Moderation::Policy::Output::Mode }

              # @!method initialize(mode:)
              #   The moderation policy for the response output.
              #
              #   @param mode [Symbol, OpenAI::Models::Beta::ResponseCreateParams::Moderation::Policy::Output::Mode]

              # @see OpenAI::Models::Beta::ResponseCreateParams::Moderation::Policy::Output#mode
              module Mode
                extend OpenAI::Internal::Type::Enum
        ...
        class MultiAgent < OpenAI::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {OpenAI::Models::Beta::ResponseCreateParams::MultiAgent} for more details.
          #
          #   Configuration for server-hosted multi-agent execution.
          #
        ...
        class PromptCacheOptions < OpenAI::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {OpenAI::Models::Beta::ResponseCreateParams::PromptCacheOptions} for more
          #   details.
          #
          #   Options for prompt caching. Supported for `gpt-5.6` and later models. By
          #   default, OpenAI automatically chooses one implicit cache breakpoint. You can add
          ...
          #
          #   @param mode [Symbol, OpenAI::Models::Beta::ResponseCreateParams::PromptCacheOptions::Mode] Controls whether OpenAI automatically creates an implicit cache breakpoint. Defa
          #
          #   @param ttl [Symbol, OpenAI::Models::Beta::ResponseCreateParams::PromptCacheOptions::Ttl] The minimum lifetime applied to every implicit and explicit cache breakpoint wri
          ...
          # request does not use prompt caching.
          #
          # @see OpenAI::Models::Beta::ResponseCreateParams::PromptCacheOptions#mode
          module Mode
            extend OpenAI::Internal::Type::Enum
          ...
          # value. The backend may retain cache entries for longer.
          #
          # @see OpenAI::Models::Beta::ResponseCreateParams::PromptCacheOptions#ttl
          module Ttl
            extend OpenAI::Internal::Type::Enum
        ...
        class Reasoning < OpenAI::Internal::Type::BaseModel
          ...
          #   for the response.
          #
          #   @return [Symbol, OpenAI::Models::Beta::ResponseCreateParams::Reasoning::Context, nil]
          ...
          #
          #   @return [Symbol, OpenAI::Models::Beta::ResponseCreateParams::Reasoning::Effort, nil]
          ...
          #
          #   @return [String, Symbol, OpenAI::Models::Beta::ResponseCreateParams::Reasoning::Mode, nil]
          ...
          #   models after `gpt-5`.
          #
          #   @return [Symbol, OpenAI::Models::Beta::ResponseCreateParams::Reasoning::Summary, nil]
          ...
          #   Some parameter documentations has been truncated, see
          #   {OpenAI::Models::Beta::ResponseCreateParams::Reasoning} for more details.
          #
          #   Configuration options for
          #   [reasoning models](https://platform.openai.com/docs/guides/reasoning).
          #
          #   @param context [Symbol, OpenAI::Models::Beta::ResponseCreateParams::Reasoning::Context, nil] Controls which reasoning items are rendered back to the model on later turns.
          #
          #   @param effort [Symbol, OpenAI::Models::Beta::ResponseCreateParams::Reasoning::Effort, nil] Constrains effort on reasoning for reasoning models. Currently supported
          #
          #   @param generate_summary [Symbol, OpenAI::Models::Beta::ResponseCreateParams::Reasoning::GenerateSummary, nil] **Deprecated:** use `summary` instead.
          #
          #   @param mode [String, Symbol, OpenAI::Models::Beta::ResponseCreateParams::Reasoning::Mode] Controls the reasoning execution mode for the request.
          #
          ...
          # for the response.
          #
          # @see OpenAI::Models::Beta::ResponseCreateParams::Reasoning#context
          module Context
            extend OpenAI::Internal::Type::Enum
          ...
          # model-specific support.
          #
          # @see OpenAI::Models::Beta::ResponseCreateParams::Reasoning#effort
          module Effort
            extend OpenAI::Internal::Type::Enum
          ...
          # `concise`, or `detailed`.
          #
          # @see OpenAI::Models::Beta::ResponseCreateParams::Reasoning#generate_summary
          ...
          # When returned on a response, this is the effective execution mode.
          #
          # @see OpenAI::Models::Beta::ResponseCreateParams::Reasoning#mode
          module Mode
            extend OpenAI::Internal::Type::Union

            variant String

            variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Reasoning::Mode::STANDARD }

            variant const: -> { OpenAI::Models::Beta::ResponseCreateParams::Reasoning::Mode::PRO }

            # @!method self.variants
            #   @return [Array(String, Symbol)]

            define_sorbet_constant!(:Variants) do
              T.type_alias { T.any(String, OpenAI::Beta::ResponseCreateParams::Reasoning::Mode::TaggedSymbol) }
            end
          ...
          # models after `gpt-5`.
          #
          # @see OpenAI::Models::Beta::ResponseCreateParams::Reasoning#summary
          module Summary
            extend OpenAI::Internal::Type::Enum
        ...
        class StreamOptions < OpenAI::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {OpenAI::Models::Beta::ResponseCreateParams::StreamOptions} for more details.
          #
          #   Options for streaming responses. Only set this when you set `stream: true`.
          #
        ...
        module ToolChoice
          ...
          variant -> { OpenAI::Beta::ResponseCreateParams::ToolChoice::BetaSpecificProgrammaticToolCallingParam }
