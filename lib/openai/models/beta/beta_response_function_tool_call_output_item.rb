  ...
  module Models
    module Beta
      class BetaResponseFunctionToolCallOutputItem < OpenAI::Internal::Type::BaseModel
        ...
        #     list of output content.
        #
        #   @param status [Symbol, OpenAI::Models::Beta::BetaResponseFunctionToolCallOutputItem::Status]
        #     The status of the item. One of `in_progress`, `completed`, or `incomplete`.
        #     Populated when items are returned via API.
        #
        #   @param agent [OpenAI::Models::Beta::BetaResponseFunctionToolCallOutputItem::Agent, nil]
        #     The agent that produced this item.
        #
        #   @param call_id [String]
        #     The unique ID of the function tool call generated by the model.
        #
        #   @param caller_ [OpenAI::Models::Beta::BetaResponseFunctionToolCallOutputItem::Caller::Direct, OpenAI::Models::Beta::BetaResponseFunctionToolCallOutputItem::Caller::Program, nil]
        #     The execution context that produced this tool call.
        #
