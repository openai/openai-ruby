  ...
  module Models
    module Beta
      class BetaResponseCodeInterpreterCallCompletedEvent < OpenAI::Internal::Type::BaseModel
        ...
        #
        #   @return [OpenAI::Models::Beta::BetaResponseCodeInterpreterCallCompletedEvent::Agent, nil]
        optional :agent, -> { OpenAI::Beta::BetaResponseCodeInterpreterCallCompletedEvent::Agent }, nil?: true

        # @!method initialize(item_id:, output_index:, sequence_number:, agent: nil, type: :"response.code_interpreter_call.completed")
        #   Some parameter documentations has been truncated, see
        #   {OpenAI::Models::Beta::BetaResponseCodeInterpreterCallCompletedEvent} for more
        #   details.
        #
        ...
        # @see OpenAI::Models::Beta::BetaResponseCodeInterpreterCallCompletedEvent#agent
    ...
    BetaResponseCodeInterpreterCallCompletedEvent = Beta::BetaResponseCodeInterpreterCallCompletedEvent
  end
end
