  ...
  module Models
    module Beta
      ...
      module BetaResponseItem
        ...
        variant :configuration_update, -> { OpenAI::Beta::BetaResponseConfigurationUpdateItem }
        ...
        class AgentMessage < OpenAI::Internal::Type::BaseModel
          ...
          #     The destination agent identity.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseItem::AgentMessage::Agent]
          #     The agent that produced this item.
          #
          ...
          module Content
            ...
            class ComputerScreenshot < OpenAI::Internal::Type::BaseModel
              ...
              #   A screenshot of a computer.
              #
              #   @param detail [Symbol, OpenAI::Models::Beta::BetaResponseItem::AgentMessage::Content::ComputerScreenshot::Detail]
              #     The detail level of the screenshot image to be sent to the model. One of `high`,
              #     `low`, `auto`, or `original`. Defaults to `auto`.
              #
              ...
              #     The URL of the screenshot image.
              #
              #   @param prompt_cache_breakpoint [OpenAI::Models::Beta::BetaResponseItem::AgentMessage::Content::ComputerScreenshot::PromptCacheBreakpoint]
              #     Marks the exact end of a reusable prompt prefix. The breakpoint inherits its TTL
              #     from the request's `prompt_cache_options.ttl`; the boundary is not rounded to a
              #     token block.
              #
        ...
        class MultiAgentCall < OpenAI::Internal::Type::BaseModel
          ...
          #     The unique ID of the multi-agent call item.
          #
          #   @param action [Symbol, OpenAI::Models::Beta::BetaResponseItem::MultiAgentCall::Action]
          #     The multi-agent action to execute.
          #
          ...
          #     The unique ID linking this call to its output.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseItem::MultiAgentCall::Agent]
          #     The agent that produced this item.
          #
        ...
        class MultiAgentCallOutput < OpenAI::Internal::Type::BaseModel
          ...
          #     The unique ID of the multi-agent call output item.
          #
          #   @param action [Symbol, OpenAI::Models::Beta::BetaResponseItem::MultiAgentCallOutput::Action]
          #     The multi-agent action that produced this result.
          #
          #   @param call_id [String]
          #     The unique ID of the multi-agent call.
          ...
          #     Text output returned by the multi-agent action.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseItem::MultiAgentCallOutput::Agent]
          #     The agent that produced this item.
          #
        ...
        class AdditionalTools < OpenAI::Internal::Type::BaseModel
          ...
          #     The unique ID of the additional tools item.
          #
          #   @param role [Symbol, OpenAI::Models::Beta::BetaResponseItem::AdditionalTools::Role]
          #     The role that provided the additional tools.
          #
          ...
          #     The additional tool definitions made available at this item.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseItem::AdditionalTools::Agent]
          #     The agent that produced this item.
          #
        ...
        class Program < OpenAI::Internal::Type::BaseModel
          ...
          #     Opaque program replay fingerprint that must be round-tripped.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseItem::Program::Agent]
          #     The agent that produced this item.
          #
        ...
        class ProgramOutput < OpenAI::Internal::Type::BaseModel
          ...
          #     The result produced by the program item.
          #
          #   @param status [Symbol, OpenAI::Models::Beta::BetaResponseItem::ProgramOutput::Status]
          #     The terminal status of the program output item.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseItem::ProgramOutput::Agent]
          #     The agent that produced this item.
          #
        ...
        class ImageGenerationCall < OpenAI::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, OpenAI::Models::Beta::BetaResponseItem::ImageGenerationCall::Action, nil]
          optional(
            :action,
            enum: -> {
          ...
          #
          #   @return [Symbol, OpenAI::Models::Beta::BetaResponseItem::ImageGenerationCall::Background, nil]
          optional(
            :background,
          ...
          #
          #   @return [Symbol, OpenAI::Models::Beta::BetaResponseItem::ImageGenerationCall::OutputFormat, nil]
          optional(
            :output_format,
          ...
          #     The generated image encoded in base64.
          #
          #   @param status [Symbol, OpenAI::Models::Beta::BetaResponseItem::ImageGenerationCall::Status]
          #     The status of the image generation call.
          #
          #   @param action [Symbol, OpenAI::Models::Beta::BetaResponseItem::ImageGenerationCall::Action, nil]
          #     The action used for image generation.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseItem::ImageGenerationCall::Agent, nil]
          #     The agent that produced this item.
          #
          #   @param background [Symbol, OpenAI::Models::Beta::BetaResponseItem::ImageGenerationCall::Background, nil]
          #     The background setting used for generation.
          #
          #   @param output_format [Symbol, OpenAI::Models::Beta::BetaResponseItem::ImageGenerationCall::OutputFormat, nil]
          #     The output format used for generation.
          #
          #   @param quality [Symbol, OpenAI::Models::Beta::BetaResponseItem::ImageGenerationCall::Quality, nil]
          #     The quality of the image generated by the image generation tool call. One of
          #     `low`, `medium`, `high`, `xhigh`, `max`, or `auto`.
          #
          ...
          #     The prompt that was used after any model prompt rewriting.
          #
          #   @param size [String, Symbol, OpenAI::Models::Beta::BetaResponseItem::ImageGenerationCall::Size, nil]
          #     The image dimensions as a `WIDTHxHEIGHT` string, for example `1536x864`.
          #
          ...
          # The background setting used for generation.
          #
          # @see OpenAI::Models::Beta::BetaResponseItem::ImageGenerationCall#background
          module Background
            extend OpenAI::Internal::Type::Enum
          ...
          # The output format used for generation.
          #
          # @see OpenAI::Models::Beta::BetaResponseItem::ImageGenerationCall#output_format
          module OutputFormat
            extend OpenAI::Internal::Type::Enum
        ...
        class LocalShellCall < OpenAI::Internal::Type::BaseModel
          ...
          #     The unique ID of the local shell call.
          #
          #   @param action [OpenAI::Models::Beta::BetaResponseItem::LocalShellCall::Action]
          #     Execute a shell command on the server.
          #
          #   @param call_id [String]
          #     The unique ID of the local shell tool call generated by the model.
          #
          #   @param status [Symbol, OpenAI::Models::Beta::BetaResponseItem::LocalShellCall::Status]
          #     The status of the local shell call.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseItem::LocalShellCall::Agent, nil]
          #     The agent that produced this item.
          #
        ...
        class LocalShellCallOutput < OpenAI::Internal::Type::BaseModel
          ...
          #     A JSON string of the output of the local shell tool call.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseItem::LocalShellCallOutput::Agent, nil]
          #     The agent that produced this item.
          #
          #   @param status [Symbol, OpenAI::Models::Beta::BetaResponseItem::LocalShellCallOutput::Status, nil]
          #     The status of the item. One of `in_progress`, `completed`, or `incomplete`.
          #
        ...
        class McpListTools < OpenAI::Internal::Type::BaseModel
          ...
          #     The label of the MCP server.
          #
          #   @param tools [Array<OpenAI::Models::Beta::BetaResponseItem::McpListTools::Tool>]
          #     The tools available on the server.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseItem::McpListTools::Agent, nil]
          #     The agent that produced this item.
          #
        ...
        class McpApprovalRequest < OpenAI::Internal::Type::BaseModel
          ...
          #     The label of the MCP server making the request.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseItem::McpApprovalRequest::Agent, nil]
          #     The agent that produced this item.
          #
        ...
        class McpApprovalResponse < OpenAI::Internal::Type::BaseModel
          ...
          #     Whether the request was approved.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseItem::McpApprovalResponse::Agent, nil]
          #     The agent that produced this item.
          #
        ...
        class McpCall < OpenAI::Internal::Type::BaseModel
          ...
          #     The label of the MCP server running the tool.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseItem::McpCall::Agent, nil]
          #     The agent that produced this item.
          #
          ...
          #     The output from the tool call.
          #
          #   @param status [Symbol, OpenAI::Models::Beta::BetaResponseItem::McpCall::Status]
          #     The status of the tool call. One of `in_progress`, `completed`, `incomplete`,
          #     `calling`, or `failed`.
          #
