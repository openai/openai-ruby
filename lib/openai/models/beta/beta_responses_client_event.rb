  ...
  module Models
    module Beta
      ...
      module BetaResponsesClientEvent
        ...
        variant :"response.steer", -> { OpenAI::Beta::BetaResponseSteerEvent }
        ...
        class ResponseCreate < OpenAI::Internal::Type::BaseModel
          ...
          #     [Learn more](https://developers.openai.com/api/docs/guides/background).
          #
          #   @param context_management [Array<OpenAI::Models::Beta::BetaResponsesClientEvent::ResponseCreate::ContextManagement>, nil]
          #     Context management configuration for this request.
          #
          ...
          #     a maximum length of 512 characters.
          #
          #   @param model [Symbol, String, OpenAI::Models::Beta::BetaResponsesClientEvent::ResponseCreate::Model]
          #     Model ID used to generate the response, like `gpt-6-astra`. OpenAI offers a wide
          #     range of models with different capabilities, performance characteristics, and
          #     price points. Refer to the
          #     [model guide](https://developers.openai.com/api/docs/models) to browse and
          #     compare available models.
          #
          #   @param moderation [OpenAI::Models::Beta::BetaResponsesClientEvent::ResponseCreate::Moderation, nil]
          #     Configuration for running moderation on the input and output of this response.
          #
          #   @param multi_agent [OpenAI::Models::Beta::BetaResponsesClientEvent::ResponseCreate::MultiAgent, nil]
          #     Configuration for server-hosted multi-agent execution.
          #
          ...
          #     [Learn more](https://developers.openai.com/api/docs/guides/prompt-caching).
          #
          #   @param prompt_cache_options [OpenAI::Models::Beta::BetaResponsesClientEvent::ResponseCreate::PromptCacheOptions]
          #     Options for prompt caching. Supported for `gpt-5.6` and later models. By
          #     default, OpenAI automatically chooses one implicit cache breakpoint. You can add
          #     explicit breakpoints to content blocks with `prompt_cache_breakpoint`. Each
          #     request can write up to four breakpoints. For cache matching, OpenAI considers
          ...
          #     for current details.
          #
          #   @param prompt_cache_retention [Symbol, OpenAI::Models::Beta::BetaResponsesClientEvent::ResponseCreate::PromptCacheRetention, nil]
          #     Deprecated. Use `prompt_cache_options.ttl` instead.
          #
          #     The retention policy for the prompt cache. Set to `24h` to enable extended
          #     prompt caching, which keeps cached prefixes active for longer, up to a maximum
          ...
          #       `prompt_cache_retention` is not specified.
          #
          #   @param reasoning [OpenAI::Models::Beta::BetaResponsesClientEvent::ResponseCreate::Reasoning, nil]
          #     Configuration options for
          #     [reasoning models](https://developers.openai.com/api/docs/guides/reasoning).
          #
          ...
          #     [Learn more](https://developers.openai.com/api/docs/guides/safety-best-practices#implement-safety-identifiers).
          #
          #   @param service_tier [Symbol, OpenAI::Models::Beta::BetaResponsesClientEvent::ResponseCreate::ServiceTier, nil]
          #     Specifies the processing type used for serving the request.
          #
          #     - If set to 'auto', then the request will be processed with the service tier
          #       configured in the Project settings. Unless otherwise configured, the Project
          ...
          #     lineage, so a new lane can fork from a response created on another lane.
          #
          #   @param stream_options [OpenAI::Models::Beta::BetaResponsesClientEvent::ResponseCreate::StreamOptions, nil]
          #     Options for streaming responses. Only set this when you set `stream: true`.
          #
          ...
          #     We generally recommend altering this or `temperature` but not both.
          #
          #   @param truncation [Symbol, OpenAI::Models::Beta::BetaResponsesClientEvent::ResponseCreate::Truncation, nil]
          #     The truncation strategy to use for the model response.
          #
          #     - `auto`: If the input to this Response exceeds the model's context window size,
          #       the model will truncate the response to fit the context window by dropping
          ...
          module Model
            ...
            variant const: -> { OpenAI::Models::Beta::BetaResponsesClientEvent::ResponseCreate::Model::GPT_6_ASTRA }

            variant const: -> { OpenAI::Models::Beta::BetaResponsesClientEvent::ResponseCreate::Model::GPT_6_SOL }

            variant const: -> { OpenAI::Models::Beta::BetaResponsesClientEvent::ResponseCreate::Model::GPT_6_LUNA }
            ...
            variant(
              const: -> {
                OpenAI::Models::Beta::BetaResponsesClientEvent::ResponseCreate::Model::GPT_ROSALIND_RESEARCH
              }
            )
          ...
          class Moderation < OpenAI::Internal::Type::BaseModel
            ...
            #     'omni-moderation-latest'.
            #
            #   @param policy [OpenAI::Models::Beta::BetaResponsesClientEvent::ResponseCreate::Moderation::Policy, nil]
            #     The policy to apply to moderated response input and output.
            ...
            class Policy < OpenAI::Internal::Type::BaseModel
              ...
              #   The policy to apply to moderated response input and output.
              #
              #   @param input [OpenAI::Models::Beta::BetaResponsesClientEvent::ResponseCreate::Moderation::Policy::Input, nil]
              #     The moderation policy for the response input.
              #
              #   @param output [OpenAI::Models::Beta::BetaResponsesClientEvent::ResponseCreate::Moderation::Policy::Output, nil]
              #     The moderation policy for the response output.
          ...
          class PromptCacheOptions < OpenAI::Internal::Type::BaseModel
            ...
            #     this field requests prompt cache diagnostics when the feature is enabled.
            #
            #   @param mode [Symbol, OpenAI::Models::Beta::BetaResponsesClientEvent::ResponseCreate::PromptCacheOptions::Mode]
            #     Controls whether OpenAI automatically creates an implicit cache breakpoint.
            #     Defaults to `implicit`. With `implicit`, OpenAI creates one implicit breakpoint
            #     and writes up to the latest three explicit breakpoints in the request. With
            #     `explicit`, OpenAI does not create an implicit breakpoint and writes up to the
          ...
          class Reasoning < OpenAI::Internal::Type::BaseModel
            ...
            #   [reasoning models](https://developers.openai.com/api/docs/guides/reasoning).
            #
            #   @param context [Symbol, OpenAI::Models::Beta::BetaResponsesClientEvent::ResponseCreate::Reasoning::Context, nil]
            #     Controls which reasoning items are rendered back to the model on later turns. If
            #     omitted or set to `auto`, the model determines the context mode. The `gpt-5.6`
            #     model family defaults to `all_turns`; earlier models default to `current_turn`.
            #
            ...
            #     for the response.
            #
            #   @param effort [Symbol, OpenAI::Models::Beta::BetaResponsesClientEvent::ResponseCreate::Reasoning::Effort, nil]
            #     Constrains effort on reasoning for reasoning models. Currently supported values
            #     are `none`, `minimal`, `low`, `medium`, `high`, `xhigh`, and `max`. Reducing
            #     reasoning effort can result in faster responses and fewer tokens used on
            #     reasoning in a response. Not all reasoning models support every value. See the
            ...
            #     model-specific support.
            #
            #   @param generate_summary [Symbol, OpenAI::Models::Beta::BetaResponsesClientEvent::ResponseCreate::Reasoning::GenerateSummary, nil]
            #     **Deprecated:** use `summary` instead.
            #
            #     A summary of the reasoning performed by the model. This can be useful for
            #     debugging and understanding the model's reasoning process. One of `auto`,
            #     `concise`, or `detailed`.
            #
            #   @param mode [String, Symbol, OpenAI::Models::Beta::BetaResponsesClientEvent::ResponseCreate::Reasoning::Mode]
            #     Controls the reasoning execution mode for the request.
            #
            #     When returned on a response, this is the effective execution mode.
            #
            #   @param summary [Symbol, OpenAI::Models::Beta::BetaResponsesClientEvent::ResponseCreate::Reasoning::Summary, nil]
            #     A summary of the reasoning performed by the model. This can be useful for
            #     debugging and understanding the model's reasoning process. One of `auto`,
            #     `concise`, or `detailed`.
            #
        ...
        # @!method self.variants
        #   @return [Array(OpenAI::Models::Beta::BetaResponsesClientEvent::ResponseCreate, OpenAI::Models::Beta::BetaResponseSteerEvent, OpenAI::Models::Beta::BetaResponseInjectEvent)]
      end
    end
