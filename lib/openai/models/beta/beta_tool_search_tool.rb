  ...
  module Models
    module Beta
      class BetaToolSearchTool < OpenAI::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, OpenAI::Models::Beta::BetaToolSearchTool::Execution, nil]
        optional :execution, enum: -> { OpenAI::Beta::BetaToolSearchTool::Execution }
        ...
        #
        #   @param execution [Symbol, OpenAI::Models::Beta::BetaToolSearchTool::Execution] Whether tool search is executed by the server or by the client.
        #
        ...
        # Whether tool search is executed by the server or by the client.
        #
        # @see OpenAI::Models::Beta::BetaToolSearchTool#execution
        module Execution
