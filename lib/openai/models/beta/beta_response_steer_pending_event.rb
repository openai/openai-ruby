  ...
  module Models
    module Beta
      class BetaResponseSteerPendingEvent < OpenAI::Internal::Type::BaseModel
        ...
        required :reason, union: -> { OpenAI::Beta::BetaResponseSteerPendingReason }
        ...
        required(
          :required_input,
          -> { OpenAI::Internal::Type::ArrayOf[union: OpenAI::Beta::BetaResponseSteerRequiredInput] }
        )
        ...
        #
        #   @return [OpenAI::Models::Beta::BetaResponseSteerPendingEvent::Steer]
        required :steer, -> { OpenAI::Beta::BetaResponseSteerPendingEvent::Steer }
