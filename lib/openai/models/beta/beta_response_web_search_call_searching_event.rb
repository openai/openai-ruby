  ...
  module Models
    module Beta
      class BetaResponseWebSearchCallSearchingEvent < OpenAI::Internal::Type::BaseModel
        ...
        #
        #   @return [OpenAI::Models::Beta::BetaResponseWebSearchCallSearchingEvent::Agent, nil]
        optional :agent, -> { OpenAI::Beta::BetaResponseWebSearchCallSearchingEvent::Agent }, nil?: true

        # @!method initialize(item_id:, output_index:, sequence_number:, agent: nil, type: :"response.web_search_call.searching")
        #   Some parameter documentations has been truncated, see
        #   {OpenAI::Models::Beta::BetaResponseWebSearchCallSearchingEvent} for more
        #   details.
        #
        ...
        # @see OpenAI::Models::Beta::BetaResponseWebSearchCallSearchingEvent#agent
    ...
    BetaResponseWebSearchCallSearchingEvent = Beta::BetaResponseWebSearchCallSearchingEvent
  end
end
