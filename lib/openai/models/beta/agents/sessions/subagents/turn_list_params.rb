  ...
  module Models
    module Beta
      module Agents
        module Sessions
          module Subagents
            # @see OpenAI::Resources::Beta::Agents::Sessions::Subagents::Turns#list
            class TurnListParams < OpenAI::Internal::Type::BaseModel
              ...
              #
              #   @return [Symbol, OpenAI::Models::Beta::Agents::Sessions::Subagents::TurnListParams::Order, nil]
              optional :order, enum: -> { OpenAI::Beta::Agents::Sessions::Subagents::TurnListParams::Order }
