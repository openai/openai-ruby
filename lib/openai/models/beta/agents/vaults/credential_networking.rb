      ...
      module Agents
        module Vaults
          ...
          module CredentialNetworking
            ...
            variant :unrestricted, -> { OpenAI::Beta::Agents::Vaults::CredentialNetworking::Unrestricted }

            # Allows substitution only for the listed hosts. The environment network policy must also allow these hosts.
            variant :limited, -> { OpenAI::Beta::Agents::Vaults::CredentialNetworking::Limited }
            ...
            #   @return [Array(OpenAI::Models::Beta::Agents::Vaults::CredentialNetworking::Unrestricted, OpenAI::Models::Beta::Agents::Vaults::CredentialNetworking::Limited)]
          end
        end
      end
    end
