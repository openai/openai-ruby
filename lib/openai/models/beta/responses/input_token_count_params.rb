      ...
      module Responses
        ...
        class InputTokenCountParams < OpenAI::Internal::Type::BaseModel
          ...
          class Reasoning < OpenAI::Internal::Type::BaseModel
            ...
            #   [reasoning models](https://developers.openai.com/api/docs/guides/reasoning).
            #
            #   @param context [Symbol, OpenAI::Models::Beta::Responses::InputTokenCountParams::Reasoning::Context, nil]
            #     Controls which reasoning items are rendered back to the model on later turns. If
            #     omitted or set to `auto`, the model determines the context mode. The `gpt-5.6`
            #     model family defaults to `all_turns`; earlier models default to `current_turn`.
            #
            ...
            #     for the response.
            #
            #   @param effort [Symbol, OpenAI::Models::Beta::Responses::InputTokenCountParams::Reasoning::Effort, nil]
            #     Constrains effort on reasoning for reasoning models. Currently supported values
            #     are `none`, `minimal`, `low`, `medium`, `high`, `xhigh`, and `max`. Reducing
            #     reasoning effort can result in faster responses and fewer tokens used on
            #     reasoning in a response. Not all reasoning models support every value. See the
            ...
            #     model-specific support.
            #
            #   @param generate_summary [Symbol, OpenAI::Models::Beta::Responses::InputTokenCountParams::Reasoning::GenerateSummary, nil]
            #     **Deprecated:** use `summary` instead.
            #
            #     A summary of the reasoning performed by the model. This can be useful for
            #     debugging and understanding the model's reasoning process. One of `auto`,
            #     `concise`, or `detailed`.
            #
            #   @param mode [String, Symbol, OpenAI::Models::Beta::Responses::InputTokenCountParams::Reasoning::Mode]
            #     Controls the reasoning execution mode for the request.
            #
            #     When returned on a response, this is the effective execution mode.
            #
            #   @param summary [Symbol, OpenAI::Models::Beta::Responses::InputTokenCountParams::Reasoning::Summary, nil]
            #     A summary of the reasoning performed by the model. This can be useful for
            #     debugging and understanding the model's reasoning process. One of `auto`,
            #     `concise`, or `detailed`.
            #
          ...
          class Text < OpenAI::Internal::Type::BaseModel
            ...
            #     preferred for models that support it.
            #
            #   @param verbosity [Symbol, OpenAI::Models::Beta::Responses::InputTokenCountParams::Text::Verbosity, nil]
            #     Constrains the verbosity of the model's response. Lower values will result in
            #     more concise responses, while higher values will result in more verbose
            #     responses. Currently supported values are `low`, `medium`, and `high`. The
            #     default is `medium`.
