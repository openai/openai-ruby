  ...
  module Models
    module Beta
      ...
      module BetaResponseStreamEvent
        ...
        variant :"response.compaction.compacting", -> { OpenAI::Beta::BetaResponseCompactionCompactingEvent }
        ...
        variant :"response.shell_call_command.added", -> { OpenAI::Beta::BetaResponseShellCallCommandAddedEvent }

        # A streaming event that indicated a shell command was incrementally updated.
        variant :"response.shell_call_command.delta", -> { OpenAI::Beta::BetaResponseShellCallCommandDeltaEvent }

        # A streaming event that indicated a shell command was completed.
        variant :"response.shell_call_command.done", -> { OpenAI::Beta::BetaResponseShellCallCommandDoneEvent }
