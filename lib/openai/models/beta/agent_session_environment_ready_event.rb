...
module OpenAI
  module Models
    module Beta
      class AgentSessionEnvironmentReadyEvent < OpenAI::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, :"agent.session.environment.ready"]
        required :type, const: :"agent.session.environment.ready"

        # @!method initialize(environment:, event_id:, session_id:, turn_id:, type: :"agent.session.environment.ready")
        ...
        #     The ID of the turn associated with the event, when applicable.
        #
        #   @param type [Symbol, :"agent.session.environment.ready"]
        #     The type of the object. Always `agent.session.environment.ready`.
      end
    end
  end
