  ...
  module Models
    module Beta
      ...
      class ThreadCreateParams < OpenAI::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<OpenAI::Beta::ThreadCreateParams::Message>, nil]
        ...
        #
        #   @return [OpenAI::Beta::ThreadCreateParams::ToolResources, nil]
        ...
        class Message < OpenAI::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, OpenAI::Beta::ThreadCreateParams::Message::Role]
          required :role, enum: -> { OpenAI::Beta::ThreadCreateParams::Message::Role }

          # @!attribute attachments
          #   A list of files attached to the message, and the tools they should be added to.
          #
          #   @return [Array<OpenAI::Beta::ThreadCreateParams::Message::Attachment>, nil]
          ...
          #   Some parameter documentations has been truncated, see
          #   {OpenAI::Beta::ThreadCreateParams::Message} for more details.
          #
          ...
          #
          #   @param role [Symbol, OpenAI::Beta::ThreadCreateParams::Message::Role] The role of the entity that is creating the message. Allowed values include:
          #
          #   @param attachments [Array<OpenAI::Beta::ThreadCreateParams::Message::Attachment>, nil] A list of files attached to the message, and the tools they should be added to.
          #
          #   @param metadata [Hash{Symbol=>String}, nil] Set of 16 key-value pairs that can be attached to an object. This can be

          # The text contents of the message.
          #
          # @see OpenAI::Beta::ThreadCreateParams::Message#content
          module Content
            ...
            variant -> { OpenAI::Beta::ThreadCreateParams::Message::Content::MessageContentPartParamArray }
          ...
          #   value to insert messages from the assistant into the conversation.
          #
          # @see OpenAI::Beta::ThreadCreateParams::Message#role
          module Role
          ...
          class Attachment < OpenAI::Internal::Type::BaseModel
            ...
            #
            #   @return [Array<OpenAI::Beta::CodeInterpreterTool, OpenAI::Beta::ThreadCreateParams::Message::Attachment::Tool::FileSearch>, nil]
            optional :tools,
                     -> {
            ...
            #
            #   @param tools [Array<OpenAI::Beta::CodeInterpreterTool, OpenAI::Beta::ThreadCreateParams::Message::Attachment::Tool::FileSearch>] The tools to add this file to.
        ...
        class ToolResources < OpenAI::Internal::Type::BaseModel
          ...
          #
          #   @return [OpenAI::Beta::ThreadCreateParams::ToolResources::CodeInterpreter, nil]
          optional :code_interpreter, -> { OpenAI::Beta::ThreadCreateParams::ToolResources::CodeInterpreter }

          # @!attribute file_search
          #
          #   @return [OpenAI::Beta::ThreadCreateParams::ToolResources::FileSearch, nil]
          ...
          #   tool requires a list of vector store IDs.
          #
          #   @param code_interpreter [OpenAI::Beta::ThreadCreateParams::ToolResources::CodeInterpreter]
          #   @param file_search [OpenAI::Beta::ThreadCreateParams::ToolResources::FileSearch]

          # @see OpenAI::Beta::ThreadCreateParams::ToolResources#code_interpreter
          class CodeInterpreter < OpenAI::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {OpenAI::Beta::ThreadCreateParams::ToolResources::CodeInterpreter} for more
            #   details.
            #
            #   @param file_ids [Array<String>] A list of [file](https://platform.openai.com/docs/api-reference/files) IDs made
          end

          # @see OpenAI::Beta::ThreadCreateParams::ToolResources#file_search
          class FileSearch < OpenAI::Internal::Type::BaseModel
            ...
            #
            #   @return [Array<OpenAI::Beta::ThreadCreateParams::ToolResources::FileSearch::VectorStore>, nil]
            ...
            #   Some parameter documentations has been truncated, see
            #   {OpenAI::Beta::ThreadCreateParams::ToolResources::FileSearch} for more details.
            #
            #   @param vector_store_ids [Array<String>] The [vector store](https://platform.openai.com/docs/api-reference/vector-stores/
            #
            #   @param vector_stores [Array<OpenAI::Beta::ThreadCreateParams::ToolResources::FileSearch::VectorStore>] A helper to create a [vector store](https://platform.openai.com/docs/api-referen
            ...
            class VectorStore < OpenAI::Internal::Type::BaseModel
              ...
              #   strategy.
              #
              #   @return [OpenAI::Beta::ThreadCreateParams::ToolResources::FileSearch::VectorStore::ChunkingStrategy::Auto, OpenAI::Beta::ThreadCreateParams::ToolResources::FileSearch::VectorStore::ChunkingStrategy::Static, nil]
              ...
              #   Some parameter documentations has been truncated, see
              #   {OpenAI::Beta::ThreadCreateParams::ToolResources::FileSearch::VectorStore} for
              #   more details.
              #
              #   @param chunking_strategy [OpenAI::Beta::ThreadCreateParams::ToolResources::FileSearch::VectorStore::ChunkingStrategy::Auto, OpenAI::Beta::ThreadCreateParams::ToolResources::FileSearch::VectorStore::ChunkingStrategy::Static] The chunking strategy used to chunk the file(s). If not set, will use the `auto`
              #
              ...
              # strategy.
              #
              # @see OpenAI::Beta::ThreadCreateParams::ToolResources::FileSearch::VectorStore#chunking_strategy
              module ChunkingStrategy
                ...
                class Static < OpenAI::Internal::Type::BaseModel
                  # @!attribute static
                  #
                  #   @return [OpenAI::Beta::ThreadCreateParams::ToolResources::FileSearch::VectorStore::ChunkingStrategy::Static::Static]
                  required :static,
                           -> {
                  ...
                  #   @param static [OpenAI::Beta::ThreadCreateParams::ToolResources::FileSearch::VectorStore::ChunkingStrategy::Static::Static]
                  #
                  #   @param type [Symbol, :static] Always `static`.

                  # @see OpenAI::Beta::ThreadCreateParams::ToolResources::FileSearch::VectorStore::ChunkingStrategy::Static#static
                  class Static < OpenAI::Internal::Type::BaseModel
