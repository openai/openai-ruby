  ...
  module Models
    module Beta
      class BetaResponseOutputText < OpenAI::Internal::Type::BaseModel
        ...
        # @!attribute logprobs
        #
        #   @return [Array<OpenAI::Models::Beta::BetaResponseOutputText::Logprob>, nil]
        optional :logprobs, -> { OpenAI::Internal::Type::ArrayOf[OpenAI::Beta::BetaResponseOutputText::Logprob] }
        ...
        module Annotation
          ...
          variant :file_citation, -> { OpenAI::Beta::BetaResponseOutputText::Annotation::FileCitation }
        ...
        class Logprob < OpenAI::Internal::Type::BaseModel
          ...
          #   @param logprob [Float]
          #   @param top_logprobs [Array<OpenAI::Models::Beta::BetaResponseOutputText::Logprob::TopLogprob>]
