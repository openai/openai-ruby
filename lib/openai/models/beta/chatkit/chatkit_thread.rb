    ...
    module Beta
      module ChatKit
        ...
        class ChatKitThread < OpenAI::Internal::Type::BaseModel
          ...
          #     Unix timestamp (in seconds) for when the thread was created.
          #
          #   @param status [OpenAI::Models::Beta::ChatKit::ChatKitThread::Status::Active, OpenAI::Models::Beta::ChatKit::ChatKitThread::Status::Locked, OpenAI::Models::Beta::ChatKit::ChatKitThread::Status::Closed]
          #     Current status for the thread. Defaults to `active` for newly created threads.
          #
          ...
          #     Free-form string that identifies your end user who owns the thread.
          #
          #   @param object [Symbol, :"chatkit.thread"]
          #     Type discriminator that is always `chatkit.thread`.
