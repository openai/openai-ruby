      ...
      module BetaResponseSteerInput
        ...
        module ResponseSteerInputItemList
          ...
          class Message < OpenAI::Internal::Type::BaseModel
            ...
            #   @param content [Array<OpenAI::Models::Beta::BetaResponseInputTextContent, OpenAI::Models::Beta::BetaResponseInputImageContent, OpenAI::Models::Beta::BetaResponseInputFileContent>, String]
            #     The message content, as an array of content parts.
            #
            #   @param id [String, nil]
            #     The unique ID of this message item.
            #
            #   @param agent [OpenAI::Models::Beta::BetaResponseSteerInput::ResponseSteerInputItemList::Message::Agent, nil]
            #     The agent that produced this item.
            #
          ...
          class FunctionCallOutput < OpenAI::Internal::Type::BaseModel
            ...
            #   The output of a function tool call.
            #
            #   @param output [String, Array<OpenAI::Models::Beta::BetaResponseInputTextContent, OpenAI::Models::Beta::BetaResponseInputImageContent, OpenAI::Models::Beta::BetaResponseInputFileContent>]
            #     Text, image, or file output of the function tool call.
            #
            #   @param id [String, nil]
            #     The unique ID of the function tool call output. Populated when this item is
            #     returned via API.
            #
            #   @param agent [OpenAI::Models::Beta::BetaResponseSteerInput::ResponseSteerInputItemList::FunctionCallOutput::Agent, nil]
            #     The agent that produced this item.
            #
            #   @param call_id [String, nil]
            #     The unique ID of the function tool call generated by the model.
            #
            #   @param caller_ [OpenAI::Models::Beta::BetaResponseSteerInput::ResponseSteerInputItemList::FunctionCallOutput::Caller::Direct, OpenAI::Models::Beta::BetaResponseSteerInput::ResponseSteerInputItemList::FunctionCallOutput::Caller::Program, nil]
            #     The execution context that produced this tool call.
            #
            ...
            #     The namespace of the tool that produced the output.
            #
            #   @param status [Symbol, OpenAI::Models::Beta::BetaResponseSteerInput::ResponseSteerInputItemList::FunctionCallOutput::Status, nil]
            #     The status of the item. One of `in_progress`, `completed`, or `incomplete`.
            #     Populated when items are returned via API.
            #
