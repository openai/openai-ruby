  ...
  module Models
    module Beta
      class BetaResponseInputImage < OpenAI::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, OpenAI::Models::Beta::BetaResponseInputImage::Detail]
        ...
        #   token block.
        #
        #   @return [OpenAI::Models::Beta::BetaResponseInputImage::PromptCacheBreakpoint, nil]
        ...
        #   {OpenAI::Models::Beta::BetaResponseInputImage} for more details.
        #
        #   An image input to the model. Learn about
        #   [image inputs](https://platform.openai.com/docs/guides/vision).
        #
        #   @param detail [Symbol, OpenAI::Models::Beta::BetaResponseInputImage::Detail] The detail level of the image to be sent to the model. One of `high`, `low`, `au
        #
        ...
        #
        #   @param prompt_cache_breakpoint [OpenAI::Models::Beta::BetaResponseInputImage::PromptCacheBreakpoint] Marks the exact end of a reusable prompt prefix. The breakpoint inherits its TTL
        #
        ...
        # `auto`, or `original`. Defaults to `auto`.
        #
        # @see OpenAI::Models::Beta::BetaResponseInputImage#detail
        module Detail
        ...
        # @see OpenAI::Models::Beta::BetaResponseInputImage#prompt_cache_breakpoint
