  ...
  module Models
    module Beta
      class BetaResponseMcpCallInProgressEvent < OpenAI::Internal::Type::BaseModel
        ...
        #
        #   @return [OpenAI::Models::Beta::BetaResponseMcpCallInProgressEvent::Agent, nil]
        optional :agent, -> { OpenAI::Beta::BetaResponseMcpCallInProgressEvent::Agent }, nil?: true

        # @!method initialize(item_id:, output_index:, sequence_number:, agent: nil, type: :"response.mcp_call.in_progress")
        ...
        # @see OpenAI::Models::Beta::BetaResponseMcpCallInProgressEvent#agent
    ...
    BetaResponseMcpCallInProgressEvent = Beta::BetaResponseMcpCallInProgressEvent
  end
end
