  ...
  module Models
    module Beta
      ...
      module BetaComputerAction
        ...
        # A click action.
        variant :click, -> { OpenAI::Beta::BetaComputerAction::Click }

        # A double click action.
        variant :double_click, -> { OpenAI::Beta::BetaComputerAction::DoubleClick }

        # A drag action.
        variant :drag, -> { OpenAI::Beta::BetaComputerAction::Drag }

        # A collection of keypresses the model would like to perform.
        variant :keypress, -> { OpenAI::Beta::BetaComputerAction::Keypress }

        # A mouse move action.
        variant :move, -> { OpenAI::Beta::BetaComputerAction::Move }

        # A screenshot action.
        variant :screenshot, -> { OpenAI::Beta::BetaComputerAction::Screenshot }

        # A scroll action.
        variant :scroll, -> { OpenAI::Beta::BetaComputerAction::Scroll }

        # An action to type in text.
        variant :type, -> { OpenAI::Beta::BetaComputerAction::Type }

        # A wait action.
        variant :wait, -> { OpenAI::Beta::BetaComputerAction::Wait }
        ...
        class Click < OpenAI::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, OpenAI::Models::Beta::BetaComputerAction::Click::Button]
          required :button, enum: -> { OpenAI::Beta::BetaComputerAction::Click::Button }
          ...
          # `right`, `wheel`, `back`, or `forward`.
          #
          # @see OpenAI::Models::Beta::BetaComputerAction::Click#button
          module Button
        ...
        class Drag < OpenAI::Internal::Type::BaseModel
          ...
          #   ```
          #
          #   @return [Array<OpenAI::Models::Beta::BetaComputerAction::Drag::Path>]
          required :path, -> { OpenAI::Internal::Type::ArrayOf[OpenAI::Beta::BetaComputerAction::Drag::Path] }
        ...
        #   @return [Array(OpenAI::Models::Beta::BetaComputerAction::Click, OpenAI::Models::Beta::BetaComputerAction::DoubleClick, OpenAI::Models::Beta::BetaComputerAction::Drag, OpenAI::Models::Beta::BetaComputerAction::Keypress, OpenAI::Models::Beta::BetaComputerAction::Move, OpenAI::Models::Beta::BetaComputerAction::Screenshot, OpenAI::Models::Beta::BetaComputerAction::Scroll, OpenAI::Models::Beta::BetaComputerAction::Type, OpenAI::Models::Beta::BetaComputerAction::Wait)]
      end
    end
