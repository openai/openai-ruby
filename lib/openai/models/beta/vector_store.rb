  ...
  module Models
    module Beta
      class VectorStore < OpenAI::BaseModel
        ...
        #
        #   @return [OpenAI::Models::Beta::VectorStore::FileCounts]
        required :file_counts, -> { OpenAI::Models::Beta::VectorStore::FileCounts }
        ...
        #     for use.
        #
        #   @return [Symbol, OpenAI::Models::Beta::VectorStore::Status]
        required :status, enum: -> { OpenAI::Models::Beta::VectorStore::Status }
        ...
        #
        #   @return [OpenAI::Models::Beta::VectorStore::ExpiresAfter, nil]
        optional :expires_after, -> { OpenAI::Models::Beta::VectorStore::ExpiresAfter }

        # @!parse
        #   # @return [OpenAI::Models::Beta::VectorStore::ExpiresAfter]
        ...
        #   # @param file_counts [OpenAI::Models::Beta::VectorStore::FileCounts]
        #   # @param last_active_at [Integer, nil]
        #   # @param metadata [Hash{Symbol=>String}, nil]
        #   # @param name [String]
        #   # @param status [Symbol, OpenAI::Models::Beta::VectorStore::Status]
        #   # @param usage_bytes [Integer]
        #   # @param expires_after [OpenAI::Models::Beta::VectorStore::ExpiresAfter]
