  ...
  module Models
    module Beta
      ...
      module TextFormatParam
        ...
        variant :text, -> { OpenAI::Beta::TextFormatParam::Text }

        # Constrains generated text to a JSON Schema.
        variant :json_schema, -> { OpenAI::Beta::TextFormatParam::JSONSchema }
        ...
        #   @return [Array(OpenAI::Models::Beta::TextFormatParam::Text, OpenAI::Models::Beta::TextFormatParam::JSONSchema)]
      end
    end
  end
end
