  ...
  module Models
    module Beta
      ...
      class BetaResponse < OpenAI::Internal::Type::BaseModel
        ...
        #
        #   @param model [Symbol, String, OpenAI::Models::Beta::BetaResponse::Model] Model ID used to generate the response, like `gpt-6-astra`. OpenAI
        #
        ...
        #
        #   @param prompt_cache_diagnostics [OpenAI::Models::Beta::BetaResponse::PromptCacheDiagnostics::CacheMiss, OpenAI::Models::Beta::BetaResponse::PromptCacheDiagnostics::CacheHit, OpenAI::Models::Beta::BetaResponse::PromptCacheDiagnostics::ComparisonResponseNotFound, OpenAI::Models::Beta::BetaResponse::PromptCacheDiagnostics::Unavailable] Prompt cache diagnostics requested for this response.
        #
        ...
        #
        #   @param reasoning [OpenAI::Models::Beta::BetaResponse::Reasoning, nil] Configuration options for
        #
        ...
        class IncompleteDetails < OpenAI::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {OpenAI::Models::Beta::BetaResponse::IncompleteDetails} for more details.
          #
          #   Details about why the response is incomplete.
          #
          #   @param reason [Symbol, OpenAI::Models::Beta::BetaResponse::IncompleteDetails::Reason] The reason why the response is incomplete. `steered` means
        ...
        module PromptCacheDiagnostics
          ...
          class CacheMiss < OpenAI::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {OpenAI::Models::Beta::BetaResponse::PromptCacheDiagnostics::CacheMiss} for more
            #   details.
            #
            #   @param cache_missed_tokens [Integer] The estimated number of input tokens affected after the first detected divergenc
            #
            #   @param reason [Symbol, OpenAI::Models::Beta::BetaResponse::PromptCacheDiagnostics::CacheMiss::Reason] The reason prompt cache reuse did not occur.
            #
