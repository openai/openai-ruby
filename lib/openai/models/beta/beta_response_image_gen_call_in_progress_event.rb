  ...
  module Models
    module Beta
      class BetaResponseImageGenCallInProgressEvent < OpenAI::Internal::Type::BaseModel
        ...
        #
        #   @return [OpenAI::Models::Beta::BetaResponseImageGenCallInProgressEvent::Agent, nil]
        optional :agent, -> { OpenAI::Beta::BetaResponseImageGenCallInProgressEvent::Agent }, nil?: true
