  ...
  module Models
    module Beta
      class VectorStoreCreateParams < OpenAI::BaseModel
        ...
        #
        #   @return [OpenAI::Models::Beta::VectorStoreCreateParams::ExpiresAfter, nil]
        optional :expires_after, -> { OpenAI::Models::Beta::VectorStoreCreateParams::ExpiresAfter }

        # @!parse
        #   # @return [OpenAI::Models::Beta::VectorStoreCreateParams::ExpiresAfter]
        ...
        #   # @param expires_after [OpenAI::Models::Beta::VectorStoreCreateParams::ExpiresAfter]
