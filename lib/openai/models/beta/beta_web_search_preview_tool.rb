  ...
  module Models
    module Beta
      class BetaWebSearchPreviewTool < OpenAI::Internal::Type::BaseModel
        ...
        #
        #   @param type [Symbol, OpenAI::Models::Beta::BetaWebSearchPreviewTool::Type]
        #     The type of the web search tool. One of `web_search_preview` or
        #     `web_search_preview_2025_03_11`.
        #
        #   @param search_content_types [Array<Symbol, OpenAI::Models::Beta::BetaWebSearchPreviewTool::SearchContentType>]
        #
        #   @param search_context_size [Symbol, OpenAI::Models::Beta::BetaWebSearchPreviewTool::SearchContextSize]
        #     High level guidance for the amount of context window space to use for the
        #     search. One of `low`, `medium`, or `high`. `medium` is the default.
        #
