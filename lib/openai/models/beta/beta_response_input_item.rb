  ...
  module Models
    module Beta
      ...
      module BetaResponseInputItem
        ...
        variant :configuration_update, -> { OpenAI::Beta::BetaResponseConfigurationUpdateItemParam }
        ...
        class Message < OpenAI::Internal::Type::BaseModel
          ...
          #     types.
          #
          #   @param role [Symbol, OpenAI::Models::Beta::BetaResponseInputItem::Message::Role]
          #     The role of the message input. One of `user`, `system`, or `developer`.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseInputItem::Message::Agent, nil]
          #     The agent that produced this item.
          #
          #   @param status [Symbol, OpenAI::Models::Beta::BetaResponseInputItem::Message::Status]
          #     The status of item. One of `in_progress`, `completed`, or `incomplete`.
          #     Populated when items are returned via API.
          #
          #   @param type [Symbol, OpenAI::Models::Beta::BetaResponseInputItem::Message::Type]
          #     The type of the message input. Always set to `message`.
        ...
        class ComputerCallOutput < OpenAI::Internal::Type::BaseModel
          ...
          #     The ID of the computer tool call output.
          #
          #   @param acknowledged_safety_checks [Array<OpenAI::Models::Beta::BetaResponseInputItem::ComputerCallOutput::AcknowledgedSafetyCheck>, nil]
          #     The safety checks reported by the API that have been acknowledged by the
          #     developer.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseInputItem::ComputerCallOutput::Agent, nil]
          #     The agent that produced this item.
          #
          #   @param status [Symbol, OpenAI::Models::Beta::BetaResponseInputItem::ComputerCallOutput::Status, nil]
          #     The status of the message input. One of `in_progress`, `completed`, or
          #     `incomplete`. Populated when input items are returned via API.
          #
        ...
        class FunctionCallOutput < OpenAI::Internal::Type::BaseModel
          ...
          #     returned via API.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseInputItem::FunctionCallOutput::Agent, nil]
          #     The agent that produced this item.
          #
          #   @param call_id [String, nil]
          #     The unique ID of the function tool call generated by the model.
          #
          #   @param caller_ [OpenAI::Models::Beta::BetaResponseInputItem::FunctionCallOutput::Caller::Direct, OpenAI::Models::Beta::BetaResponseInputItem::FunctionCallOutput::Caller::Program, nil]
          #     The execution context that produced this tool call.
          #
          ...
          #     The namespace of the tool that produced the output.
          #
          #   @param status [Symbol, OpenAI::Models::Beta::BetaResponseInputItem::FunctionCallOutput::Status, nil]
          #     The status of the item. One of `in_progress`, `completed`, or `incomplete`.
          #     Populated when items are returned via API.
          #
        ...
        class AgentMessage < OpenAI::Internal::Type::BaseModel
          ...
          #     The sending agent identity.
          #
          #   @param content [Array<OpenAI::Models::Beta::BetaResponseInputTextContent, OpenAI::Models::Beta::BetaResponseInputImageContent, OpenAI::Models::Beta::BetaResponseInputItem::AgentMessage::Content::EncryptedContent>]
          #     Plaintext, image, or encrypted content sent between agents.
          #
          ...
          #     The unique ID of this agent message item.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseInputItem::AgentMessage::Agent, nil]
          #     The agent that produced this item.
          #
        ...
        class MultiAgentCall < OpenAI::Internal::Type::BaseModel
          ...
          #   @param action [Symbol, OpenAI::Models::Beta::BetaResponseInputItem::MultiAgentCall::Action]
          #     The multi-agent action that was executed.
          #
          ...
          #     The unique ID of this multi-agent call.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseInputItem::MultiAgentCall::Agent, nil]
          #     The agent that produced this item.
          #
          #   @param type [Symbol, :multi_agent_call]
          #     The item type. Always `multi_agent_call`.
        ...
        class MultiAgentCallOutput < OpenAI::Internal::Type::BaseModel
          ...
          #   @param action [Symbol, OpenAI::Models::Beta::BetaResponseInputItem::MultiAgentCallOutput::Action]
          #     The multi-agent action that produced this result.
          #
          #   @param call_id [String]
          #     The unique ID of the multi-agent call.
          #
          #   @param output [Array<OpenAI::Models::Beta::BetaResponseInputItem::MultiAgentCallOutput::Output>]
          #     Text output returned by the multi-agent action.
          #
          #   @param id [String, nil]
          #     The unique ID of this multi-agent call output.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseInputItem::MultiAgentCallOutput::Agent, nil]
          #     The agent that produced this item.
          #
          #   @param type [Symbol, :multi_agent_call_output]
          #     The item type. Always `multi_agent_call_output`.
        ...
        class ToolSearchCall < OpenAI::Internal::Type::BaseModel
          ...
          #     The unique ID of this tool search call.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseInputItem::ToolSearchCall::Agent, nil]
          #     The agent that produced this item.
          #
          #   @param call_id [String, nil]
          #     The unique ID of the tool search call generated by the model.
          #
          #   @param execution [Symbol, OpenAI::Models::Beta::BetaResponseInputItem::ToolSearchCall::Execution]
          #     Whether tool search was executed by the server or by the client.
          #
          #   @param status [Symbol, OpenAI::Models::Beta::BetaResponseInputItem::ToolSearchCall::Status, nil]
          #     The status of the tool search call.
          #
          #   @param type [Symbol, :tool_search_call]
          #     The item type. Always `tool_search_call`.
        ...
        class AdditionalTools < OpenAI::Internal::Type::BaseModel
          ...
          #     The unique ID of this additional tools item.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseInputItem::AdditionalTools::Agent, nil]
          #     The agent that produced this item.
          #
          #   @param role [Symbol, :developer]
          #     The role that provided the additional tools. Only `developer` is supported.
          #
          #   @param type [Symbol, :additional_tools]
          #     The item type. Always `additional_tools`.
        ...
        class ImageGenerationCall < OpenAI::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, OpenAI::Models::Beta::BetaResponseInputItem::ImageGenerationCall::Action, nil]
          optional(
            :action,
          ...
          #
          #   @return [Symbol, OpenAI::Models::Beta::BetaResponseInputItem::ImageGenerationCall::Background, nil]
          optional(
            :background,
          ...
          #
          #   @return [Symbol, OpenAI::Models::Beta::BetaResponseInputItem::ImageGenerationCall::OutputFormat, nil]
          optional(
            :output_format,
          ...
          # @!method initialize(id:, result:, status:, action: nil, agent: nil, background: nil, output_format: nil, quality: nil, revised_prompt: nil, size: nil, type: :image_generation_call)
          #   An image generation request made by the model.
          #
          #   @param id [String]
          #     The unique ID of the image generation call.
          ...
          #     The generated image encoded in base64.
          #
          #   @param status [Symbol, OpenAI::Models::Beta::BetaResponseInputItem::ImageGenerationCall::Status]
          #     The status of the image generation call.
          #
          #   @param action [Symbol, OpenAI::Models::Beta::BetaResponseInputItem::ImageGenerationCall::Action, nil]
          #     The action used for image generation.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseInputItem::ImageGenerationCall::Agent, nil]
          #     The agent that produced this item.
          #
          #   @param background [Symbol, OpenAI::Models::Beta::BetaResponseInputItem::ImageGenerationCall::Background, nil]
          #     The background setting used for generation.
          #
          #   @param output_format [Symbol, OpenAI::Models::Beta::BetaResponseInputItem::ImageGenerationCall::OutputFormat, nil]
          #     The output format used for generation.
          #
          #   @param quality [Symbol, OpenAI::Models::Beta::BetaResponseInputItem::ImageGenerationCall::Quality, nil]
          #     The quality of the image generated by the image generation tool call. One of
          #     `low`, `medium`, `high`, `xhigh`, `max`, or `auto`.
          #
          #   @param revised_prompt [String, nil]
          #     The prompt that was used after any model prompt rewriting.
          #
          #   @param size [String, Symbol, OpenAI::Models::Beta::BetaResponseInputItem::ImageGenerationCall::Size, nil]
          #     The image dimensions as a `WIDTHxHEIGHT` string, for example `1536x864`.
          #
          #   @param type [Symbol, :image_generation_call]
          #     The type of the image generation call. Always `image_generation_call`.
          ...
          # The action used for image generation.
          #
          # @see OpenAI::Models::Beta::BetaResponseInputItem::ImageGenerationCall#action
          module Action
            extend OpenAI::Internal::Type::Enum
          ...
          # The background setting used for generation.
          #
          # @see OpenAI::Models::Beta::BetaResponseInputItem::ImageGenerationCall#background
          module Background
            extend OpenAI::Internal::Type::Enum
          ...
          # The output format used for generation.
          #
          # @see OpenAI::Models::Beta::BetaResponseInputItem::ImageGenerationCall#output_format
          module OutputFormat
            extend OpenAI::Internal::Type::Enum
        ...
        class LocalShellCall < OpenAI::Internal::Type::BaseModel
          ...
          #     The unique ID of the local shell call.
          #
          #   @param action [OpenAI::Models::Beta::BetaResponseInputItem::LocalShellCall::Action]
          #     Execute a shell command on the server.
          #
          #   @param call_id [String]
          #     The unique ID of the local shell tool call generated by the model.
          #
          #   @param status [Symbol, OpenAI::Models::Beta::BetaResponseInputItem::LocalShellCall::Status]
          #     The status of the local shell call.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseInputItem::LocalShellCall::Agent, nil]
          #     The agent that produced this item.
          #
          #   @param type [Symbol, :local_shell_call]
          #     The type of the local shell call. Always `local_shell_call`.
        ...
        class LocalShellCallOutput < OpenAI::Internal::Type::BaseModel
          ...
          #     A JSON string of the output of the local shell tool call.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseInputItem::LocalShellCallOutput::Agent, nil]
          #     The agent that produced this item.
          #
          #   @param status [Symbol, OpenAI::Models::Beta::BetaResponseInputItem::LocalShellCallOutput::Status, nil]
          #     The status of the item. One of `in_progress`, `completed`, or `incomplete`.
          #
          #   @param type [Symbol, :local_shell_call_output]
          #     The type of the local shell tool call output. Always `local_shell_call_output`.
        ...
        class ShellCall < OpenAI::Internal::Type::BaseModel
          ...
          #   A tool representing a request to execute one or more shell commands.
          #
          #   @param action [OpenAI::Models::Beta::BetaResponseInputItem::ShellCall::Action]
          #     The shell commands and limits that describe how to run the tool call.
          #
          #   @param call_id [String]
          #     The unique ID of the shell tool call generated by the model.
          ...
          #     API.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseInputItem::ShellCall::Agent, nil]
          #     The agent that produced this item.
          #
          #   @param caller_ [OpenAI::Models::Beta::BetaResponseInputItem::ShellCall::Caller::Direct, OpenAI::Models::Beta::BetaResponseInputItem::ShellCall::Caller::Program, nil]
          #     The execution context that produced this tool call.
          #
          #   @param environment [OpenAI::Models::Beta::BetaLocalEnvironment, OpenAI::Models::Beta::BetaContainerReference, nil]
          #     The environment to execute the shell commands in.
          #
          #   @param status [Symbol, OpenAI::Models::Beta::BetaResponseInputItem::ShellCall::Status, nil]
          #     The status of the shell call. One of `in_progress`, `completed`, or
          #     `incomplete`.
          #
          #   @param type [Symbol, :shell_call]
          #     The type of the item. Always `shell_call`.
          ...
          class Action < OpenAI::Internal::Type::BaseModel
            ...
            #     Ordered shell commands for the execution environment to run.
            #
            #   @param max_output_length [Integer, nil]
            #     Maximum number of UTF-8 characters to capture from combined stdout and stderr
            #     output.
            #
            #   @param timeout_ms [Integer, nil]
        ...
        class ShellCallOutput < OpenAI::Internal::Type::BaseModel
          ...
          #     The unique ID of the shell tool call generated by the model.
          #
          #   @param output [Array<OpenAI::Models::Beta::BetaResponseFunctionShellCallOutputContent>]
          #     Captured chunks of stdout and stderr output, along with their associated
          #     outcomes.
          #
          #   @param id [String, nil]
          ...
          #     returned via API.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseInputItem::ShellCallOutput::Agent, nil]
          #     The agent that produced this item.
          #
          #   @param caller_ [OpenAI::Models::Beta::BetaResponseInputItem::ShellCallOutput::Caller::Direct, OpenAI::Models::Beta::BetaResponseInputItem::ShellCallOutput::Caller::Program, nil]
          #     The execution context that produced this tool call.
          #
          #   @param max_output_length [Integer, nil]
          #     The maximum number of UTF-8 characters captured for this shell call's combined
          #     output.
          #
          #   @param status [Symbol, OpenAI::Models::Beta::BetaResponseInputItem::ShellCallOutput::Status, nil]
          #     The status of the shell call output.
          #
        ...
        class ApplyPatchCall < OpenAI::Internal::Type::BaseModel
          ...
          #     The unique ID of the apply patch tool call generated by the model.
          #
          #   @param operation [OpenAI::Models::Beta::BetaResponseInputItem::ApplyPatchCall::Operation::CreateFile, OpenAI::Models::Beta::BetaResponseInputItem::ApplyPatchCall::Operation::DeleteFile, OpenAI::Models::Beta::BetaResponseInputItem::ApplyPatchCall::Operation::UpdateFile]
          #     The specific create, delete, or update instruction for the apply_patch tool
          #     call.
          #
          #   @param status [Symbol, OpenAI::Models::Beta::BetaResponseInputItem::ApplyPatchCall::Status]
          #     The status of the apply patch tool call. One of `in_progress` or `completed`.
          #
          #   @param id [String, nil]
          #     The unique ID of the apply patch tool call. Populated when this item is returned
          #     via API.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseInputItem::ApplyPatchCall::Agent, nil]
          #     The agent that produced this item.
          #
          #   @param caller_ [OpenAI::Models::Beta::BetaResponseInputItem::ApplyPatchCall::Caller::Direct, OpenAI::Models::Beta::BetaResponseInputItem::ApplyPatchCall::Caller::Program, nil]
          #     The execution context that produced this tool call.
          #
          #   @param type [Symbol, :apply_patch_call]
          #     The type of the item. Always `apply_patch_call`.
        ...
        class ApplyPatchCallOutput < OpenAI::Internal::Type::BaseModel
          ...
          #     The unique ID of the apply patch tool call generated by the model.
          #
          #   @param status [Symbol, OpenAI::Models::Beta::BetaResponseInputItem::ApplyPatchCallOutput::Status]
          #     The status of the apply patch tool call output. One of `completed` or `failed`.
          #
          #   @param id [String, nil]
          #     The unique ID of the apply patch tool call output. Populated when this item is
          #     returned via API.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseInputItem::ApplyPatchCallOutput::Agent, nil]
          #     The agent that produced this item.
          #
          #   @param caller_ [OpenAI::Models::Beta::BetaResponseInputItem::ApplyPatchCallOutput::Caller::Direct, OpenAI::Models::Beta::BetaResponseInputItem::ApplyPatchCallOutput::Caller::Program, nil]
          #     The execution context that produced this tool call.
          #
        ...
        class McpListTools < OpenAI::Internal::Type::BaseModel
          ...
          #     The label of the MCP server.
          #
          #   @param tools [Array<OpenAI::Models::Beta::BetaResponseInputItem::McpListTools::Tool>]
          #     The tools available on the server.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseInputItem::McpListTools::Agent, nil]
          #     The agent that produced this item.
          #
        ...
        class McpApprovalRequest < OpenAI::Internal::Type::BaseModel
          ...
          #     The label of the MCP server making the request.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseInputItem::McpApprovalRequest::Agent, nil]
          #     The agent that produced this item.
          #
        ...
        class McpApprovalResponse < OpenAI::Internal::Type::BaseModel
          ...
          #     The unique ID of the approval response
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseInputItem::McpApprovalResponse::Agent, nil]
          #     The agent that produced this item.
          #
        ...
        class McpCall < OpenAI::Internal::Type::BaseModel
          ...
          #     The label of the MCP server running the tool.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseInputItem::McpCall::Agent, nil]
          #     The agent that produced this item.
          #
          ...
          #     corresponding tool call.
          #
          #   @param error [OpenAI::Models::Beta::BetaMcpToolCallError::McpProtocolError, OpenAI::Models::Beta::BetaMcpToolCallError::McpToolExecutionError, OpenAI::Models::Beta::BetaMcpToolCallError::HTTPError, nil]
          #     The error from the tool call, if any.
          #
          #   @param output [String, nil]
          #     The output from the tool call.
          #
          #   @param status [Symbol, OpenAI::Models::Beta::BetaResponseInputItem::McpCall::Status]
          #     The status of the tool call. One of `in_progress`, `completed`, `incomplete`,
          #     `calling`, or `failed`.
          #
        ...
        class CompactionTrigger < OpenAI::Internal::Type::BaseModel
          ...
          #   Compacts the current context. Must be the final input item.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseInputItem::CompactionTrigger::Agent, nil]
          #     The agent that produced this item.
          #
          #   @param type [Symbol, :compaction_trigger]
          #     The type of the item. Always `compaction_trigger`.
        ...
        class ItemReference < OpenAI::Internal::Type::BaseModel
          ...
          #     The ID of the item to reference.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseInputItem::ItemReference::Agent, nil]
          #     The agent that produced this item.
          #
          #   @param type [Symbol, OpenAI::Models::Beta::BetaResponseInputItem::ItemReference::Type, nil]
          #     The type of item to reference. Always `item_reference`.
        ...
        class Program < OpenAI::Internal::Type::BaseModel
          ...
          #     Opaque program replay fingerprint that must be round-tripped.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseInputItem::Program::Agent, nil]
          #     The agent that produced this item.
          #
          #   @param type [Symbol, :program]
          #     The item type. Always `program`.
        ...
        class ProgramOutput < OpenAI::Internal::Type::BaseModel
          ...
          #     The result produced by the program item.
          #
          #   @param status [Symbol, OpenAI::Models::Beta::BetaResponseInputItem::ProgramOutput::Status]
          #     The terminal status of the program output.
          #
          #   @param agent [OpenAI::Models::Beta::BetaResponseInputItem::ProgramOutput::Agent, nil]
          #     The agent that produced this item.
          #
          #   @param type [Symbol, :program_output]
          #     The item type. Always `program_output`.
