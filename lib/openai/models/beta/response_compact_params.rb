    ...
    module Beta
      ...
      class ResponseCompactParams < OpenAI::Internal::Type::BaseModel
        ...
        module Model
          ...
          variant const: -> { OpenAI::Models::Beta::ResponseCompactParams::Model::GPT_6_ASTRA }

          variant const: -> { OpenAI::Models::Beta::ResponseCompactParams::Model::GPT_6_SOL }

          variant const: -> { OpenAI::Models::Beta::ResponseCompactParams::Model::GPT_6_LUNA }
          ...
          variant const: -> { OpenAI::Models::Beta::ResponseCompactParams::Model::GPT_AUDIO_MINI }

          variant const: -> { OpenAI::Models::Beta::ResponseCompactParams::Model::GPT_AUDIO_MINI_2025_12_15 }
          ...
          variant const: -> { OpenAI::Models::Beta::ResponseCompactParams::Model::GPT_ROSALIND_RESEARCH }
