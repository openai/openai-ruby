  ...
  module Models
    module Beta
      ...
      module PersistedAgentToolParam
        ...
        variant :function, -> { OpenAI::Beta::PersistedAgentToolParam::Function }

        # Discovers deferred function tools and loads them into the model context.
        variant :tool_search, -> { OpenAI::Beta::PersistedAgentToolParam::ToolSearch }

        # Enables calling tools from model-generated code.
        variant :programmatic_tool_calling, -> { OpenAI::Beta::PersistedAgentToolParam::ProgrammaticToolCalling }

        # Tools provided by a remote MCP server without stored credentials.
        variant :mcp, -> { OpenAI::Beta::PersistedAgentToolParam::Mcp }
        ...
        class Mcp < OpenAI::Internal::Type::BaseModel
          ...
          #
          #   @return [OpenAI::Models::Beta::PersistedMcpTransportParam::HTTP, OpenAI::Models::Beta::PersistedMcpTransportParam::Stdio]
          ...
          #     A label used to identify the MCP server in tool calls.
          #
          #   @param transport [OpenAI::Models::Beta::PersistedMcpTransportParam::HTTP, OpenAI::Models::Beta::PersistedMcpTransportParam::Stdio]
          #     The credential-free transport used to connect to the MCP server.
          #
        ...
        class WebSearch < OpenAI::Internal::Type::BaseModel
          ...
          # @see OpenAI::Models::Beta::PersistedAgentToolParam::WebSearch#location
