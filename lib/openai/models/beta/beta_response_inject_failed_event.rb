  ...
  module Models
    module Beta
      class BetaResponseInjectFailedEvent < OpenAI::Internal::Type::BaseModel
        ...
        #   when appropriate.
        #
        #   @param error [OpenAI::Models::Beta::BetaResponseInjectFailedEvent::Error]
        #     Information about why the input was not committed.
        #
        ...
        #     only when WebSocket multiplexing is enabled separately.
        #
        #   @param type [Symbol, :"response.inject.failed"]
        #     The event discriminator. Always `response.inject.failed`.
        ...
        class Error < OpenAI::Internal::Type::BaseModel
          ...
          #   Information about why the input was not committed.
          #
          #   @param code [Symbol, OpenAI::Models::Beta::BetaResponseInjectFailedEvent::Error::Code]
          #     A machine-readable error code.
          #
