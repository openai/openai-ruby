  ...
  module Models
    class CompletionUsage < OpenAI::Internal::Type::BaseModel
      ...
      class CompletionTokensDetails < OpenAI::Internal::Type::BaseModel
        ...
        # @!method initialize(accepted_prediction_tokens: nil, audio_tokens: nil, reasoning_tokens: nil, rejected_prediction_tokens: nil, text_tokens: nil)
        #   Some parameter documentations has been truncated, see
        ...
        #
        #   @param text_tokens [Integer] Text output tokens generated by the model.
      end
      ...
      class PromptTokensDetails < OpenAI::Internal::Type::BaseModel
        ...
        # @!method initialize(audio_tokens: nil, cache_write_tokens: nil, cached_tokens: nil, image_tokens: nil, text_tokens: nil)
        #   Breakdown of tokens used in the prompt.
        #
        ...
        #
        #   @param image_tokens [Integer] Image input tokens present in the prompt.
        #
        #   @param text_tokens [Integer] Text input tokens present in the prompt.
      end
    end
  end
end
