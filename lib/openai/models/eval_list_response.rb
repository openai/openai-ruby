...
module OpenAI
  module Models
    ...
    class EvalListResponse < OpenAI::Internal::Type::BaseModel
      ...
      #   @param name [String]
      #   @param testing_criteria [Array<OpenAI::Models::EvalLabelModelGrader, OpenAI::Models::EvalStringCheckGrader, OpenAI::Models::EvalTextSimilarityGrader, OpenAI::Models::EvalListResponse::TestingCriterion::Python, OpenAI::Models::EvalListResponse::TestingCriterion::ScoreModel>]
      ...
      module TestingCriterion
        ...
        class ScoreModel < OpenAI::Internal::Type::BaseModel
          ...
          #   A ScoreModelGrader object that uses a model to assign a score to the input.
          #
          #   @param input [Array<OpenAI::Models::EvalListResponse::TestingCriterion::ScoreModel::Input>]
          #   @param model [String]
          #   @param name [String]
          #   @param pass_threshold [Float]
          ...
          class Input < OpenAI::Internal::Type::BaseModel
            ...
            #   interactions.
            #
            #   @param content [String, OpenAI::Models::Responses::ResponseInputText, OpenAI::Models::EvalListResponse::TestingCriterion::ScoreModel::Input::Content::OutputText]
            #   @param role [Symbol, OpenAI::Models::EvalListResponse::TestingCriterion::ScoreModel::Input::Role]
            #   @param type [Symbol, OpenAI::Models::EvalListResponse::TestingCriterion::ScoreModel::Input::Type]
