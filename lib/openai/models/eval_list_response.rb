...
module OpenAI
  module Models
    ...
    class EvalListResponse < OpenAI::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<OpenAI::EvalLabelModelGrader, OpenAI::EvalStringCheckGrader, OpenAI::EvalTextSimilarityGrader, OpenAI::Models::EvalListResponse::TestingCriterion::Python, OpenAI::Models::EvalListResponse::TestingCriterion::ScoreModel>]
      ...
      #
      #   @param testing_criteria [Array<OpenAI::EvalLabelModelGrader, OpenAI::EvalStringCheckGrader, OpenAI::EvalTextSimilarityGrader, OpenAI::Models::EvalListResponse::TestingCriterion::Python, OpenAI::Models::EvalListResponse::TestingCriterion::ScoreModel>] A list of testing criteria.
      #
      ...
      module TestingCriterion
        ...
        class ScoreModel < OpenAI::Internal::Type::BaseModel
          ...
          class Input < OpenAI::Internal::Type::BaseModel
            ...
            #
            #   @return [String, OpenAI::Responses::ResponseInputText, OpenAI::Models::EvalListResponse::TestingCriterion::ScoreModel::Input::Content::OutputText]
            required :content,
            ...
            #   interactions.
            #
            #   @param content [String, OpenAI::Responses::ResponseInputText, OpenAI::Models::EvalListResponse::TestingCriterion::ScoreModel::Input::Content::OutputText] Text inputs to the model - can contain template strings.
            #
            ...
            module Content
              ...
              # @!method self.variants
              #   @return [Array(String, OpenAI::Responses::ResponseInputText, OpenAI::Models::EvalListResponse::TestingCriterion::ScoreModel::Input::Content::OutputText)]
            end
