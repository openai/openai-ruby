...
module OpenAI
  module Models
    ...
    class EvalRetrieveResponse < OpenAI::Internal::Type::BaseModel
      ...
      #
      #   @param testing_criteria [Array<OpenAI::Models::EvalLabelModelGrader, OpenAI::Models::EvalStringCheckGrader, OpenAI::Models::EvalTextSimilarityGrader, OpenAI::Models::EvalRetrieveResponse::TestingCriterion::Python, OpenAI::Models::EvalRetrieveResponse::TestingCriterion::ScoreModel>] A list of testing criteria.
      #
