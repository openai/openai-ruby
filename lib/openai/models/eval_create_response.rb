...
module OpenAI
  module Models
    ...
    class EvalCreateResponse < OpenAI::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel, OpenAI::Models::EvalCreateResponse::TestingCriterion::StringCheck, OpenAI::Models::EvalCreateResponse::TestingCriterion::TextSimilarity, OpenAI::Models::EvalCreateResponse::TestingCriterion::Python, OpenAI::Models::EvalCreateResponse::TestingCriterion::ScoreModel>]
      ...
      #
      #   @param testing_criteria [Array<OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel, OpenAI::Models::EvalCreateResponse::TestingCriterion::StringCheck, OpenAI::Models::EvalCreateResponse::TestingCriterion::TextSimilarity, OpenAI::Models::EvalCreateResponse::TestingCriterion::Python, OpenAI::Models::EvalCreateResponse::TestingCriterion::ScoreModel>] A list of testing criteria.
      #
      ...
      module TestingCriterion
        ...
        # in the evaluation.
        variant :label_model, -> { OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel }

        # A StringCheckGrader object that performs a string comparison between input and reference using a specified operation.
        variant :string_check, -> { OpenAI::Models::EvalCreateResponse::TestingCriterion::StringCheck }

        # A TextSimilarityGrader object which grades text based on similarity metrics.
        variant :text_similarity, -> { OpenAI::Models::EvalCreateResponse::TestingCriterion::TextSimilarity }
        ...
        class LabelModel < OpenAI::Internal::Type::BaseModel
          # @!attribute input
          #
          #   @return [Array<OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel::Input>]
          required :input,
                   -> { OpenAI::Internal::Type::ArrayOf[OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel::Input] }
          ...
          #   the evaluation.
          #
          #   @param input [Array<OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel::Input>]
          #
          ...
          class Input < OpenAI::Internal::Type::BaseModel
            ...
            #
            #   @return [String, OpenAI::Models::Responses::ResponseInputText, OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel::Input::Content::OutputText]
            required :content,
                     union: -> { OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel::Input::Content }

            # @!attribute role
            #   The role of the message input. One of `user`, `assistant`, `system`, or
            #   `developer`.
            #
            #   @return [Symbol, OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel::Input::Role]
            required :role, enum: -> { OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel::Input::Role }

            # @!attribute type
            #   The type of the message input. Always `message`.
            #
            #   @return [Symbol, OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel::Input::Type, nil]
            optional :type, enum: -> { OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel::Input::Type }

            # @!method initialize(content:, role:, type: nil)
            #   Some parameter documentations has been truncated, see
            #   {OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel::Input} for
            #   more details.
            #
            ...
            #   interactions.
            #
            #   @param content [String, OpenAI::Models::Responses::ResponseInputText, OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel::Input::Content::OutputText] Text inputs to the model - can contain template strings.
            #
            #   @param role [Symbol, OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel::Input::Role] The role of the message input. One of `user`, `assistant`, `system`, or
            #
            #   @param type [Symbol, OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel::Input::Type] The type of the message input. Always `message`.

            # Text inputs to the model - can contain template strings.
            #
            # @see OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel::Input#content
            module Content
              extend OpenAI::Internal::Type::Union
              ...
              variant -> { OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel::Input::Content::OutputText }
              ...
              class OutputText < OpenAI::Internal::Type::BaseModel
                ...
                #   Some parameter documentations has been truncated, see
                #   {OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel::Input::Content::OutputText}
                #   for more details.
                #
                #   A text output from the model.
                #
              ...
              # @!method self.variants
              #   @return [Array(String, OpenAI::Models::Responses::ResponseInputText, OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel::Input::Content::OutputText)]
            end

            # The role of the message input. One of `user`, `assistant`, `system`, or
            # `developer`.
            #
            # @see OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel::Input#role
            module Role
            ...
            # The type of the message input. Always `message`.
            #
            # @see OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel::Input#type
            module Type
              extend OpenAI::Internal::Type::Enum
        ...
        class StringCheck < OpenAI::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, OpenAI::Models::EvalCreateResponse::TestingCriterion::StringCheck::Operation]
          required :operation,
                   enum: -> { OpenAI::Models::EvalCreateResponse::TestingCriterion::StringCheck::Operation }
          ...
          #   @param name [String] The name of the grader.
          #
          #   @param operation [Symbol, OpenAI::Models::EvalCreateResponse::TestingCriterion::StringCheck::Operation] The string check operation to perform. One of `eq`, `ne`, `like`, or `ilike`.
          #
          ...
          # The string check operation to perform. One of `eq`, `ne`, `like`, or `ilike`.
          #
          # @see OpenAI::Models::EvalCreateResponse::TestingCriterion::StringCheck#operation
          module Operation
            extend OpenAI::Internal::Type::Enum
        ...
        class TextSimilarity < OpenAI::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, OpenAI::Models::EvalCreateResponse::TestingCriterion::TextSimilarity::EvaluationMetric]
          required :evaluation_metric,
                   enum: -> { OpenAI::Models::EvalCreateResponse::TestingCriterion::TextSimilarity::EvaluationMetric }
          ...
          #   Some parameter documentations has been truncated, see
          #   {OpenAI::Models::EvalCreateResponse::TestingCriterion::TextSimilarity} for more
          #   details.
          #
          #   A TextSimilarityGrader object which grades text based on similarity metrics.
          #
          #   @param evaluation_metric [Symbol, OpenAI::Models::EvalCreateResponse::TestingCriterion::TextSimilarity::EvaluationMetric] The evaluation metric to use. One of `fuzzy_match`, `bleu`, `gleu`, `meteor`, `r
          #
          ...
          # `rouge_1`, `rouge_2`, `rouge_3`, `rouge_4`, `rouge_5`, or `rouge_l`.
          #
          # @see OpenAI::Models::EvalCreateResponse::TestingCriterion::TextSimilarity#evaluation_metric
        ...
        class ScoreModel < OpenAI::Internal::Type::BaseModel
          ...
          #   A ScoreModelGrader object that uses a model to assign a score to the input.
          #
          #   @param input [Array<OpenAI::Models::EvalCreateResponse::TestingCriterion::ScoreModel::Input>] The input text. This may include template strings.
          #
          ...
          class Input < OpenAI::Internal::Type::BaseModel
            ...
            # @!method initialize(content:, role:, type: nil)
            #   Some parameter documentations has been truncated, see
            #   {OpenAI::Models::EvalCreateResponse::TestingCriterion::ScoreModel::Input} for
            #   more details.
            #
            #   A message input to the model with a role indicating instruction following
            #   hierarchy. Instructions given with the `developer` or `system` role take
