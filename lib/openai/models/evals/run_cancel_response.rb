  ...
  module Models
    module Evals
      ...
      class RunCancelResponse < OpenAI::Internal::Type::BaseModel
        ...
        #     Unix timestamp (in seconds) when the evaluation run was created.
        #
        #   @param data_source [OpenAI::Models::Evals::CreateEvalJSONLRunDataSource, OpenAI::Models::Evals::CreateEvalCompletionsRunDataSource, OpenAI::Models::Evals::RunCancelResponse::DataSource::Responses]
        #     Information about the run's data source.
        #
        ...
        module DataSource
          ...
          class Responses < OpenAI::Internal::Type::BaseModel
            ...
            #   A ResponsesRunDataSource object describing a model sampling configuration.
            #
            #   @param source [OpenAI::Models::Evals::RunCancelResponse::DataSource::Responses::Source::FileContent, OpenAI::Models::Evals::RunCancelResponse::DataSource::Responses::Source::FileID, OpenAI::Models::Evals::RunCancelResponse::DataSource::Responses::Source::Responses]
            #     Determines what populates the `item` namespace in this run's data source.
            #
            #   @param input_messages [OpenAI::Models::Evals::RunCancelResponse::DataSource::Responses::InputMessages::Template, OpenAI::Models::Evals::RunCancelResponse::DataSource::Responses::InputMessages::ItemReference]
            #     Used when sampling from a model. Dictates the structure of the messages passed
            #     into the model. Can either be a reference to a prebuilt trajectory (ie,
            #     `item.input_trajectory`), or a template with variable references to the `item`
            #     namespace.
            ...
            module Source
              ...
              class FileContent < OpenAI::Internal::Type::BaseModel
                ...
                #   @param content [Array<OpenAI::Models::Evals::RunCancelResponse::DataSource::Responses::Source::FileContent::Content>]
                #     The content of the jsonl file.
                #
            ...
            module InputMessages
              ...
              class Template < OpenAI::Internal::Type::BaseModel
                ...
                required(
                  ...
                  -> {
                    OpenAI::Internal::Type::ArrayOf[
                      union: OpenAI::Models::Evals::RunCancelResponse::DataSource::Responses::InputMessages::Template::Template
                    ]
                  }
                )
                ...
                #   @param template [Array<OpenAI::Models::Evals::RunCancelResponse::DataSource::Responses::InputMessages::Template::Template::ChatMessage, OpenAI::Models::Evals::RunCancelResponse::DataSource::Responses::InputMessages::Template::Template::EvalItem>]
                #     A list of chat messages forming the prompt or context. May include variable
                #     references to the `item` namespace, ie {{item.name}}.
                #
                ...
                module Template
                  ...
                  class EvalItem < OpenAI::Internal::Type::BaseModel
                    ...
                    required(
                      :content,
                      union: -> {
                        OpenAI::Models::Evals::RunCancelResponse::DataSource::Responses::InputMessages::Template::Template::EvalItem::Content
                      }
                    )
                    ...
                    #     input images, and input audio, either as a single item or an array of items.
                    #
                    #   @param role [Symbol, OpenAI::Models::Evals::RunCancelResponse::DataSource::Responses::InputMessages::Template::Template::EvalItem::Role]
                    #     The role of the message input. One of `user`, `assistant`, `system`, or
                    #     `developer`.
                    #
                    #   @param type [Symbol, OpenAI::Models::Evals::RunCancelResponse::DataSource::Responses::InputMessages::Template::Template::EvalItem::Type]
                    #     The type of the message input. Always `message`.
            ...
            class SamplingParams < OpenAI::Internal::Type::BaseModel
              ...
              #     A higher temperature increases randomness in the outputs.
              #
              #   @param text [OpenAI::Models::Evals::RunCancelResponse::DataSource::Responses::SamplingParams::Text]
              #     Configuration options for a text response from the model. Can be plain text or
              #     structured JSON data. Learn more:
              #
              #     - [Text inputs and outputs](https://developers.openai.com/api/docs/guides/text)
