  ...
  module Models
    module Evals
      ...
      class RunRetrieveResponse < OpenAI::Internal::Type::BaseModel
        ...
        #     Unix timestamp (in seconds) when the evaluation run was created.
        #
        #   @param data_source [OpenAI::Models::Evals::CreateEvalJSONLRunDataSource, OpenAI::Models::Evals::CreateEvalCompletionsRunDataSource, OpenAI::Models::Evals::RunRetrieveResponse::DataSource::Responses]
        #     Information about the run's data source.
        #
        ...
        module DataSource
          ...
          class Responses < OpenAI::Internal::Type::BaseModel
            ...
            #   A ResponsesRunDataSource object describing a model sampling configuration.
            #
            #   @param source [OpenAI::Models::Evals::RunRetrieveResponse::DataSource::Responses::Source::FileContent, OpenAI::Models::Evals::RunRetrieveResponse::DataSource::Responses::Source::FileID, OpenAI::Models::Evals::RunRetrieveResponse::DataSource::Responses::Source::Responses]
            #     Determines what populates the `item` namespace in this run's data source.
            #
            ...
            module Source
              ...
              class FileContent < OpenAI::Internal::Type::BaseModel
                ...
                #   @param content [Array<OpenAI::Models::Evals::RunRetrieveResponse::DataSource::Responses::Source::FileContent::Content>]
                #     The content of the jsonl file.
                #
            ...
            module InputMessages
              ...
              class Template < OpenAI::Internal::Type::BaseModel
                ...
                #   @param template [Array<OpenAI::Models::Evals::RunRetrieveResponse::DataSource::Responses::InputMessages::Template::Template::ChatMessage, OpenAI::Models::Evals::RunRetrieveResponse::DataSource::Responses::InputMessages::Template::Template::EvalItem>]
                #     A list of chat messages forming the prompt or context. May include variable
                #     references to the `item` namespace, ie {{item.name}}.
                #
                ...
                module Template
                  ...
                  class EvalItem < OpenAI::Internal::Type::BaseModel
                    ...
                    #     input images, and input audio, either as a single item or an array of items.
                    #
                    #   @param role [Symbol, OpenAI::Models::Evals::RunRetrieveResponse::DataSource::Responses::InputMessages::Template::Template::EvalItem::Role]
                    #     The role of the message input. One of `user`, `assistant`, `system`, or
                    #     `developer`.
                    #
                    #   @param type [Symbol, OpenAI::Models::Evals::RunRetrieveResponse::DataSource::Responses::InputMessages::Template::Template::EvalItem::Type]
                    #     The type of the message input. Always `message`.
            ...
            class SamplingParams < OpenAI::Internal::Type::BaseModel
              ...
              #     A higher temperature increases randomness in the outputs.
              #
              #   @param text [OpenAI::Models::Evals::RunRetrieveResponse::DataSource::Responses::SamplingParams::Text]
              #     Configuration options for a text response from the model. Can be plain text or
              #     structured JSON data. Learn more:
              #
              #     - [Text inputs and outputs](https://developers.openai.com/api/docs/guides/text)
