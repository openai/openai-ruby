  ...
  module Models
    module Evals
      ...
      class RunListResponse < OpenAI::Internal::Type::BaseModel
        ...
        #
        #   @return [OpenAI::Models::Evals::CreateEvalJSONLRunDataSource, OpenAI::Models::Evals::CreateEvalCompletionsRunDataSource, OpenAI::Models::Evals::RunListResponse::DataSource::Completions]
        ...
        #
        #   @param data_source [OpenAI::Models::Evals::CreateEvalJSONLRunDataSource, OpenAI::Models::Evals::CreateEvalCompletionsRunDataSource, OpenAI::Models::Evals::RunListResponse::DataSource::Completions] Information about the run's data source.
        #
        ...
        module DataSource
          ...
          variant :completions, -> { OpenAI::Models::Evals::RunListResponse::DataSource::Completions }

          class Completions < OpenAI::Internal::Type::BaseModel
            # @!attribute source
            #   A EvalResponsesSource object describing a run data source configuration.
            #
            #   @return [OpenAI::Models::Evals::RunListResponse::DataSource::Completions::Source::FileContent, OpenAI::Models::Evals::RunListResponse::DataSource::Completions::Source::FileID, OpenAI::Models::Evals::RunListResponse::DataSource::Completions::Source::Responses]
            required :source, union: -> { OpenAI::Models::Evals::RunListResponse::DataSource::Completions::Source }
            ...
            #
            #   @return [OpenAI::Models::Evals::RunListResponse::DataSource::Completions::InputMessages::Template, OpenAI::Models::Evals::RunListResponse::DataSource::Completions::InputMessages::ItemReference, nil]
            optional :input_messages,
                     union: -> { OpenAI::Models::Evals::RunListResponse::DataSource::Completions::InputMessages }
            ...
            #
            #   @return [OpenAI::Models::Evals::RunListResponse::DataSource::Completions::SamplingParams, nil]
            ...
            #   Some parameter documentations has been truncated, see
            #   {OpenAI::Models::Evals::RunListResponse::DataSource::Completions} for more
            #   details.
            #
            #   A ResponsesRunDataSource object describing a model sampling configuration.
            #
            #   @param source [OpenAI::Models::Evals::RunListResponse::DataSource::Completions::Source::FileContent, OpenAI::Models::Evals::RunListResponse::DataSource::Completions::Source::FileID, OpenAI::Models::Evals::RunListResponse::DataSource::Completions::Source::Responses] A EvalResponsesSource object describing a run data source configuration. ...
            #
            #   @param input_messages [OpenAI::Models::Evals::RunListResponse::DataSource::Completions::InputMessages::Template, OpenAI::Models::Evals::RunListResponse::DataSource::Completions::InputMessages::ItemReference]
            #
            #   @param model [String] The name of the model to use for generating completions (e.g. "o3-mini").
            #
            #   @param sampling_params [OpenAI::Models::Evals::RunListResponse::DataSource::Completions::SamplingParams]
            #
            #   @param type [Symbol, :completions] The type of run data source. Always `completions`.

            # A EvalResponsesSource object describing a run data source configuration.
            #
            # @see OpenAI::Models::Evals::RunListResponse::DataSource::Completions#source
            module Source
              extend OpenAI::Internal::Type::Union
              ...
              variant :file_id, -> { OpenAI::Models::Evals::RunListResponse::DataSource::Completions::Source::FileID }
              ...
              class FileContent < OpenAI::Internal::Type::BaseModel
                ...
                #
                #   @return [Array<OpenAI::Models::Evals::RunListResponse::DataSource::Completions::Source::FileContent::Content>]
                required :content,
                         -> { OpenAI::Internal::Type::ArrayOf[OpenAI::Models::Evals::RunListResponse::DataSource::Completions::Source::FileContent::Content] }
                ...
                #   @param content [Array<OpenAI::Models::Evals::RunListResponse::DataSource::Completions::Source::FileContent::Content>] The content of the jsonl file.
                #
            ...
            module InputMessages
              ...
              class Template < OpenAI::Internal::Type::BaseModel
                ...
                required :template,
                         -> { OpenAI::Internal::Type::ArrayOf[union: OpenAI::Models::Evals::RunListResponse::DataSource::Completions::InputMessages::Template::Template] }
                ...
                module Template
                  ...
                  variant -> { OpenAI::Models::Evals::RunListResponse::DataSource::Completions::InputMessages::Template::Template::ChatMessage }
                  ...
                  # `assistant` role are presumed to have been generated by the model in previous
                  # interactions.
                  variant -> { OpenAI::Models::Evals::RunListResponse::DataSource::Completions::InputMessages::Template::Template::EvalItem }
                  ...
                  class EvalItem < OpenAI::Internal::Type::BaseModel
                    ...
                    #
                    #   @return [String, OpenAI::Models::Responses::ResponseInputText, OpenAI::Models::Evals::RunListResponse::DataSource::Completions::InputMessages::Template::Template::EvalItem::Content::OutputText]
                    required :content,
                             union: -> { OpenAI::Models::Evals::RunListResponse::DataSource::Completions::InputMessages::Template::Template::EvalItem::Content }

                    # @!attribute role
                    #   The role of the message input. One of `user`, `assistant`, `system`, or
                    #   `developer`.
                    #
                    #   @return [Symbol, OpenAI::Models::Evals::RunListResponse::DataSource::Completions::InputMessages::Template::Template::EvalItem::Role]
                    required :role,
                             enum: -> { OpenAI::Models::Evals::RunListResponse::DataSource::Completions::InputMessages::Template::Template::EvalItem::Role }

                    # @!attribute type
                    #   The type of the message input. Always `message`.
                    #
                    #   @return [Symbol, OpenAI::Models::Evals::RunListResponse::DataSource::Completions::InputMessages::Template::Template::EvalItem::Type, nil]
                    optional :type,
                             enum: -> { OpenAI::Models::Evals::RunListResponse::DataSource::Completions::InputMessages::Template::Template::EvalItem::Type }
                    ...
                    #   interactions.
                    #
                    #   @param content [String, OpenAI::Models::Responses::ResponseInputText, OpenAI::Models::Evals::RunListResponse::DataSource::Completions::InputMessages::Template::Template::EvalItem::Content::OutputText] Text inputs to the model - can contain template strings. ...
                    #
                    #   @param role [Symbol, OpenAI::Models::Evals::RunListResponse::DataSource::Completions::InputMessages::Template::Template::EvalItem::Role] The role of the message input. One of `user`, `assistant`, `system`, or ...
                    #
                    #   @param type [Symbol, OpenAI::Models::Evals::RunListResponse::DataSource::Completions::InputMessages::Template::Template::EvalItem::Type] The type of the message input. Always `message`. ...

                    # Text inputs to the model - can contain template strings.
                    #
                    # @see OpenAI::Models::Evals::RunListResponse::DataSource::Completions::InputMessages::Template::Template::EvalItem#content
                    module Content
                      extend OpenAI::Internal::Type::Union
                      ...
                      variant -> { OpenAI::Models::Evals::RunListResponse::DataSource::Completions::InputMessages::Template::Template::EvalItem::Content::OutputText }
                      ...
                      # @!method self.variants
                      #   @return [Array(String, OpenAI::Models::Responses::ResponseInputText, OpenAI::Models::Evals::RunListResponse::DataSource::Completions::InputMessages::Template::Template::EvalItem::Content::OutputText)]
                    end

                    # The role of the message input. One of `user`, `assistant`, `system`, or
                    # `developer`.
                    #
                    # @see OpenAI::Models::Evals::RunListResponse::DataSource::Completions::InputMessages::Template::Template::EvalItem#role
                    module Role
                    ...
                    # The type of the message input. Always `message`.
                    #
                    # @see OpenAI::Models::Evals::RunListResponse::DataSource::Completions::InputMessages::Template::Template::EvalItem#type
                    module Type
                      extend OpenAI::Internal::Type::Enum
          ...
          # @!method self.variants
          #   @return [Array(OpenAI::Models::Evals::CreateEvalJSONLRunDataSource, OpenAI::Models::Evals::CreateEvalCompletionsRunDataSource, OpenAI::Models::Evals::RunListResponse::DataSource::Completions)]
        end
