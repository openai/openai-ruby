    ...
    module Evals
      module Runs
        ...
        class OutputItemListResponse < OpenAI::Internal::Type::BaseModel
          ...
          #     The identifier of the evaluation group.
          #
          #   @param results [Array<OpenAI::Models::Evals::Runs::OutputItemListResponse::Result>]
          #     A list of grader results for this output item.
          #
          #   @param run_id [String]
          #     The identifier of the evaluation run associated with this output item.
          #
          #   @param sample [OpenAI::Models::Evals::Runs::OutputItemListResponse::Sample]
          #     A sample containing the input and output of the evaluation run.
          #
          #   @param status [String]
          #     The status of the evaluation run.
          ...
          class Sample < OpenAI::Internal::Type::BaseModel
            ...
            #     The reason why the sample generation was finished.
            #
            #   @param input [Array<OpenAI::Models::Evals::Runs::OutputItemListResponse::Sample::Input>]
            #     An array of input messages.
            #
            ...
            #     The model used for generating the sample.
            #
            #   @param output [Array<OpenAI::Models::Evals::Runs::OutputItemListResponse::Sample::Output>]
            #     An array of output messages.
            #
            #   @param seed [Integer]
            #     The seed used for generating the sample.
            ...
            #     The top_p value used for sampling.
            #
            #   @param usage [OpenAI::Models::Evals::Runs::OutputItemListResponse::Sample::Usage]
            #     Token usage details for the sample.
