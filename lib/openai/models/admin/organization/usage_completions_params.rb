    ...
    module Admin
      module Organization
        ...
        class UsageCompletionsParams < OpenAI::Internal::Type::BaseModel
          ...
          #
          #   @return [Boolean, nil]
          optional :batch, OpenAI::Internal::Type::Boolean

          # @!attribute bucket_width
          #   Width of each time bucket in response. Currently `1m`, `1h` and `1d` are
          #   supported, default to `1d`.
          #
          #   @return [Symbol, OpenAI::Models::Admin::Organization::UsageCompletionsParams::BucketWidth, nil]
          optional :bucket_width, enum: -> { OpenAI::Admin::Organization::UsageCompletionsParams::BucketWidth }
          ...
          # @!method initialize(start_time:, api_key_ids: nil, batch: nil, bucket_width: nil, end_time: nil, group_by: nil, limit: nil, models: nil, page: nil, project_ids: nil, user_ids: nil, request_options: {})
