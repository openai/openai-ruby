...
module OpenAI
  module Models
    module Admin
      module Organization
        # @see OpenAI::Resources::Admin::Organization::Certificates#deactivate
        class CertificateDeactivateResponse < OpenAI::Internal::Type::BaseModel
          ...
          #
          #   @return [OpenAI::Models::Admin::Organization::CertificateDeactivateResponse::CertificateDetails]
          required(
            :certificate_details,
          ...
          #     Whether the certificate is currently active at the organization level.
          #
          #   @param certificate_details [OpenAI::Models::Admin::Organization::CertificateDeactivateResponse::CertificateDetails]
          #
          ...
          #     The name of the certificate.
          #
          #   @param object [Symbol, :"organization.certificate"]
          #     The object type, which is always `organization.certificate`.

          # @see OpenAI::Models::Admin::Organization::CertificateDeactivateResponse#certificate_details
