    ...
    module Admin
      module Organization
        ...
        class CertificateListParams < OpenAI::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, OpenAI::Models::Admin::Organization::CertificateListParams::Order, nil]
          optional :order, enum: -> { OpenAI::Admin::Organization::CertificateListParams::Order }
