    ...
    module Admin
      module Organization
        ...
        class UsageEmbeddingsParams < OpenAI::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, OpenAI::Models::Admin::Organization::UsageEmbeddingsParams::BucketWidth, nil]
          optional :bucket_width, enum: -> { OpenAI::Admin::Organization::UsageEmbeddingsParams::BucketWidth }
          ...
          #
          #   @return [Array<Symbol, OpenAI::Models::Admin::Organization::UsageEmbeddingsParams::GroupBy>, nil]
          optional(
            :group_by,
            -> { OpenAI::Internal::Type::ArrayOf[enum: OpenAI::Admin::Organization::UsageEmbeddingsParams::GroupBy] }
          )
