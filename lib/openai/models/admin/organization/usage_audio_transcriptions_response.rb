    ...
    module Admin
      module Organization
        ...
        class UsageAudioTranscriptionsResponse < OpenAI::Internal::Type::BaseModel
          # @!attribute data
          #
          #   @return [Array<OpenAI::Models::Admin::Organization::UsageAudioTranscriptionsResponse::Data>]
          required(
            :data,
            -> {
          ...
          #   @param data [Array<OpenAI::Models::Admin::Organization::UsageAudioTranscriptionsResponse::Data>]
          ...
          class Data < OpenAI::Internal::Type::BaseModel
            ...
            required(
              ...
              -> {
                OpenAI::Internal::Type::ArrayOf[
                  union: OpenAI::Models::Admin::Organization::UsageAudioTranscriptionsResponse::Data::Result
                ]
              }
            )
            ...
            module Result
              ...
              class OrganizationCostsResult < OpenAI::Internal::Type::BaseModel
                ...
                #
                #   @return [OpenAI::Models::Admin::Organization::UsageAudioTranscriptionsResponse::Data::Result::OrganizationCostsResult::Amount, nil]
                optional(
                  :amount,
                  -> {
                ...
                #
                #   @return [String, Symbol, OpenAI::Models::Admin::Organization::UsageAudioTranscriptionsResponse::Data::Result::OrganizationCostsResult::QuantityUnit, nil]
                optional(
                  :quantity_unit,
                  union: -> {
                ...
                #   The aggregated costs details of the specific time bucket.
                #
                #   @param amount [OpenAI::Models::Admin::Organization::UsageAudioTranscriptionsResponse::Data::Result::OrganizationCostsResult::Amount] The monetary value in its associated currency.
                #
                ...
                #
                #   @param quantity_unit [String, Symbol, OpenAI::Models::Admin::Organization::UsageAudioTranscriptionsResponse::Data::Result::OrganizationCostsResult::QuantityUnit, nil] The unit of the `quantity` value. If no single supported unit applies to the res
                #
                ...
                # result, this field is `null`.
                #
                # @see OpenAI::Models::Admin::Organization::UsageAudioTranscriptionsResponse::Data::Result::OrganizationCostsResult#quantity_unit
                module QuantityUnit
                  extend OpenAI::Internal::Type::Union
                  ...
                  variant(
                    const: -> {
                      OpenAI::Models::Admin::Organization::UsageAudioTranscriptionsResponse::Data::Result::OrganizationCostsResult::QuantityUnit::TOKENS
                    }
                  )

                  variant(
                    const: -> {
                      OpenAI::Models::Admin::Organization::UsageAudioTranscriptionsResponse::Data::Result::OrganizationCostsResult::QuantityUnit::QUANTITY_UNIT_1000_TOKENS
                    }
                  )

                  variant(
                    const: -> {
                      OpenAI::Models::Admin::Organization::UsageAudioTranscriptionsResponse::Data::Result::OrganizationCostsResult::QuantityUnit::DURATION_SECONDS
                    }
                  )

                  variant(
                    const: -> {
                      OpenAI::Models::Admin::Organization::UsageAudioTranscriptionsResponse::Data::Result::OrganizationCostsResult::QuantityUnit::DURATION_MINUTES
                    }
                  )

                  variant(
                    const: -> {
                      OpenAI::Models::Admin::Organization::UsageAudioTranscriptionsResponse::Data::Result::OrganizationCostsResult::QuantityUnit::DURATION_HOURS
                    }
                  )

                  variant(
                    const: -> {
                      OpenAI::Models::Admin::Organization::UsageAudioTranscriptionsResponse::Data::Result::OrganizationCostsResult::QuantityUnit::GIBIBYTE_HOURS
                    }
                  )

                  variant(
                    const: -> {
                      OpenAI::Models::Admin::Organization::UsageAudioTranscriptionsResponse::Data::Result::OrganizationCostsResult::QuantityUnit::IMAGES
                    }
                  )

                  variant(
                    const: -> {
                      OpenAI::Models::Admin::Organization::UsageAudioTranscriptionsResponse::Data::Result::OrganizationCostsResult::QuantityUnit::CHARACTERS
                    }
                  )
