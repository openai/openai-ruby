    ...
    module Admin
      module Organization
        ...
        class UsageAudioSpeechesParams < OpenAI::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, OpenAI::Models::Admin::Organization::UsageAudioSpeechesParams::BucketWidth, nil]
          optional :bucket_width, enum: -> { OpenAI::Admin::Organization::UsageAudioSpeechesParams::BucketWidth }
          ...
          #
          #   @return [Array<Symbol, OpenAI::Models::Admin::Organization::UsageAudioSpeechesParams::GroupBy>, nil]
          optional(
            :group_by,
            -> {
              OpenAI::Internal::Type::ArrayOf[enum: OpenAI::Admin::Organization::UsageAudioSpeechesParams::GroupBy]
            }
          )
