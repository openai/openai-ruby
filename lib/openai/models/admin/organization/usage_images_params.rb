    ...
    module Admin
      module Organization
        ...
        class UsageImagesParams < OpenAI::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, OpenAI::Models::Admin::Organization::UsageImagesParams::BucketWidth, nil]
          optional :bucket_width, enum: -> { OpenAI::Admin::Organization::UsageImagesParams::BucketWidth }
          ...
          # @!method initialize(start_time:, api_key_ids: nil, bucket_width: nil, end_time: nil, group_by: nil, limit: nil, models: nil, page: nil, project_ids: nil, sizes: nil, sources: nil, user_ids: nil, request_options: {})
