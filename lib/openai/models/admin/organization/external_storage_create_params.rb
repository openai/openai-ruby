    ...
    module Admin
      module Organization
        ...
        class ExternalStorageCreateParams < OpenAI::Internal::Type::BaseModel
          ...
          # @!attribute provider
          #
          #   @return [OpenAI::Models::Admin::Organization::ExternalStorageCreateParams::Provider::Aws, OpenAI::Models::Admin::Organization::ExternalStorageCreateParams::Provider::Azure]
          ...
          module Provider
            ...
            #   @return [Array(OpenAI::Models::Admin::Organization::ExternalStorageCreateParams::Provider::Aws, OpenAI::Models::Admin::Organization::ExternalStorageCreateParams::Provider::Azure)]
          end
        end
      end
    end
