...
module OpenAI
  module Models
    module Admin
      module Organization
        module Groups
          # @see OpenAI::Resources::Admin::Organization::Groups::Roles#retrieve
          class RoleRetrieveResponse < OpenAI::Internal::Type::BaseModel
            ...
            #
            #   @param assignment_sources [Array<OpenAI::Models::Admin::Organization::Groups::RoleRetrieveResponse::AssignmentSource>, nil] Principals from which the role assignment is inherited, when available.
            #
