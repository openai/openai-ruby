      ...
      module Organization
        module Groups
          ...
          class RoleListResponse < OpenAI::Internal::Type::BaseModel
            ...
            #
            #   @param assignment_sources [Array<OpenAI::Models::Admin::Organization::Groups::RoleListResponse::AssignmentSource>, nil] Principals from which the role assignment is inherited, when available.
            #
