      ...
      module Organization
        module Groups
          ...
          class RoleCreateResponse < OpenAI::Internal::Type::BaseModel
            ...
            #
            #   @return [OpenAI::Models::Admin::Organization::Groups::RoleCreateResponse::Group]
            required :group, -> { OpenAI::Models::Admin::Organization::Groups::RoleCreateResponse::Group }
            ...
            #
            #   @param group [OpenAI::Models::Admin::Organization::Groups::RoleCreateResponse::Group] Summary information about a group returned in role assignment responses.
            #
            ...
            # @see OpenAI::Models::Admin::Organization::Groups::RoleCreateResponse#group
