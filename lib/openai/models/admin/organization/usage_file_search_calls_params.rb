    ...
    module Admin
      module Organization
        ...
        class UsageFileSearchCallsParams < OpenAI::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, OpenAI::Models::Admin::Organization::UsageFileSearchCallsParams::BucketWidth, nil]
          ...
          # @!method initialize(start_time:, api_key_ids: nil, bucket_width: nil, end_time: nil, group_by: nil, limit: nil, page: nil, project_ids: nil, user_ids: nil, vector_store_ids: nil, request_options: {})
