...
module OpenAI
  module Models
    module Admin
      module Organization
        module Projects
          # @see OpenAI::Resources::Admin::Organization::Projects::Roles#update
          class RoleUpdateParams < OpenAI::Internal::Type::BaseModel
            ...
            # @!method initialize(project_id:, role_id:, description: nil, permissions: nil, role_name: nil, request_options: {})
