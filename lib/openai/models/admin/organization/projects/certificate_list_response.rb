...
module OpenAI
  module Models
    module Admin
      module Organization
        module Projects
          # @see OpenAI::Resources::Admin::Organization::Projects::Certificates#list
          class CertificateListResponse < OpenAI::Internal::Type::BaseModel
            ...
            #
            #   @return [OpenAI::Models::Admin::Organization::Projects::CertificateListResponse::CertificateDetails]
            ...
            #
            #   @param certificate_details [OpenAI::Models::Admin::Organization::Projects::CertificateListResponse::CertificateDetails]
            #
            ...
            # @see OpenAI::Models::Admin::Organization::Projects::CertificateListResponse#certificate_details
