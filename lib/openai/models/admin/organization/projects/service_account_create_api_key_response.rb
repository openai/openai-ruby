...
module OpenAI
  module Models
    module Admin
      module Organization
        module Projects
          # @see OpenAI::Resources::Admin::Organization::Projects::ServiceAccounts#create_api_key
          class ServiceAccountCreateAPIKeyResponse < OpenAI::Internal::Type::BaseModel
            # @!attribute id
