...
module OpenAI
  module Models
    module Admin
      module Organization
        module Projects
          # @see OpenAI::Resources::Admin::Organization::Projects::SpendAlerts#list
          class SpendAlertListParams < OpenAI::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, OpenAI::Models::Admin::Organization::Projects::SpendAlertListParams::Order, nil]
            optional :order, enum: -> { OpenAI::Admin::Organization::Projects::SpendAlertListParams::Order }

            # @!method initialize(project_id:, after: nil, before: nil, limit: nil, order: nil, request_options: {})
