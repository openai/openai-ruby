...
module OpenAI
  module Models
    module Admin
      module Organization
        module Projects
          # @see OpenAI::Resources::Admin::Organization::Projects::Certificates#activate
          class CertificateActivateResponse < OpenAI::Internal::Type::BaseModel
            ...
            #
            #   @return [OpenAI::Models::Admin::Organization::Projects::CertificateActivateResponse::CertificateDetails]
            required :certificate_details,
                     -> { OpenAI::Models::Admin::Organization::Projects::CertificateActivateResponse::CertificateDetails }
            ...
            #
            #   @param certificate_details [OpenAI::Models::Admin::Organization::Projects::CertificateActivateResponse::CertificateDetails]
            #
            ...
            # @see OpenAI::Models::Admin::Organization::Projects::CertificateActivateResponse#certificate_details
