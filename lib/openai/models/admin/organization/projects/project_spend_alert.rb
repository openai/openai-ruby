      ...
      module Organization
        module Projects
          ...
          class ProjectSpendAlert < OpenAI::Internal::Type::BaseModel
            ...
            #     The identifier, which can be referenced in API endpoints.
            #
            #   @param currency [Symbol, OpenAI::Models::Admin::Organization::Projects::ProjectSpendAlert::Currency]
            #     The currency for the threshold amount.
            #
            #   @param interval [Symbol, OpenAI::Models::Admin::Organization::Projects::ProjectSpendAlert::Interval]
            #     The time interval for evaluating spend against the threshold.
            #
            #   @param notification_channel [OpenAI::Models::Admin::Organization::Projects::ProjectSpendAlert::NotificationChannel]
            #     Email notification settings for a spend alert.
            #
            #   @param threshold_amount [Integer]
            #     The alert threshold amount, in cents.
            #
            #   @param object [Symbol, :"project.spend_alert"]
            #     The object type, which is always `project.spend_alert`.
