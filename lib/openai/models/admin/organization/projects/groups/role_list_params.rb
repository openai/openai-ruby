  ...
  module Models
    module Admin
      module Organization
        module Projects
          module Groups
            # @see OpenAI::Resources::Admin::Organization::Projects::Groups::Roles#list
            class RoleListParams < OpenAI::Internal::Type::BaseModel
              ...
              #
              #   @return [Symbol, OpenAI::Models::Admin::Organization::Projects::Groups::RoleListParams::Order, nil]
              optional :order, enum: -> { OpenAI::Admin::Organization::Projects::Groups::RoleListParams::Order }

              # @!method initialize(project_id:, group_id:, after: nil, limit: nil, order: nil, request_options: {})
              ...
              #
              #   @param order [Symbol, OpenAI::Models::Admin::Organization::Projects::Groups::RoleListParams::Order] Sort order for the returned project roles.
              #
