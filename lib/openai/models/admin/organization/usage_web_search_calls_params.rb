    ...
    module Admin
      module Organization
        ...
        class UsageWebSearchCallsParams < OpenAI::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, OpenAI::Models::Admin::Organization::UsageWebSearchCallsParams::BucketWidth, nil]
          optional :bucket_width, enum: -> { OpenAI::Admin::Organization::UsageWebSearchCallsParams::BucketWidth }

          # @!attribute context_levels
          ...
          # @!method initialize(start_time:, api_key_ids: nil, bucket_width: nil, context_levels: nil, end_time: nil, group_by: nil, limit: nil, models: nil, page: nil, project_ids: nil, user_ids: nil, request_options: {})
