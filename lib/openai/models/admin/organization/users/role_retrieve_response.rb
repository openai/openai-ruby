...
module OpenAI
  module Models
    module Admin
      module Organization
        module Users
          # @see OpenAI::Resources::Admin::Organization::Users::Roles#retrieve
          class RoleRetrieveResponse < OpenAI::Internal::Type::BaseModel
            ...
            #
            #   @param assignment_sources [Array<OpenAI::Models::Admin::Organization::Users::RoleRetrieveResponse::AssignmentSource>, nil] Principals from which the role assignment is inherited, when available.
            #
