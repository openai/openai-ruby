  ...
  module Models
    module Admin
      module Organization
        ...
        class UsageModerationsResponse < OpenAI::Internal::Type::BaseModel
          # @!attribute data
          #
          #   @return [Array<OpenAI::Models::Admin::Organization::UsageModerationsResponse::Data>]
          required(
            :data,
            -> { OpenAI::Internal::Type::ArrayOf[OpenAI::Models::Admin::Organization::UsageModerationsResponse::Data] }
          )
          ...
          class Data < OpenAI::Internal::Type::BaseModel
            ...
            module Result
              ...
              variant(
                ...
                -> {
                  OpenAI::Models::Admin::Organization::UsageModerationsResponse::Data::Result::OrganizationUsageEmbeddingsResult
                }
              )
              ...
              variant(
                ...
                -> {
                  OpenAI::Models::Admin::Organization::UsageModerationsResponse::Data::Result::OrganizationUsageModerationsResult
                }
              )
              ...
              variant(
                ...
                -> {
                  OpenAI::Models::Admin::Organization::UsageModerationsResponse::Data::Result::OrganizationUsageImagesResult
                }
              )
              ...
              variant(
                ...
                -> {
                  OpenAI::Models::Admin::Organization::UsageModerationsResponse::Data::Result::OrganizationUsageAudioSpeechesResult
                }
              )
              ...
              variant(
                ...
                -> {
                  OpenAI::Models::Admin::Organization::UsageModerationsResponse::Data::Result::OrganizationUsageAudioTranscriptionsResult
                }
              )
              ...
              variant(
                ...
                -> {
                  OpenAI::Models::Admin::Organization::UsageModerationsResponse::Data::Result::OrganizationUsageVectorStoresResult
                }
              )
              ...
              variant(
                ...
                -> {
                  OpenAI::Models::Admin::Organization::UsageModerationsResponse::Data::Result::OrganizationUsageFileSearchesResult
                }
              )
              ...
              variant(
                ...
                -> {
                  OpenAI::Models::Admin::Organization::UsageModerationsResponse::Data::Result::OrganizationUsageWebSearchesResult
                }
              )
              ...
              class OrganizationCostsResult < OpenAI::Internal::Type::BaseModel
                ...
                #
                #   @return [OpenAI::Models::Admin::Organization::UsageModerationsResponse::Data::Result::OrganizationCostsResult::Amount, nil]
                optional(
                  :amount,
                  -> {
                ...
                #
                #   @return [String, Symbol, OpenAI::Models::Admin::Organization::UsageModerationsResponse::Data::Result::OrganizationCostsResult::QuantityUnit, nil]
                optional(
                  :quantity_unit,
                  union: -> {
                    OpenAI::Models::Admin::Organization::UsageModerationsResponse::Data::Result::OrganizationCostsResult::QuantityUnit
                  },
                  nil?: true
                )
                ...
                #   The aggregated costs details of the specific time bucket.
                #
                #   @param amount [OpenAI::Models::Admin::Organization::UsageModerationsResponse::Data::Result::OrganizationCostsResult::Amount] The monetary value in its associated currency.
                #
                ...
                #
                #   @param quantity_unit [String, Symbol, OpenAI::Models::Admin::Organization::UsageModerationsResponse::Data::Result::OrganizationCostsResult::QuantityUnit, nil] The unit of the `quantity` value. If no single supported unit applies to the res
                #
                ...
                # result, this field is `null`.
                #
                # @see OpenAI::Models::Admin::Organization::UsageModerationsResponse::Data::Result::OrganizationCostsResult#quantity_unit
                module QuantityUnit
                  extend OpenAI::Internal::Type::Union
                  ...
                  variant(
                    const: -> {
                      OpenAI::Models::Admin::Organization::UsageModerationsResponse::Data::Result::OrganizationCostsResult::QuantityUnit::TOKENS
                    }
                  )

                  variant(
                    const: -> {
                      OpenAI::Models::Admin::Organization::UsageModerationsResponse::Data::Result::OrganizationCostsResult::QuantityUnit::QUANTITY_UNIT_1000_TOKENS
                    }
                  )

                  variant(
                    const: -> {
                      OpenAI::Models::Admin::Organization::UsageModerationsResponse::Data::Result::OrganizationCostsResult::QuantityUnit::DURATION_SECONDS
                    }
                  )

                  variant(
                    const: -> {
                      OpenAI::Models::Admin::Organization::UsageModerationsResponse::Data::Result::OrganizationCostsResult::QuantityUnit::DURATION_MINUTES
                    }
                  )

                  variant(
                    const: -> {
                      OpenAI::Models::Admin::Organization::UsageModerationsResponse::Data::Result::OrganizationCostsResult::QuantityUnit::DURATION_HOURS
                    }
                  )

                  variant(
                    const: -> {
                      OpenAI::Models::Admin::Organization::UsageModerationsResponse::Data::Result::OrganizationCostsResult::QuantityUnit::GIBIBYTE_HOURS
                    }
                  )

                  variant(
                    const: -> {
                      OpenAI::Models::Admin::Organization::UsageModerationsResponse::Data::Result::OrganizationCostsResult::QuantityUnit::IMAGES
                    }
                  )

                  variant(
                    const: -> {
                      OpenAI::Models::Admin::Organization::UsageModerationsResponse::Data::Result::OrganizationCostsResult::QuantityUnit::CHARACTERS
                    }
                  )
                  ...
                  define_sorbet_constant!(:Variants) do
                    T.type_alias do
                      T.any(
                        String,
                        OpenAI::Models::Admin::Organization::UsageModerationsResponse::Data::Result::OrganizationCostsResult::QuantityUnit::TaggedSymbol
                      )
                    end
                  end
