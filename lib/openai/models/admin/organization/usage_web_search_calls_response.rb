          ...
          class Data < OpenAI::Internal::Type::BaseModel
            ...
            module Result
              ...
              class OrganizationCostsResult < OpenAI::Internal::Type::BaseModel
                ...
                #
                #   @return [String, Symbol, OpenAI::Models::Admin::Organization::UsageWebSearchCallsResponse::Data::Result::OrganizationCostsResult::QuantityUnit, nil]
                optional(
                  :quantity_unit,
                  union: -> {
                    OpenAI::Models::Admin::Organization::UsageWebSearchCallsResponse::Data::Result::OrganizationCostsResult::QuantityUnit
                  },
                  nil?: true
                )
                ...
                #
                #   @param quantity_unit [String, Symbol, OpenAI::Models::Admin::Organization::UsageWebSearchCallsResponse::Data::Result::OrganizationCostsResult::QuantityUnit, nil] The unit of the `quantity` value. If no single supported unit applies to the res
                #
                ...
                # result, this field is `null`.
                #
                # @see OpenAI::Models::Admin::Organization::UsageWebSearchCallsResponse::Data::Result::OrganizationCostsResult#quantity_unit
                module QuantityUnit
                  extend OpenAI::Internal::Type::Union
                  ...
                  variant(
                    const: -> {
                      OpenAI::Models::Admin::Organization::UsageWebSearchCallsResponse::Data::Result::OrganizationCostsResult::QuantityUnit::TOKENS
                    }
                  )

                  variant(
                    const: -> {
                      OpenAI::Models::Admin::Organization::UsageWebSearchCallsResponse::Data::Result::OrganizationCostsResult::QuantityUnit::QUANTITY_UNIT_1000_TOKENS
                    }
                  )

                  variant(
                    const: -> {
                      OpenAI::Models::Admin::Organization::UsageWebSearchCallsResponse::Data::Result::OrganizationCostsResult::QuantityUnit::DURATION_SECONDS
                    }
                  )

                  variant(
                    const: -> {
                      OpenAI::Models::Admin::Organization::UsageWebSearchCallsResponse::Data::Result::OrganizationCostsResult::QuantityUnit::DURATION_MINUTES
                    }
                  )

                  variant(
                    const: -> {
                      OpenAI::Models::Admin::Organization::UsageWebSearchCallsResponse::Data::Result::OrganizationCostsResult::QuantityUnit::DURATION_HOURS
                    }
                  )

                  variant(
                    const: -> {
                      OpenAI::Models::Admin::Organization::UsageWebSearchCallsResponse::Data::Result::OrganizationCostsResult::QuantityUnit::GIBIBYTE_HOURS
                    }
                  )

                  variant(
                    const: -> {
                      OpenAI::Models::Admin::Organization::UsageWebSearchCallsResponse::Data::Result::OrganizationCostsResult::QuantityUnit::IMAGES
                    }
                  )

                  variant(
                    const: -> {
                      OpenAI::Models::Admin::Organization::UsageWebSearchCallsResponse::Data::Result::OrganizationCostsResult::QuantityUnit::CHARACTERS
                    }
                  )
                  ...
                  define_sorbet_constant!(:Variants) do
                    T.type_alias do
                      T.any(
                        String,
                        OpenAI::Models::Admin::Organization::UsageWebSearchCallsResponse::Data::Result::OrganizationCostsResult::QuantityUnit::TaggedSymbol
                      )
                    end
                  end
