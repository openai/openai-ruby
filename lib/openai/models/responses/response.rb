  ...
  module Models
    module Responses
      ...
      class Response < OpenAI::Internal::Type::BaseModel
        ...
        #
        #   @return [OpenAI::Responses::ResponseError, nil]
        required :error, -> { OpenAI::Responses::ResponseError }, nil?: true

        # @!attribute incomplete_details
        #   Details about why the response is incomplete.
        #
        #   @return [OpenAI::Responses::Response::IncompleteDetails, nil]
        ...
        #   can call.
        #
        #   @return [Symbol, OpenAI::Responses::ToolChoiceOptions, OpenAI::Responses::ToolChoiceTypes, OpenAI::Responses::ToolChoiceFunction]
        ...
        #   utilized.
        #
        #   @return [Symbol, OpenAI::Responses::Response::ServiceTier, nil]
        ...
        #
        #   @return [Symbol, OpenAI::Responses::Response::Truncation, nil]
        ...
        #
        #   @return [OpenAI::Responses::ResponseUsage, nil]
        ...
        #
        #   @param error [OpenAI::Responses::ResponseError, nil] An error object returned when the model fails to generate a Response.
        #
        #   @param incomplete_details [OpenAI::Responses::Response::IncompleteDetails, nil] Details about why the response is incomplete.
        #
        ...
        #
        #   @param service_tier [Symbol, OpenAI::Responses::Response::ServiceTier, nil] Specifies the latency tier to use for processing the request. This parameter is
        #
        #   @param status [Symbol, OpenAI::Responses::ResponseStatus] The status of the response generation. One of `completed`, `failed`,
        #
        #   @param text [OpenAI::Responses::ResponseTextConfig] Configuration options for a text response from the model. Can be plain
        #
        #   @param truncation [Symbol, OpenAI::Responses::Response::Truncation, nil] The truncation strategy to use for the model response.
        #
        #   @param usage [OpenAI::Responses::ResponseUsage] Represents token usage details including input tokens, output tokens,
        #
        ...
        # @see OpenAI::Responses::Response#incomplete_details
        class IncompleteDetails < OpenAI::Internal::Type::BaseModel
          # @!attribute reason
          #   The reason why the response is incomplete.
          #
          #   @return [Symbol, OpenAI::Responses::Response::IncompleteDetails::Reason, nil]
          optional :reason, enum: -> { OpenAI::Responses::Response::IncompleteDetails::Reason }

          # @!method initialize(reason: nil)
          #   Details about why the response is incomplete.
          #
          #   @param reason [Symbol, OpenAI::Responses::Response::IncompleteDetails::Reason] The reason why the response is incomplete.

          # The reason why the response is incomplete.
          #
          # @see OpenAI::Responses::Response::IncompleteDetails#reason
          module Reason
        ...
        # can call.
        #
        # @see OpenAI::Responses::Response#tool_choice
        module ToolChoice
        ...
        # utilized.
        #
        # @see OpenAI::Responses::Response#service_tier
        module ServiceTier
          extend OpenAI::Internal::Type::Enum
        ...
        #   for a model, the request will fail with a 400 error.
        #
        # @see OpenAI::Responses::Response#truncation
        module Truncation
          extend OpenAI::Internal::Type::Enum
