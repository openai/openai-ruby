  ...
  module Models
    module Responses
      class ResponseApplyPatchToolCall < OpenAI::Internal::Type::BaseModel
        ...
        #     The unique ID of the apply patch tool call generated by the model.
        #
        #   @param operation [OpenAI::Models::Responses::ResponseApplyPatchToolCall::Operation::CreateFile, OpenAI::Models::Responses::ResponseApplyPatchToolCall::Operation::DeleteFile, OpenAI::Models::Responses::ResponseApplyPatchToolCall::Operation::UpdateFile]
        #     One of the create_file, delete_file, or update_file operations applied via
        #     apply_patch.
        #
        #   @param status [Symbol, OpenAI::Models::Responses::ResponseApplyPatchToolCall::Status]
        #     The status of the apply patch tool call. One of `in_progress` or `completed`.
        #
        #   @param caller_ [OpenAI::Models::Responses::ResponseApplyPatchToolCall::Caller::Direct, OpenAI::Models::Responses::ResponseApplyPatchToolCall::Caller::Program, nil]
        #     The execution context that produced this tool call.
        #
