  ...
  module Models
    module Responses
      class ResponseFunctionShellToolCall < OpenAI::Internal::Type::BaseModel
        ...
        #     API.
        #
        #   @param action [OpenAI::Models::Responses::ResponseFunctionShellToolCall::Action]
        #     The shell commands and limits that describe how to run the tool call.
        #
        #   @param call_id [String]
        #     The unique ID of the shell tool call generated by the model.
        #
        #   @param environment [OpenAI::Models::Responses::ResponseLocalEnvironment, OpenAI::Models::Responses::ResponseContainerReference, nil]
        #     Represents the use of a local environment to perform shell actions.
        #
        #   @param status [Symbol, OpenAI::Models::Responses::ResponseFunctionShellToolCall::Status]
        #     The status of the shell call. One of `in_progress`, `completed`, or
        #     `incomplete`.
        #
        #   @param caller_ [OpenAI::Models::Responses::ResponseFunctionShellToolCall::Caller::Direct, OpenAI::Models::Responses::ResponseFunctionShellToolCall::Caller::Program, nil]
        #     The execution context that produced this tool call.
        #
