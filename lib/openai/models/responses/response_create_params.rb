  ...
  module Models
    module Responses
      ...
      class ResponseCreateParams < OpenAI::Internal::Type::BaseModel
        ...
        #
        #   @return [OpenAI::Models::Responses::ResponseCreateParams::AccessPrograms, nil]
        optional :access_programs, -> { OpenAI::Responses::ResponseCreateParams::AccessPrograms }
        ...
        optional :prompt_cache_options, -> { OpenAI::Responses::ResponseCreateParams::PromptCacheOptions }
        ...
        #   @param access_programs [OpenAI::Models::Responses::ResponseCreateParams::AccessPrograms]
        #     Domain-specific access programs to use for this request.
        #
        ...
        class AccessPrograms < OpenAI::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, OpenAI::Models::Responses::ResponseCreateParams::AccessPrograms::Cyber, nil]
          optional :cyber, enum: -> { OpenAI::Responses::ResponseCreateParams::AccessPrograms::Cyber }

          # @!method initialize(cyber: nil)
          #   Domain-specific access programs to use for this request.
          #
          #   @param cyber [Symbol, OpenAI::Models::Responses::ResponseCreateParams::AccessPrograms::Cyber]
          #     The Cyber access program to use for this request. Supported values are
          #     `standard`, `daybreak_blue`, and `daybreak_red`. If omitted, the API resolves
          #     the program from the model's Cyber tier and your organization and project
          #     access, subject to model-specific eligibility restrictions. By default, models
          ...
          # field, rather than an explicit Standard selection.
          #
          # @see OpenAI::Models::Responses::ResponseCreateParams::AccessPrograms#cyber
          module Cyber
        ...
        class Moderation < OpenAI::Internal::Type::BaseModel
          ...
          #
          #   @return [OpenAI::Models::Responses::ResponseCreateParams::Moderation::Policy, nil]
          ...
          class Policy < OpenAI::Internal::Type::BaseModel
            ...
            #
            #   @return [OpenAI::Models::Responses::ResponseCreateParams::Moderation::Policy::Input, nil]
            optional(
              :input,
              -> {
            ...
            #
            #   @return [OpenAI::Models::Responses::ResponseCreateParams::Moderation::Policy::Output, nil]
            optional(
              :output,
              -> {
            ...
            class Input < OpenAI::Internal::Type::BaseModel
              # @!attribute mode
              #
              #   @return [Symbol, OpenAI::Models::Responses::ResponseCreateParams::Moderation::Policy::Input::Mode]
              required :mode, enum: -> { OpenAI::Responses::ResponseCreateParams::Moderation::Policy::Input::Mode }

              # @!method initialize(mode:)
              #   The moderation policy for the response input.
              #
              #   @param mode [Symbol, OpenAI::Models::Responses::ResponseCreateParams::Moderation::Policy::Input::Mode]

              # @see OpenAI::Models::Responses::ResponseCreateParams::Moderation::Policy::Input#mode
              module Mode
                extend OpenAI::Internal::Type::Enum
            ...
            # @see OpenAI::Models::Responses::ResponseCreateParams::Moderation::Policy#output
            class Output < OpenAI::Internal::Type::BaseModel
              # @!attribute mode
              #
              #   @return [Symbol, OpenAI::Models::Responses::ResponseCreateParams::Moderation::Policy::Output::Mode]
              required :mode, enum: -> { OpenAI::Responses::ResponseCreateParams::Moderation::Policy::Output::Mode }

              # @!method initialize(mode:)
              #   The moderation policy for the response output.
              #
              #   @param mode [Symbol, OpenAI::Models::Responses::ResponseCreateParams::Moderation::Policy::Output::Mode]

              # @see OpenAI::Models::Responses::ResponseCreateParams::Moderation::Policy::Output#mode
              module Mode
                extend OpenAI::Internal::Type::Enum
        ...
        class PromptCacheOptions < OpenAI::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, OpenAI::Models::Responses::ResponseCreateParams::PromptCacheOptions::Mode, nil]
          optional :mode, enum: -> { OpenAI::Responses::ResponseCreateParams::PromptCacheOptions::Mode }
          ...
          #
          #   @return [Symbol, OpenAI::Models::Responses::ResponseCreateParams::PromptCacheOptions::Ttl, nil]
          ...
          # request does not use prompt caching.
          #
          # @see OpenAI::Models::Responses::ResponseCreateParams::PromptCacheOptions#mode
          module Mode
            extend OpenAI::Internal::Type::Enum
          ...
          # value. The backend may retain cache entries for longer.
          #
          # @see OpenAI::Models::Responses::ResponseCreateParams::PromptCacheOptions#ttl
          module Ttl
            extend OpenAI::Internal::Type::Enum
        ...
        module ToolChoice
          ...
          variant -> { OpenAI::Responses::ResponseCreateParams::ToolChoice::SpecificProgrammaticToolCallingParam }
