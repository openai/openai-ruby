    ...
    module Responses
      ...
      module ResponsesClientEvent
        ...
        class ResponseCreate < OpenAI::Internal::Type::BaseModel
          ...
          #     [Learn more](https://developers.openai.com/api/docs/guides/background).
          #
          #   @param context_management [Array<OpenAI::Models::Responses::ResponsesClientEvent::ResponseCreate::ContextManagement>, nil]
          #     Context management configuration for this request.
          #
          ...
          #     compare available models.
          #
          #   @param moderation [OpenAI::Models::Responses::ResponsesClientEvent::ResponseCreate::Moderation, nil]
          #     Configuration for running moderation on the input and output of this response.
          #
          ...
          #     [Learn more](https://developers.openai.com/api/docs/guides/prompt-caching).
          #
          #   @param prompt_cache_options [OpenAI::Models::Responses::ResponsesClientEvent::ResponseCreate::PromptCacheOptions]
          #     Options for prompt caching. Supported for `gpt-5.6` and later models. By
          #     default, OpenAI automatically chooses one implicit cache breakpoint. You can add
          #     explicit breakpoints to content blocks with `prompt_cache_breakpoint`. Each
          #     request can write up to four breakpoints. For cache matching, OpenAI considers
          ...
          #     for current details.
          #
          #   @param prompt_cache_retention [Symbol, OpenAI::Models::Responses::ResponsesClientEvent::ResponseCreate::PromptCacheRetention, nil]
          #     Deprecated. Use `prompt_cache_options.ttl` instead.
          #
          #     The retention policy for the prompt cache. Set to `24h` to enable extended
          #     prompt caching, which keeps cached prefixes active for longer, up to a maximum
          ...
          #     [Learn more](https://developers.openai.com/api/docs/guides/safety-best-practices#implement-safety-identifiers).
          #
          #   @param service_tier [Symbol, OpenAI::Models::Responses::ResponsesClientEvent::ResponseCreate::ServiceTier, nil]
          #     Specifies the processing type used for serving the request.
          #
          #     - If set to 'auto', then the request will be processed with the service tier
          #       configured in the Project settings. Unless otherwise configured, the Project
          ...
          #     lineage, so a new lane can fork from a response created on another lane.
          #
          #   @param stream_options [OpenAI::Models::Responses::ResponsesClientEvent::ResponseCreate::StreamOptions, nil]
          #     Options for streaming responses. Only set this when you set `stream: true`.
          #
          ...
          #     We generally recommend altering this or `temperature` but not both.
          #
          #   @param truncation [Symbol, OpenAI::Models::Responses::ResponsesClientEvent::ResponseCreate::Truncation, nil]
          #     The truncation strategy to use for the model response.
          #
          #     - `auto`: If the input to this Response exceeds the model's context window size,
          #       the model will truncate the response to fit the context window by dropping
          ...
          class Moderation < OpenAI::Internal::Type::BaseModel
            ...
            #     'omni-moderation-latest'.
            #
            #   @param policy [OpenAI::Models::Responses::ResponsesClientEvent::ResponseCreate::Moderation::Policy, nil]
            #     The policy to apply to moderated response input and output.
            ...
            class Policy < OpenAI::Internal::Type::BaseModel
              ...
              #   The policy to apply to moderated response input and output.
              #
              #   @param input [OpenAI::Models::Responses::ResponsesClientEvent::ResponseCreate::Moderation::Policy::Input, nil]
              #     The moderation policy for the response input.
              #
              #   @param output [OpenAI::Models::Responses::ResponsesClientEvent::ResponseCreate::Moderation::Policy::Output, nil]
              #     The moderation policy for the response output.
          ...
          class PromptCacheOptions < OpenAI::Internal::Type::BaseModel
            ...
            #     this field requests prompt cache diagnostics when the feature is enabled.
            #
            #   @param mode [Symbol, OpenAI::Models::Responses::ResponsesClientEvent::ResponseCreate::PromptCacheOptions::Mode]
            #     Controls whether OpenAI automatically creates an implicit cache breakpoint.
            #     Defaults to `implicit`. With `implicit`, OpenAI creates one implicit breakpoint
            #     and writes up to the latest three explicit breakpoints in the request. With
            #     `explicit`, OpenAI does not create an implicit breakpoint and writes up to the
            ...
            #     request does not use prompt caching.
            #
            #   @param ttl [Symbol, OpenAI::Models::Responses::ResponsesClientEvent::ResponseCreate::PromptCacheOptions::Ttl]
            #     The minimum lifetime applied to every implicit and explicit cache breakpoint
            #     written by the request. Defaults to `30m`, which is currently the only supported
            #     value. The backend may retain cache entries for longer.
