  ...
  module Models
    module Responses
      ...
      module ResponseSteerRequiredInput
        ...
        variant :function_call_output, -> { OpenAI::Responses::ResponseSteerRequiredInput::FunctionCallOutput }
        ...
        variant :computer_call_output, -> { OpenAI::Responses::ResponseSteerRequiredInput::ComputerCallOutput }

        # Supply `output` using the shell tool call output input schema. Each
        # output entry includes `stdout`, `stderr`, and `outcome`.
        variant :shell_call_output, -> { OpenAI::Responses::ResponseSteerRequiredInput::ShellCallOutput }
        ...
        # `execution: "client"`.
        variant :tool_search_output, -> { OpenAI::Responses::ResponseSteerRequiredInput::ToolSearchOutput }
        ...
        variant :mcp_approval_response, -> { OpenAI::Responses::ResponseSteerRequiredInput::McpApprovalResponse }
        ...
        class ToolSearchOutput < OpenAI::Internal::Type::BaseModel
          ...
          # @!attribute execution
          #
          #   @return [Symbol, OpenAI::Models::Responses::ResponseSteerRequiredInput::ToolSearchOutput::Execution]
          required(
            :execution,
            enum: -> { OpenAI::Responses::ResponseSteerRequiredInput::ToolSearchOutput::Execution }
          )
          ...
          #
          #   @param call_id [String]
          #   @param execution [Symbol, OpenAI::Models::Responses::ResponseSteerRequiredInput::ToolSearchOutput::Execution]
          #   @param type [Symbol, :tool_search_output]

          # @see OpenAI::Models::Responses::ResponseSteerRequiredInput::ToolSearchOutput#execution
          module Execution
