  ...
  module Models
    module Responses
      class ResponsePrompt < OpenAI::Internal::Type::BaseModel
        ...
        #     The unique identifier of the prompt template to use.
        #
        #   @param variables [Hash{Symbol=>String, OpenAI::Models::Responses::ResponseInputText, OpenAI::Models::Responses::ResponseInputImage, OpenAI::Models::Responses::ResponseInputFile}, nil]
        #     Optional map of values to substitute in for variables in your prompt. The
        #     substitution values can either be strings, or other Response input types like
        #     images or files.
        #
