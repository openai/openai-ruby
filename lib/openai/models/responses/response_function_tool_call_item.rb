  ...
  module Models
    module Responses
      class ResponseFunctionToolCallItem < OpenAI::Models::Responses::ResponseFunctionToolCall
        ...
        #     The unique ID of the function tool call.
        #
        #   @param status [Symbol, OpenAI::Models::Responses::ResponseFunctionToolCallItem::Status]
        #     The status of the item. One of `in_progress`, `completed`, or `incomplete`.
        #     Populated when items are returned via API.
        #
        #   @param async [Boolean]
        ...
        #
        #   @param caller_ [OpenAI::Models::Responses::ResponseFunctionToolCall::Caller::Direct, OpenAI::Models::Responses::ResponseFunctionToolCall::Caller::Program, nil]
