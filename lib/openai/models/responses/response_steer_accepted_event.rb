  ...
  module Models
    module Responses
      class ResponseSteerAcceptedEvent < OpenAI::Internal::Type::BaseModel
        ...
        #
        #   @return [OpenAI::Models::Responses::ResponseSteerAcceptedEvent::Steer]
        ...
        #   {OpenAI::Models::Responses::ResponseSteerAcceptedEvent} for more details.
        #
        ...
        #
        #   @param steer [OpenAI::Models::Responses::ResponseSteerAcceptedEvent::Steer] The accepted steering submission.
        #
        ...
        # @see OpenAI::Models::Responses::ResponseSteerAcceptedEvent#steer
