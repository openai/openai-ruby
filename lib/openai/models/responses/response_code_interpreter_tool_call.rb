  ...
  module Models
    module Responses
      class ResponseCodeInterpreterToolCall < OpenAI::Internal::Type::BaseModel
        ...
        #     The ID of the container used to run the code.
        #
        #   @param outputs [Array<OpenAI::Models::Responses::ResponseCodeInterpreterToolCall::Output::Logs, OpenAI::Models::Responses::ResponseCodeInterpreterToolCall::Output::Image>, nil]
        #     The outputs generated by the code interpreter, such as logs or images. Can be
        #     null if no outputs are available.
        #
