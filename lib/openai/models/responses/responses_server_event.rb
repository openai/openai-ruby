    ...
    module Responses
      ...
      module ResponsesServerEvent
        ...
        class ResponseCompactionWsCompacting < OpenAI::Models::Responses::ResponseCompactionCompactingEvent
          ...
          # @!method initialize(item_id:, output_index:, sequence_number:, stream_id: nil, type: :"response.compaction.compacting")
        ...
        class ResponseContentPartWsAdded < OpenAI::Models::Responses::ResponseContentPartAddedEvent
          ...
          #
          #   @param part [OpenAI::Models::Responses::ResponseOutputText, OpenAI::Models::Responses::ResponseOutputRefusal, OpenAI::Models::Responses::ResponseContentPartAddedEvent::Part::ReasoningText]
        ...
        class ResponseContentPartWsDone < OpenAI::Models::Responses::ResponseContentPartDoneEvent
          ...
          #     The index of the output item that the content part was added to.
          #
          #   @param part [OpenAI::Models::Responses::ResponseOutputText, OpenAI::Models::Responses::ResponseOutputRefusal, OpenAI::Models::Responses::ResponseContentPartDoneEvent::Part::ReasoningText]
        ...
        class ResponseTextWsDelta < OpenAI::Models::Responses::ResponseTextDeltaEvent
          ...
          #
          #   @param logprobs [Array<OpenAI::Models::Responses::ResponseTextDeltaEvent::Logprob>]
        ...
        class ResponseWsError < OpenAI::Internal::Type::BaseModel
          ...
          #   Emitted when an error occurs while processing a Responses WebSocket request.
          #
          #   @param error [OpenAI::Models::Responses::ResponsesServerEvent::ResponseWsError::Error]
          #     Details about the error.
          #
          #   @param sequence_number [Integer]
          #     The sequence number of an error emitted by the response stream.
          ...
          class Error < OpenAI::Internal::Type::BaseModel
            ...
            class Misalignment < OpenAI::Internal::Type::BaseModel
              ...
              #     The public explanation for this block.
              #
              #   @param error_type [String, Symbol, OpenAI::Models::Responses::ResponsesServerEvent::ResponseWsError::Error::Misalignment::ErrorType]
              #     An optional classification; clients must accept additional values.
              #
              #   @param steer [OpenAI::Models::Responses::ResponsesServerEvent::ResponseWsError::Error::Misalignment::Steer]
              #     An optional public continuation instruction.
