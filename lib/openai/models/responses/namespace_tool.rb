  ...
  module Models
    module Responses
      class NamespaceTool < OpenAI::Internal::Type::BaseModel
        ...
        #     The namespace name used in tool calls (for example, `crm`).
        #
        #   @param tools [Array<OpenAI::Models::Responses::NamespaceTool::Tool::Function, OpenAI::Models::Responses::CustomTool>]
        #     The function/custom tools available inside this namespace.
        #
        ...
        module Tool
          ...
          class Function < OpenAI::Internal::Type::BaseModel
            ...
            #   @param name [String]
            #
            #   @param allowed_callers [Array<Symbol, OpenAI::Models::Responses::NamespaceTool::Tool::Function::AllowedCaller>, nil]
            #     The tool invocation context(s).
            #
            #   @param async [Boolean]
            #     Whether the tool response can be returned asynchronously versus immediately
