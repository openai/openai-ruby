  ...
  module Models
    module Responses
      class ResponseSteerFailedEvent < OpenAI::Internal::Type::BaseModel
        ...
        #
        #   @return [OpenAI::Models::Responses::ResponseSteerFailedEvent::Error]
        required :error, -> { OpenAI::Responses::ResponseSteerFailedEvent::Error }
        ...
        #
        #   @return [OpenAI::Models::Responses::ResponseSteerFailedEvent::Steer]
        required :steer, -> { OpenAI::Responses::ResponseSteerFailedEvent::Steer }
        ...
        class Error < OpenAI::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, String, OpenAI::Models::Responses::ResponseSteerErrorCode]
          required :code, union: -> { OpenAI::Responses::ResponseSteerErrorCode }
        ...
        class Steer < OpenAI::Internal::Type::BaseModel
          ...
          required :input, union: -> { OpenAI::Responses::ResponseSteerInput }
