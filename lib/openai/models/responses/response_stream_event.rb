  ...
  module Models
    module Responses
      ...
      module ResponseStreamEvent
        ...
        variant :"response.compaction.compacting", -> { OpenAI::Responses::ResponseCompactionCompactingEvent }
        ...
        variant :"response.shell_call_command.added", -> { OpenAI::Responses::ResponseShellCallCommandAddedEvent }

        # A streaming event that indicated a shell command was incrementally updated.
        variant :"response.shell_call_command.delta", -> { OpenAI::Responses::ResponseShellCallCommandDeltaEvent }

        # A streaming event that indicated a shell command was completed.
        variant :"response.shell_call_command.done", -> { OpenAI::Responses::ResponseShellCallCommandDoneEvent }
