  ...
  module Models
    module Responses
      ...
      module ResponseSteerInput
        ...
        variant -> { OpenAI::Models::Responses::ResponseSteerInput::ResponseSteerInputItemListArray }
        ...
        module ResponseSteerInputItemList
          ...
          variant :message, -> { OpenAI::Responses::ResponseSteerInput::ResponseSteerInputItemList::Message }
          ...
          class Message < OpenAI::Internal::Type::BaseModel
            ...
            #
            #   @return [Array<OpenAI::Models::Responses::ResponseInputTextContent, OpenAI::Models::Responses::ResponseInputImageContent, OpenAI::Models::Responses::ResponseInputFileContent>, String]
            required(
              :content,
            ...
            # @!method initialize(content:, id: nil, status: nil, role: :user, type: :message)
            #   @param content [Array<OpenAI::Models::Responses::ResponseInputTextContent, OpenAI::Models::Responses::ResponseInputImageContent, OpenAI::Models::Responses::ResponseInputFileContent>, String] The message content, as an array of content parts.
            #
            ...
            # The message content, as an array of content parts.
            #
            # @see OpenAI::Models::Responses::ResponseSteerInput::ResponseSteerInputItemList::Message#content
            module Content
              extend OpenAI::Internal::Type::Union

              variant(
                -> {
                  OpenAI::Models::Responses::ResponseSteerInput::ResponseSteerInputItemList::Message::Content::ResponseSteerInputContentArray
                }
              )
              ...
              #   @return [Array(Array<OpenAI::Models::Responses::ResponseInputTextContent, OpenAI::Models::Responses::ResponseInputImageContent, OpenAI::Models::Responses::ResponseInputFileContent>, String)]

              # @type [OpenAI::Internal::Type::Converter]
              ResponseSteerInputContentArray = OpenAI::Internal::Type::ArrayOf[
                union: -> { OpenAI::Responses::ResponseSteerInputContent }
              ]
            end
          end
          ...
          class FunctionCallOutput < OpenAI::Internal::Type::BaseModel
            ...
            #
            #   @return [OpenAI::Models::Responses::ResponseSteerInput::ResponseSteerInputItemList::FunctionCallOutput::Caller::Direct, OpenAI::Models::Responses::ResponseSteerInput::ResponseSteerInputItemList::FunctionCallOutput::Caller::Program, nil]
            optional(
              :caller_,
              union: -> {
            ...
            #
            #   @return [Symbol, OpenAI::Models::Responses::ResponseSteerInput::ResponseSteerInputItemList::FunctionCallOutput::Status, nil]
            optional(
              :status,
              enum: -> {
            ...
            #   {OpenAI::Models::Responses::ResponseSteerInput::ResponseSteerInputItemList::FunctionCallOutput}
            #   for more details.
            #
            #   The output of a function tool call.
            #
            ...
            #
            #   @param caller_ [OpenAI::Models::Responses::ResponseSteerInput::ResponseSteerInputItemList::FunctionCallOutput::Caller::Direct, OpenAI::Models::Responses::ResponseSteerInput::ResponseSteerInputItemList::FunctionCallOutput::Caller::Program, nil] The execution context that produced this tool call.
            #
            ...
            #
            #   @param status [Symbol, OpenAI::Models::Responses::ResponseSteerInput::ResponseSteerInputItemList::FunctionCallOutput::Status, nil] The status of the item. One of `in_progress`, `completed`, or `incomplete`. Popu
            #
            #   @param type [Symbol, :function_call_output] The type of the function tool call output. Always `function_call_output`.

            # Text, image, or file output of the function tool call.
            #
            # @see OpenAI::Models::Responses::ResponseSteerInput::ResponseSteerInputItemList::FunctionCallOutput#output
            module Output
              extend OpenAI::Internal::Type::Union
            ...
            # The execution context that produced this tool call.
            #
            # @see OpenAI::Models::Responses::ResponseSteerInput::ResponseSteerInputItemList::FunctionCallOutput#caller_
            module Caller
              extend OpenAI::Internal::Type::Union
              ...
              # @!method self.variants
              #   @return [Array(OpenAI::Models::Responses::ResponseSteerInput::ResponseSteerInputItemList::FunctionCallOutput::Caller::Direct, OpenAI::Models::Responses::ResponseSteerInput::ResponseSteerInputItemList::FunctionCallOutput::Caller::Program)]
            end

            # The status of the item. One of `in_progress`, `completed`, or `incomplete`.
            # Populated when items are returned via API.
            #
            # @see OpenAI::Models::Responses::ResponseSteerInput::ResponseSteerInputItemList::FunctionCallOutput#status
            module Status
          ...
          # @!method self.variants
          #   @return [Array(OpenAI::Models::Responses::ResponseSteerInput::ResponseSteerInputItemList::Message, OpenAI::Models::Responses::ResponseSteerInput::ResponseSteerInputItemList::FunctionCallOutput)]
        end
        ...
        ResponseSteerInputItemListArray = OpenAI::Internal::Type::ArrayOf[
          union: -> {
            OpenAI::Responses::ResponseSteerInput::ResponseSteerInputItemList
          }
        ]
      end
    end
