  ...
  module Models
    module Responses
      class ResponseApplyPatchToolCallOutput < OpenAI::Internal::Type::BaseModel
        ...
        #     The unique ID of the apply patch tool call generated by the model.
        #
        #   @param status [Symbol, OpenAI::Models::Responses::ResponseApplyPatchToolCallOutput::Status]
        #     The status of the apply patch tool call output. One of `completed` or `failed`.
        #
        #   @param caller_ [OpenAI::Models::Responses::ResponseApplyPatchToolCallOutput::Caller::Direct, OpenAI::Models::Responses::ResponseApplyPatchToolCallOutput::Caller::Program, nil]
        #     The execution context that produced this tool call.
        #
