  ...
  module Models
    module Responses
      class ResponseInputFile < OpenAI::Internal::Type::BaseModel
        ...
        #   token block.
        #
        #   @return [OpenAI::Models::Responses::ResponseInputFile::PromptCacheBreakpoint, nil]
        optional :prompt_cache_breakpoint, -> { OpenAI::Responses::ResponseInputFile::PromptCacheBreakpoint }
        ...
        #
        #   @param detail [Symbol, OpenAI::Models::Responses::ResponseInputFile::Detail] The detail level of the file to be sent to the model. Use `auto` to let the syst
        #
        ...
        #
        #   @param prompt_cache_breakpoint [OpenAI::Models::Responses::ResponseInputFile::PromptCacheBreakpoint] Marks the exact end of a reusable prompt prefix. The breakpoint inherits its TTL
        #
        ...
        # @see OpenAI::Models::Responses::ResponseInputFile#prompt_cache_breakpoint
