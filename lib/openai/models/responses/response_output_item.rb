    ...
    module Responses
      ...
      module ResponseOutputItem
        ...
        class ImageGenerationCall < OpenAI::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, OpenAI::Responses::ResponseOutputItem::ImageGenerationCall::Status]
          ...
          #   {OpenAI::Responses::ResponseOutputItem::ImageGenerationCall} for more details.
          #
          #   An image generation request made by the model.
          #
          ...
          #
          #   @param status [Symbol, OpenAI::Responses::ResponseOutputItem::ImageGenerationCall::Status] The status of the image generation call.
          #
          #   @param type [Symbol, :image_generation_call] The type of the image generation call. Always `image_generation_call`.

          # The status of the image generation call.
          #
          # @see OpenAI::Responses::ResponseOutputItem::ImageGenerationCall#status
          module Status
        ...
        class LocalShellCall < OpenAI::Internal::Type::BaseModel
          ...
          #
          #   @return [OpenAI::Responses::ResponseOutputItem::LocalShellCall::Action]
          ...
          #
          #   @return [Symbol, OpenAI::Responses::ResponseOutputItem::LocalShellCall::Status]
          ...
          #   Some parameter documentations has been truncated, see
          #   {OpenAI::Responses::ResponseOutputItem::LocalShellCall} for more details.
          #
          #   A tool call to run a command on the local shell.
          #
          #   @param id [String] The unique ID of the local shell call.
          #
          #   @param action [OpenAI::Responses::ResponseOutputItem::LocalShellCall::Action] Execute a shell command on the server.
          #
          #   @param call_id [String] The unique ID of the local shell tool call generated by the model.
          #
          #   @param status [Symbol, OpenAI::Responses::ResponseOutputItem::LocalShellCall::Status] The status of the local shell call.
          #
          #   @param type [Symbol, :local_shell_call] The type of the local shell call. Always `local_shell_call`.

          # @see OpenAI::Responses::ResponseOutputItem::LocalShellCall#action
          class Action < OpenAI::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {OpenAI::Responses::ResponseOutputItem::LocalShellCall::Action} for more
            #   details.
            #
            #   Execute a shell command on the server.
            #
          ...
          # The status of the local shell call.
          #
          # @see OpenAI::Responses::ResponseOutputItem::LocalShellCall#status
          module Status
            extend OpenAI::Internal::Type::Enum
        ...
        class McpCall < OpenAI::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {OpenAI::Responses::ResponseOutputItem::McpCall} for more details.
          #
          #   An invocation of a tool on an MCP server.
          #
        ...
        class McpListTools < OpenAI::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<OpenAI::Responses::ResponseOutputItem::McpListTools::Tool>]
          required :tools,
                   -> {
          ...
          #   Some parameter documentations has been truncated, see
          #   {OpenAI::Responses::ResponseOutputItem::McpListTools} for more details.
          #
          #   A list of tools available on an MCP server.
          #
          ...
          #
          #   @param tools [Array<OpenAI::Responses::ResponseOutputItem::McpListTools::Tool>] The tools available on the server.
          #
          ...
          class Tool < OpenAI::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {OpenAI::Responses::ResponseOutputItem::McpListTools::Tool} for more details.
            #
        ...
        class McpApprovalRequest < OpenAI::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {OpenAI::Responses::ResponseOutputItem::McpApprovalRequest} for more details.
          #
          #   A request for human approval of a tool invocation.
          #
