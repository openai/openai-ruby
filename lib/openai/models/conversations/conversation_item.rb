  ...
  module Models
    module Conversations
      ...
      module ConversationItem
        ...
        variant :additional_tools, -> { OpenAI::Conversations::ConversationItem::AdditionalTools }
        ...
        variant :program, -> { OpenAI::Conversations::ConversationItem::Program }

        variant :program_output, -> { OpenAI::Conversations::ConversationItem::ProgramOutput }
        ...
        class ImageGenerationCall < OpenAI::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, OpenAI::Models::Conversations::ConversationItem::ImageGenerationCall::Action, nil]
          optional(
            :action,
            enum: -> { OpenAI::Conversations::ConversationItem::ImageGenerationCall::Action },
            nil?: true
          )
          ...
          #
          #   @return [Symbol, OpenAI::Models::Conversations::ConversationItem::ImageGenerationCall::Background, nil]
          optional(
            :background,
            enum: -> { OpenAI::Conversations::ConversationItem::ImageGenerationCall::Background },
            nil?: true
          )
          ...
          #
          #   @return [Symbol, OpenAI::Models::Conversations::ConversationItem::ImageGenerationCall::OutputFormat, nil]
          optional(
            :output_format,
            enum: -> { OpenAI::Conversations::ConversationItem::ImageGenerationCall::OutputFormat },
            nil?: true
          )
          ...
          #     The generated image encoded in base64.
          #
          #   @param status [Symbol, OpenAI::Models::Conversations::ConversationItem::ImageGenerationCall::Status]
          #     The status of the image generation call.
          #
          #   @param action [Symbol, OpenAI::Models::Conversations::ConversationItem::ImageGenerationCall::Action, nil]
          #     The action used for image generation.
          #
          #   @param background [Symbol, OpenAI::Models::Conversations::ConversationItem::ImageGenerationCall::Background, nil]
          #     The background setting used for generation.
          #
          #   @param output_format [Symbol, OpenAI::Models::Conversations::ConversationItem::ImageGenerationCall::OutputFormat, nil]
          #     The output format used for generation.
          #
          #   @param quality [Symbol, OpenAI::Models::Conversations::ConversationItem::ImageGenerationCall::Quality, nil]
          #     The quality of the image generated by the image generation tool call. One of
          #     `low`, `medium`, `high`, `xhigh`, `max`, or `auto`.
          #
          ...
          #     The prompt that was used after any model prompt rewriting.
          #
          #   @param size [String, Symbol, OpenAI::Models::Conversations::ConversationItem::ImageGenerationCall::Size, nil]
          #     The image dimensions as a `WIDTHxHEIGHT` string, for example `1536x864`.
          #
          ...
          # The background setting used for generation.
          #
          # @see OpenAI::Models::Conversations::ConversationItem::ImageGenerationCall#background
          module Background
            extend OpenAI::Internal::Type::Enum
          ...
          # The output format used for generation.
          #
          # @see OpenAI::Models::Conversations::ConversationItem::ImageGenerationCall#output_format
          module OutputFormat
            extend OpenAI::Internal::Type::Enum
        ...
        class AdditionalTools < OpenAI::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, OpenAI::Models::Conversations::ConversationItem::AdditionalTools::Role]
          required :role, enum: -> { OpenAI::Conversations::ConversationItem::AdditionalTools::Role }
          ...
          #     The unique ID of the additional tools item.
          #
          #   @param role [Symbol, OpenAI::Models::Conversations::ConversationItem::AdditionalTools::Role]
          #     The role that provided the additional tools.
          #
          ...
          # The role that provided the additional tools.
          #
          # @see OpenAI::Models::Conversations::ConversationItem::AdditionalTools#role
          module Role
            extend OpenAI::Internal::Type::Enum
        ...
        class ProgramOutput < OpenAI::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, OpenAI::Models::Conversations::ConversationItem::ProgramOutput::Status]
          required :status, enum: -> { OpenAI::Conversations::ConversationItem::ProgramOutput::Status }
          ...
          #     The result produced by the program item.
          #
          #   @param status [Symbol, OpenAI::Models::Conversations::ConversationItem::ProgramOutput::Status]
          #     The terminal status of the program output item.
          #
          ...
          # The terminal status of the program output item.
          #
          # @see OpenAI::Models::Conversations::ConversationItem::ProgramOutput#status
          module Status
            extend OpenAI::Internal::Type::Enum
        ...
        class LocalShellCall < OpenAI::Internal::Type::BaseModel
          ...
          #     The unique ID of the local shell call.
          #
          #   @param action [OpenAI::Models::Conversations::ConversationItem::LocalShellCall::Action]
          #     Execute a shell command on the server.
          #
          #   @param call_id [String]
          #     The unique ID of the local shell tool call generated by the model.
          #
          #   @param status [Symbol, OpenAI::Models::Conversations::ConversationItem::LocalShellCall::Status]
          #     The status of the local shell call.
          #
        ...
        class LocalShellCallOutput < OpenAI::Internal::Type::BaseModel
          ...
          #     A JSON string of the output of the local shell tool call.
          #
          #   @param status [Symbol, OpenAI::Models::Conversations::ConversationItem::LocalShellCallOutput::Status, nil]
          #     The status of the item. One of `in_progress`, `completed`, or `incomplete`.
          #
        ...
        class McpListTools < OpenAI::Internal::Type::BaseModel
          ...
          #     The label of the MCP server.
          #
          #   @param tools [Array<OpenAI::Models::Conversations::ConversationItem::McpListTools::Tool>]
          #     The tools available on the server.
          #
        ...
        class McpCall < OpenAI::Internal::Type::BaseModel
          ...
          #     The output from the tool call.
          #
          #   @param status [Symbol, OpenAI::Models::Conversations::ConversationItem::McpCall::Status]
          #     The status of the tool call. One of `in_progress`, `completed`, `incomplete`,
          #     `calling`, or `failed`.
          #
