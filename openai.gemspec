...
Gem::Specification.new do |s|
  ...
  s.files = Dir[
    ...
    [
      ...
      "examples/realtime/browser/README.md",
      "examples/realtime/browser/server.rb",
      "examples/realtime/browser/index.html",
      "examples/realtime/browser/page.js",
      "examples/realtime/browser/peer.js",
