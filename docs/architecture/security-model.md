...
- Subject-token sources, token issuers, Azure/Bedrock endpoints, and X.509
  transports are credential-brokering boundaries. Credentials must remain
  bound to their intended issuer and destination
