    ...
    module Graders
      ...
      class TextSimilarityGrader < OpenAI::Internal::Type::BaseModel
        ...
        module EvaluationMetric
          ...
          TaggedSymbol = T.type_alias { T.all(Symbol, OpenAI::Graders::TextSimilarityGrader::EvaluationMetric) }
          OrSymbol = T.type_alias { T.any(Symbol, String) }

          COSINE = T.let(:cosine, OpenAI::Graders::TextSimilarityGrader::EvaluationMetric::TaggedSymbol)
          ...
          GLEU = T.let(:gleu, OpenAI::Graders::TextSimilarityGrader::EvaluationMetric::TaggedSymbol)
          ...
          ROUGE_5 = T.let(:rouge_5, OpenAI::Graders::TextSimilarityGrader::EvaluationMetric::TaggedSymbol)
          ROUGE_L = T.let(:rouge_l, OpenAI::Graders::TextSimilarityGrader::EvaluationMetric::TaggedSymbol)

          sig { override.returns(T::Array[OpenAI::Graders::TextSimilarityGrader::EvaluationMetric::TaggedSymbol]) }
          def self.values
          end
        end
