    ...
    module Admin
      ...
      module Organization
        ...
        class UsageEmbeddingsParams < OpenAI::Internal::Type::BaseModel
          ...
          sig { returns(T.nilable(OpenAI::Admin::Organization::UsageEmbeddingsParams::BucketWidth::OrSymbol)) }
          attr_reader :bucket_width

          sig { params(bucket_width: OpenAI::Admin::Organization::UsageEmbeddingsParams::BucketWidth::OrSymbol).void }
          ...
          sig { returns(T.nilable(T::Array[OpenAI::Admin::Organization::UsageEmbeddingsParams::GroupBy::OrSymbol])) }
          attr_reader :group_by

          sig {
            params(group_by: T::Array[OpenAI::Admin::Organization::UsageEmbeddingsParams::GroupBy::OrSymbol]).void
          }
          ...
          module BucketWidth
            ...
            TaggedSymbol = T.type_alias {
              T.all(Symbol, OpenAI::Admin::Organization::UsageEmbeddingsParams::BucketWidth)
            }
            ...
            sig {
              override.returns(T::Array[OpenAI::Admin::Organization::UsageEmbeddingsParams::BucketWidth::TaggedSymbol])
            }
            def self.values
            end
          end
          ...
          module GroupBy
            ...
            TaggedSymbol = T.type_alias { T.all(Symbol, OpenAI::Admin::Organization::UsageEmbeddingsParams::GroupBy) }
            OrSymbol = T.type_alias { T.any(Symbol, String) }

            PROJECT_ID = T.let(:project_id, OpenAI::Admin::Organization::UsageEmbeddingsParams::GroupBy::TaggedSymbol)
            USER_ID = T.let(:user_id, OpenAI::Admin::Organization::UsageEmbeddingsParams::GroupBy::TaggedSymbol)
            API_KEY_ID = T.let(:api_key_id, OpenAI::Admin::Organization::UsageEmbeddingsParams::GroupBy::TaggedSymbol)
            MODEL = T.let(:model, OpenAI::Admin::Organization::UsageEmbeddingsParams::GroupBy::TaggedSymbol)

            sig {
              override.returns(T::Array[OpenAI::Admin::Organization::UsageEmbeddingsParams::GroupBy::TaggedSymbol])
            }
            def self.values
            end
          end
