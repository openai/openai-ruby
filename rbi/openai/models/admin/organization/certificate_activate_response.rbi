    ...
    module Admin
      ...
      module Organization
        ...
        class CertificateActivateResponse < OpenAI::Internal::Type::BaseModel
          ...
          sig { returns(OpenAI::Models::Admin::Organization::CertificateActivateResponse::CertificateDetails) }
          attr_reader :certificate_details

          sig {
            params(
              certificate_details: OpenAI::Models::Admin::Organization::CertificateActivateResponse::CertificateDetails::OrHash
            )
              .void
          }
