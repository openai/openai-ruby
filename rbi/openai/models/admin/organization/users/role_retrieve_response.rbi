      ...
      module Organization
        ...
        module Users
          ...
          class RoleRetrieveResponse < OpenAI::Internal::Type::BaseModel
            ...
            sig {
              returns(
                T.nilable(T::Array[OpenAI::Models::Admin::Organization::Users::RoleRetrieveResponse::AssignmentSource])
              )
            }
            ...
            sig do
              params(
                ...
                assignment_sources: T.nilable(
                  T::Array[OpenAI::Models::Admin::Organization::Users::RoleRetrieveResponse::AssignmentSource::OrHash]
                ),
              ...
              override.returns(
                {
                  id: String,
                  assignment_sources: T.nilable(
                    T::Array[OpenAI::Models::Admin::Organization::Users::RoleRetrieveResponse::AssignmentSource]
                  ),
                  created_at: T.nilable(Integer),
                  created_by: T.nilable(String),
                  created_by_user_obj: T.nilable(T::Hash[Symbol, T.anything]),
