    ...
    module Admin
      ...
      module Organization
        ...
        class UsageCompletionsResponse < OpenAI::Internal::Type::BaseModel
          ...
          sig { returns(T::Array[OpenAI::Models::Admin::Organization::UsageCompletionsResponse::Data]) }
          attr_accessor :data
          ...
          sig do
            params(
              ...
              data: T::Array[OpenAI::Models::Admin::Organization::UsageCompletionsResponse::Data::OrHash],
          ...
          sig do
            override.returns(
              {
                data: T::Array[OpenAI::Models::Admin::Organization::UsageCompletionsResponse::Data],
                has_more: T::Boolean,
                next_page: T.nilable(String),
                object: Symbol
              }
          ...
          class Data < OpenAI::Internal::Type::BaseModel
            ...
            sig {
              returns(T::Array[OpenAI::Models::Admin::Organization::UsageCompletionsResponse::Data::Result::Variants])
            }
            ...
            module Result
              ...
              class OrganizationCostsResult < OpenAI::Internal::Type::BaseModel
                ...
                sig {
                  params(
                    amount: OpenAI::Models::Admin::Organization::UsageCompletionsResponse::Data::Result::OrganizationCostsResult::Amount::OrHash
                  )
                    .void
                }
                attr_writer :amount
                ...
                sig {
                  returns(
                    T.nilable(
                      OpenAI::Models::Admin::Organization::UsageCompletionsResponse::Data::Result::OrganizationCostsResult::QuantityUnit::Variants
                    )
                  )
                }
                ...
                sig do
                  params(
                    ...
                    quantity_unit: T.nilable(
                      T.any(
                        String,
                        OpenAI::Models::Admin::Organization::UsageCompletionsResponse::Data::Result::OrganizationCostsResult::QuantityUnit::OrSymbol
                      )
                    ),
              ...
              sig {
                override.returns(
                  T::Array[OpenAI::Models::Admin::Organization::UsageCompletionsResponse::Data::Result::Variants]
                )
              }
              def self.variants
              end
