    ...
    module Admin
      ...
      module Organization
        ...
        class UsageWebSearchCallsResponse < OpenAI::Internal::Type::BaseModel
          ...
          sig { returns(T::Array[OpenAI::Models::Admin::Organization::UsageWebSearchCallsResponse::Data]) }
          attr_accessor :data
          ...
          sig do
            params(
              ...
              data: T::Array[OpenAI::Models::Admin::Organization::UsageWebSearchCallsResponse::Data::OrHash],
          ...
          sig do
            override.returns(
              {
                data: T::Array[OpenAI::Models::Admin::Organization::UsageWebSearchCallsResponse::Data],
                has_more: T::Boolean,
                next_page: T.nilable(String),
                object: Symbol
              }
          ...
          class Data < OpenAI::Internal::Type::BaseModel
            ...
            sig {
              returns(
                T::Array[OpenAI::Models::Admin::Organization::UsageWebSearchCallsResponse::Data::Result::Variants]
              )
            }
            ...
            module Result
              ...
              class OrganizationCostsResult < OpenAI::Internal::Type::BaseModel
                ...
                sig {
                  params(
                    amount: OpenAI::Models::Admin::Organization::UsageWebSearchCallsResponse::Data::Result::OrganizationCostsResult::Amount::OrHash
                  )
                    .void
                }
                attr_writer :amount
                ...
                sig {
                  returns(
                    T.nilable(
                      OpenAI::Models::Admin::Organization::UsageWebSearchCallsResponse::Data::Result::OrganizationCostsResult::QuantityUnit::Variants
                    )
                  )
                }
                ...
                sig do
                  params(
                    ...
                    quantity_unit: T.nilable(
                      T.any(
                        String,
                        OpenAI::Models::Admin::Organization::UsageWebSearchCallsResponse::Data::Result::OrganizationCostsResult::QuantityUnit::OrSymbol
                      )
                    ),
                ...
                sig do
                  override.returns(
                    {
                      object: Symbol,
                      amount: OpenAI::Models::Admin::Organization::UsageWebSearchCallsResponse::Data::Result::OrganizationCostsResult::Amount,
                      api_key_id: T.nilable(String),
                      line_item: T.nilable(String),
                      project_id: T.nilable(String),
                      quantity: T.nilable(Float),
