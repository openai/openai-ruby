      ...
      module Organization
        ...
        class UsageAudioTranscriptionsParams < OpenAI::Internal::Type::BaseModel
          ...
          OrHash = T.type_alias do
            T.any(
              OpenAI::Admin::Organization::UsageAudioTranscriptionsParams,
          ...
          sig {
            returns(T.nilable(OpenAI::Admin::Organization::UsageAudioTranscriptionsParams::BucketWidth::OrSymbol))
          }
          attr_reader :bucket_width

          sig {
            params(bucket_width: OpenAI::Admin::Organization::UsageAudioTranscriptionsParams::BucketWidth::OrSymbol)
              .void
          }
          ...
          sig {
            returns(T.nilable(T::Array[OpenAI::Admin::Organization::UsageAudioTranscriptionsParams::GroupBy::OrSymbol]))
          }
          attr_reader :group_by

          sig {
            params(group_by: T::Array[OpenAI::Admin::Organization::UsageAudioTranscriptionsParams::GroupBy::OrSymbol])
              .void
          }
          ...
          module BucketWidth
            ...
            TaggedSymbol = T.type_alias {
              T.all(Symbol, OpenAI::Admin::Organization::UsageAudioTranscriptionsParams::BucketWidth)
            }
            OrSymbol = T.type_alias { T.any(Symbol, String) }

            BUCKET_WIDTH_1M = T.let(
              :"1m",
              OpenAI::Admin::Organization::UsageAudioTranscriptionsParams::BucketWidth::TaggedSymbol
            )
            ...
            sig {
              override.returns(
                T::Array[OpenAI::Admin::Organization::UsageAudioTranscriptionsParams::BucketWidth::TaggedSymbol]
              )
            }
            def self.values
            end
          ...
          module GroupBy
            ...
            TaggedSymbol = T.type_alias {
              T.all(Symbol, OpenAI::Admin::Organization::UsageAudioTranscriptionsParams::GroupBy)
            }
            OrSymbol = T.type_alias { T.any(Symbol, String) }

            PROJECT_ID = T.let(
              :project_id,
              OpenAI::Admin::Organization::UsageAudioTranscriptionsParams::GroupBy::TaggedSymbol
            )
            USER_ID = T.let(
              :user_id,
              OpenAI::Admin::Organization::UsageAudioTranscriptionsParams::GroupBy::TaggedSymbol
            ...
            MODEL = T.let(:model, OpenAI::Admin::Organization::UsageAudioTranscriptionsParams::GroupBy::TaggedSymbol)

            sig {
              override.returns(
                T::Array[OpenAI::Admin::Organization::UsageAudioTranscriptionsParams::GroupBy::TaggedSymbol]
              )
            }
            def self.values
            end
