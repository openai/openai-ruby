    ...
    module Admin
      ...
      module Organization
        ...
        class CertificateListResponse < OpenAI::Internal::Type::BaseModel
          ...
          sig { returns(OpenAI::Models::Admin::Organization::CertificateListResponse::CertificateDetails) }
          attr_reader :certificate_details

          sig {
            params(
              certificate_details: OpenAI::Models::Admin::Organization::CertificateListResponse::CertificateDetails::OrHash
            )
              .void
          }
