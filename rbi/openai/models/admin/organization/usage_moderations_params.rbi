          ...
          module BucketWidth
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  OpenAI::Admin::Organization::UsageModerationsParams::BucketWidth
                )
              end
          ...
          module GroupBy
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  OpenAI::Admin::Organization::UsageModerationsParams::GroupBy
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            PROJECT_ID =
              T.let(
                :project_id,
                OpenAI::Admin::Organization::UsageModerationsParams::GroupBy::TaggedSymbol
              )
            USER_ID =
              T.let(
                :user_id,
