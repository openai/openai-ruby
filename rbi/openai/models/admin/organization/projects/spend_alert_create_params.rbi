            ...
            module Currency
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    OpenAI::Admin::Organization::Projects::SpendAlertCreateParams::Currency
                  )
                end
              ...
              USD =
                T.let(
                  :USD,
                  OpenAI::Admin::Organization::Projects::SpendAlertCreateParams::Currency::TaggedSymbol
                )
            ...
            module Interval
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    OpenAI::Admin::Organization::Projects::SpendAlertCreateParams::Interval
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
