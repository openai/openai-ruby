      ...
      module Organization
        ...
        module Projects
          ...
          class CertificateDeactivateResponse < OpenAI::Internal::Type::BaseModel
            ...
            sig {
              returns(OpenAI::Models::Admin::Organization::Projects::CertificateDeactivateResponse::CertificateDetails)
            }
            attr_reader :certificate_details

            sig {
              params(
                certificate_details: OpenAI::Models::Admin::Organization::Projects::CertificateDeactivateResponse::CertificateDetails::OrHash
              )
                .void
            }
