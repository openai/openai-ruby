    ...
    module Admin
      ...
      module Organization
        ...
        class AuditLogListParams < OpenAI::Internal::Type::BaseModel
          ...
          sig { returns(T.nilable(OpenAI::Admin::Organization::AuditLogListParams::EffectiveAt)) }
          attr_reader :effective_at

          sig { params(effective_at: OpenAI::Admin::Organization::AuditLogListParams::EffectiveAt::OrHash).void }
          ...
          sig { returns(T.nilable(T::Array[OpenAI::Admin::Organization::AuditLogListParams::EventType::OrSymbol])) }
          attr_reader :event_types

          sig {
            params(event_types: T::Array[OpenAI::Admin::Organization::AuditLogListParams::EventType::OrSymbol]).void
          }
            ...
            override.returns(
              {
                ...
                after: String,
                before: String,
                effective_at: OpenAI::Admin::Organization::AuditLogListParams::EffectiveAt,
                event_types: T::Array[OpenAI::Admin::Organization::AuditLogListParams::EventType::OrSymbol],
                limit: Integer,
                project_ids: T::Array[String],
                resource_ids: T::Array[String],
          ...
          module EventType
            ...
            TaggedSymbol = T.type_alias { T.all(Symbol, OpenAI::Admin::Organization::AuditLogListParams::EventType) }
            ...
            USER_ADDED = T.let(:"user.added", OpenAI::Admin::Organization::AuditLogListParams::EventType::TaggedSymbol)
            USER_UPDATED = T.let(
              :"user.updated",
              OpenAI::Admin::Organization::AuditLogListParams::EventType::TaggedSymbol
            )
            ...
            sig {
              override.returns(T::Array[OpenAI::Admin::Organization::AuditLogListParams::EventType::TaggedSymbol])
            }
            def self.values
            end
          end
