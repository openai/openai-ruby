    ...
    class ImageEditCompletedEvent < OpenAI::Internal::Type::BaseModel
      ...
      sig do
        override.returns(
          {
            b64_json: String,
            background: OpenAI::ImageEditCompletedEvent::Background::TaggedSymbol,
            created_at: Integer,
      ...
      module Background
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, OpenAI::ImageEditCompletedEvent::Background) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        TRANSPARENT = T.let(:transparent, OpenAI::ImageEditCompletedEvent::Background::TaggedSymbol)
        OPAQUE = T.let(:opaque, OpenAI::ImageEditCompletedEvent::Background::TaggedSymbol)
        AUTO = T.let(:auto, OpenAI::ImageEditCompletedEvent::Background::TaggedSymbol)
      ...
      module OutputFormat
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, OpenAI::ImageEditCompletedEvent::OutputFormat) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        PNG = T.let(:png, OpenAI::ImageEditCompletedEvent::OutputFormat::TaggedSymbol)
        WEBP = T.let(:webp, OpenAI::ImageEditCompletedEvent::OutputFormat::TaggedSymbol)
        JPEG = T.let(:jpeg, OpenAI::ImageEditCompletedEvent::OutputFormat::TaggedSymbol)

        sig { override.returns(T::Array[OpenAI::ImageEditCompletedEvent::OutputFormat::TaggedSymbol]) }
        def self.values
        end
      end
      ...
      module Quality
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, OpenAI::ImageEditCompletedEvent::Quality) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module Size
        ...
        SIZE_1024X1536 = T.let(:"1024x1536", OpenAI::ImageEditCompletedEvent::Size::TaggedSymbol)
        ...
        sig { returns(T::Array[OpenAI::ImageEditCompletedEvent::Size::TaggedSymbol]) }
        def self.values
        end
      end
