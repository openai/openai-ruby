...
module OpenAI
  module Models
    ...
    class VectorStoreSearchResponse < OpenAI::Internal::Type::BaseModel
      ...
      sig { returns(T.nilable(T::Hash[Symbol, OpenAI::Models::VectorStoreSearchResponse::Attribute::Variants])) }
      ...
      sig do
        params(
          ...
          attributes: T.nilable(T::Hash[Symbol, OpenAI::Models::VectorStoreSearchResponse::Attribute::Variants]),

          content: T::Array[OpenAI::Models::VectorStoreSearchResponse::Content::OrHash],
      ...
      module Attribute
        ...
        sig { override.returns(T::Array[OpenAI::Models::VectorStoreSearchResponse::Attribute::Variants]) }
        def self.variants
        end
      ...
      class Content < OpenAI::Internal::Type::BaseModel
        ...
        sig do
          override.returns(
            {text: String, type: OpenAI::Models::VectorStoreSearchResponse::Content::Type::TaggedSymbol}
          )
        end
        def to_hash
        end
