    ...
    class ImageEditPartialImageEvent < OpenAI::Internal::Type::BaseModel
      ...
      sig do
        override.returns(
          {
            b64_json: String,
            background: OpenAI::ImageEditPartialImageEvent::Background::TaggedSymbol,
            created_at: Integer,
      ...
      module Background
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, OpenAI::ImageEditPartialImageEvent::Background) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        TRANSPARENT = T.let(:transparent, OpenAI::ImageEditPartialImageEvent::Background::TaggedSymbol)
        OPAQUE = T.let(:opaque, OpenAI::ImageEditPartialImageEvent::Background::TaggedSymbol)
        AUTO = T.let(:auto, OpenAI::ImageEditPartialImageEvent::Background::TaggedSymbol)

        sig { override.returns(T::Array[OpenAI::ImageEditPartialImageEvent::Background::TaggedSymbol]) }
        def self.values
        end
      end
      ...
      module OutputFormat
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, OpenAI::ImageEditPartialImageEvent::OutputFormat) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        PNG = T.let(:png, OpenAI::ImageEditPartialImageEvent::OutputFormat::TaggedSymbol)
        WEBP = T.let(:webp, OpenAI::ImageEditPartialImageEvent::OutputFormat::TaggedSymbol)
        JPEG = T.let(:jpeg, OpenAI::ImageEditPartialImageEvent::OutputFormat::TaggedSymbol)

        sig { override.returns(T::Array[OpenAI::ImageEditPartialImageEvent::OutputFormat::TaggedSymbol]) }
        def self.values
        end
      end
      ...
      module Quality
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, OpenAI::ImageEditPartialImageEvent::Quality) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module Size
        ...
        SIZE_1024X1536 = T.let(:"1024x1536", OpenAI::ImageEditPartialImageEvent::Size::TaggedSymbol)
        ...
        sig { returns(T::Array[OpenAI::ImageEditPartialImageEvent::Size::TaggedSymbol]) }
        def self.values
        end
      end
