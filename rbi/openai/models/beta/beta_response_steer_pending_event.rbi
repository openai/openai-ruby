...
module OpenAI
  module Models
    ...
    BetaResponseSteerPendingEvent = Beta::BetaResponseSteerPendingEvent

    module Beta

      class BetaResponseSteerPendingEvent < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(OpenAI::Beta::BetaResponseSteerPendingReason::Variants) }
        ...
        sig { returns(OpenAI::Beta::BetaResponseSteerPendingEvent::Steer) }
        attr_reader :steer

        sig { params(steer: OpenAI::Beta::BetaResponseSteerPendingEvent::Steer::OrHash).void }
        attr_writer :steer
        ...
        sig do
          params(
            ...
            required_input: T::Array[
              T.any(
                OpenAI::Beta::BetaResponseSteerRequiredInput::FunctionCallOutput::OrHash,
                OpenAI::Beta::BetaResponseSteerRequiredInput::CustomToolCallOutput::OrHash,
                OpenAI::Beta::BetaResponseSteerRequiredInput::ComputerCallOutput::OrHash,
                OpenAI::Beta::BetaResponseSteerRequiredInput::ShellCallOutput::OrHash,
                OpenAI::Beta::BetaResponseSteerRequiredInput::ApplyPatchCallOutput::OrHash,
                OpenAI::Beta::BetaResponseSteerRequiredInput::ToolSearchOutput::OrHash,
                OpenAI::Beta::BetaResponseSteerRequiredInput::McpApprovalResponse::OrHash
              )
            ],

            sequence_number: Integer,

            steer: OpenAI::Beta::BetaResponseSteerPendingEvent::Steer::OrHash,
        ...
        sig do
          override.returns(
            {
              reason: OpenAI::Beta::BetaResponseSteerPendingReason::Variants,
              required_input: T::Array[
                T.any(
                  OpenAI::Beta::BetaResponseSteerRequiredInput::FunctionCallOutput,
                  OpenAI::Beta::BetaResponseSteerRequiredInput::CustomToolCallOutput,
              ...
              sequence_number: Integer,
              steer: OpenAI::Beta::BetaResponseSteerPendingEvent::Steer,
              type: Symbol,
              stream_id: String
            }
          )
        ...
        class Steer < OpenAI::Internal::Type::BaseModel
          OrHash = T.type_alias do
            T.any(
              OpenAI::Beta::BetaResponseSteerPendingEvent::Steer,
              OpenAI::Internal::AnyHash
            )
          end
