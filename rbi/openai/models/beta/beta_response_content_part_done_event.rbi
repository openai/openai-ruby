  ...
  module Models
    ...
    module Beta
      ...
      class BetaResponseContentPartDoneEvent < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(OpenAI::Beta::BetaResponseContentPartDoneEvent::Part::Variants) }
        attr_accessor :part
        ...
        sig { returns(T.nilable(OpenAI::Beta::BetaResponseContentPartDoneEvent::Agent)) }
        attr_reader :agent

        sig { params(agent: T.nilable(OpenAI::Beta::BetaResponseContentPartDoneEvent::Agent::OrHash)).void }
        attr_writer :agent
        ...
        module Part
          ...
          sig { override.returns(T::Array[OpenAI::Beta::BetaResponseContentPartDoneEvent::Part::Variants]) }
          def self.variants
          end
