  ...
  module Models
    ...
    module Beta
      ...
      class BetaResponseImageGenCallCompletedEvent < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(T.nilable(OpenAI::Beta::BetaResponseImageGenCallCompletedEvent::Agent)) }
        attr_reader :agent

        sig { params(agent: T.nilable(OpenAI::Beta::BetaResponseImageGenCallCompletedEvent::Agent::OrHash)).void }
        attr_writer :agent
