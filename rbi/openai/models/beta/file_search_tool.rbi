  ...
  module Models
    ...
    module Beta
      ...
      class FileSearchTool < OpenAI::Internal::Type::BaseModel
        ...
        sig do
          override.returns(
            {type: Symbol, file_search: OpenAI::Beta::FileSearchTool::FileSearch}
          )
        end
        def to_hash
        end
        ...
        class FileSearch < OpenAI::Internal::Type::BaseModel
          ...
          sig do
            override.returns(
              {max_num_results: Integer, ranking_options: OpenAI::Beta::FileSearchTool::FileSearch::RankingOptions}
            )
          end
          def to_hash
          end
          ...
          class RankingOptions < OpenAI::Internal::Type::BaseModel
            ...
            # ranker.
            sig { returns(T.nilable(OpenAI::Beta::FileSearchTool::FileSearch::RankingOptions::Ranker::OrSymbol)) }
            attr_reader :ranker
            ...
            module Ranker
              ...
              TaggedSymbol = T.type_alias {
                T.all(Symbol, OpenAI::Beta::FileSearchTool::FileSearch::RankingOptions::Ranker)
              }
              OrSymbol = T.type_alias { T.any(Symbol, String) }

              AUTO = T.let(:auto, OpenAI::Beta::FileSearchTool::FileSearch::RankingOptions::Ranker::TaggedSymbol)
              ...
              sig {
                override.returns(
                  T::Array[OpenAI::Beta::FileSearchTool::FileSearch::RankingOptions::Ranker::TaggedSymbol]
                )
              }
              def self.values
              end
