    ...
    module Beta
      class BetaResponseInputImageContent < OpenAI::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              OpenAI::Beta::BetaResponseInputImageContent::Detail::OrSymbol
            )
          )
        end
        ...
        module Detail
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, OpenAI::Beta::BetaResponseInputImageContent::Detail)
            end
          ...
          LOW =
            T.let(
              :low,
              OpenAI::Beta::BetaResponseInputImageContent::Detail::TaggedSymbol
            )
          HIGH =
            T.let(
              :high,
