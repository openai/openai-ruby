  ...
  module Models
    ...
    module Beta
      ...
      class BetaResponseCodeInterpreterCallInProgressEvent < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(T.nilable(OpenAI::Beta::BetaResponseCodeInterpreterCallInProgressEvent::Agent)) }
        attr_reader :agent

        sig {
          params(agent: T.nilable(OpenAI::Beta::BetaResponseCodeInterpreterCallInProgressEvent::Agent::OrHash)).void
        }
        attr_writer :agent
