  ...
  module Models
    ...
    module Beta
      ...
      class BetaResponseAudioDeltaEvent < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(T.nilable(OpenAI::Beta::BetaResponseAudioDeltaEvent::Agent)) }
        attr_reader :agent

        sig { params(agent: T.nilable(OpenAI::Beta::BetaResponseAudioDeltaEvent::Agent::OrHash)).void }
        attr_writer :agent
