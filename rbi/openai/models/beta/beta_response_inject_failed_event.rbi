  ...
  module Models
    ...
    module Beta
      ...
      class BetaResponseInjectFailedEvent < OpenAI::Internal::Type::BaseModel
        ...
        sig { params(error: OpenAI::Beta::BetaResponseInjectFailedEvent::Error::OrHash).void }
        attr_writer :error
          ...
          params(
            ...
            input: T::Array[
              T.any(
                ...
                OpenAI::Beta::BetaResponseConfigurationUpdateItemParam::OrHash,
        ...
        class Error < OpenAI::Internal::Type::BaseModel
          ...
          sig { returns(OpenAI::Beta::BetaResponseInjectFailedEvent::Error::Code::OrSymbol) }
          attr_accessor :code
          ...
          sig do
            params(
              ...
              code: OpenAI::Beta::BetaResponseInjectFailedEvent::Error::Code::OrSymbol,
          ...
          sig do
            override.returns(
              {code: OpenAI::Beta::BetaResponseInjectFailedEvent::Error::Code::OrSymbol, message: String}
            )
          end
          def to_hash
          end
          ...
          module Code
            ...
            TaggedSymbol = T.type_alias { T.all(Symbol, OpenAI::Beta::BetaResponseInjectFailedEvent::Error::Code) }
            ...
            RESPONSE_NOT_FOUND = T.let(
              :response_not_found,
              OpenAI::Beta::BetaResponseInjectFailedEvent::Error::Code::TaggedSymbol
            )

            sig { override.returns(T::Array[OpenAI::Beta::BetaResponseInjectFailedEvent::Error::Code::TaggedSymbol]) }
            def self.values
            end
          end
        end
