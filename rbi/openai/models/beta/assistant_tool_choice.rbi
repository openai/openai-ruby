    ...
    module Beta
      ...
      class AssistantToolChoice < OpenAI::Internal::Type::BaseModel
        ...
        module Type
          ...
          TaggedSymbol = T.type_alias { T.all(Symbol, OpenAI::Beta::AssistantToolChoice::Type) }
          OrSymbol = T.type_alias { T.any(Symbol, String) }

          FUNCTION = T.let(:function, OpenAI::Beta::AssistantToolChoice::Type::TaggedSymbol)
          CODE_INTERPRETER = T.let(:code_interpreter, OpenAI::Beta::AssistantToolChoice::Type::TaggedSymbol)
          FILE_SEARCH = T.let(:file_search, OpenAI::Beta::AssistantToolChoice::Type::TaggedSymbol)
