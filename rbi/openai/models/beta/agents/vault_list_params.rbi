    ...
    module Beta
      ...
      module Agents
        ...
        class VaultListParams < OpenAI::Internal::Type::BaseModel
          ...
          sig { params(order: OpenAI::Beta::Agents::VaultListParams::Order::OrSymbol).void }
          attr_writer :order
          ...
          module Order
            ...
            TaggedSymbol = T.type_alias { T.all(Symbol, OpenAI::Beta::Agents::VaultListParams::Order) }
            OrSymbol = T.type_alias { T.any(Symbol, String) }

            # Returns resources in ascending order.
            ASC = T.let(:asc, OpenAI::Beta::Agents::VaultListParams::Order::TaggedSymbol)

            # Returns resources in descending order.
            DESC = T.let(:desc, OpenAI::Beta::Agents::VaultListParams::Order::TaggedSymbol)

            sig { override.returns(T::Array[OpenAI::Beta::Agents::VaultListParams::Order::TaggedSymbol]) }
            def self.values
            end
          end
