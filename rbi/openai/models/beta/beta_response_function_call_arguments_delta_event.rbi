  ...
  module Models
    ...
    module Beta
      ...
      class BetaResponseFunctionCallArgumentsDeltaEvent < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(T.nilable(OpenAI::Beta::BetaResponseFunctionCallArgumentsDeltaEvent::Agent)) }
        attr_reader :agent

        sig { params(agent: T.nilable(OpenAI::Beta::BetaResponseFunctionCallArgumentsDeltaEvent::Agent::OrHash)).void }
        attr_writer :agent
