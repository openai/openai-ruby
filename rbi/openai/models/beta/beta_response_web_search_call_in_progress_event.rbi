  ...
  module Models
    ...
    module Beta
      ...
      class BetaResponseWebSearchCallInProgressEvent < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(T.nilable(OpenAI::Beta::BetaResponseWebSearchCallInProgressEvent::Agent)) }
        attr_reader :agent

        sig { params(agent: T.nilable(OpenAI::Beta::BetaResponseWebSearchCallInProgressEvent::Agent::OrHash)).void }
        attr_writer :agent
