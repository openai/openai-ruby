  ...
  module Models
    ...
    module Beta
      ...
      class BetaResponseReasoningTextDeltaEvent < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(T.nilable(OpenAI::Beta::BetaResponseReasoningTextDeltaEvent::Agent)) }
        attr_reader :agent

        sig { params(agent: T.nilable(OpenAI::Beta::BetaResponseReasoningTextDeltaEvent::Agent::OrHash)).void }
        attr_writer :agent
