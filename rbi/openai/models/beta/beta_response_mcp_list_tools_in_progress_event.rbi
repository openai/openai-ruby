  ...
  module Models
    ...
    module Beta
      ...
      class BetaResponseMcpListToolsInProgressEvent < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(T.nilable(OpenAI::Beta::BetaResponseMcpListToolsInProgressEvent::Agent)) }
        attr_reader :agent

        sig { params(agent: T.nilable(OpenAI::Beta::BetaResponseMcpListToolsInProgressEvent::Agent::OrHash)).void }
        attr_writer :agent
