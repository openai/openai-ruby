    ...
    module Beta
      ...
      module Threads
        ...
        class Message < OpenAI::Internal::Type::BaseModel
          ...
          sig { params(incomplete_details: T.nilable(OpenAI::Beta::Threads::Message::IncompleteDetails::OrHash)).void }
          ...
          sig do
            params(
              ...
              attachments: T.nilable(T::Array[OpenAI::Beta::Threads::Message::Attachment::OrHash]),
              ...
              incomplete_details: T.nilable(OpenAI::Beta::Threads::Message::IncompleteDetails::OrHash),
            ...
            override.returns(
              {
                id: String,
                assistant_id: T.nilable(String),
                attachments: T.nilable(T::Array[OpenAI::Beta::Threads::Message::Attachment]),
                completed_at: T.nilable(Integer),
                content: T::Array[OpenAI::Beta::Threads::MessageContent::Variants],
                created_at: Integer,
                incomplete_at: T.nilable(Integer),
                incomplete_details: T.nilable(OpenAI::Beta::Threads::Message::IncompleteDetails),
                metadata: T.nilable(T::Hash[Symbol, String]),
                object: Symbol,
          ...
          class Attachment < OpenAI::Internal::Type::BaseModel
            ...
            sig { returns(T.nilable(T::Array[OpenAI::Beta::Threads::Message::Attachment::Tool::Variants])) }
            attr_reader :tools
            ...
            sig do
              override.returns(
                {file_id: String, tools: T::Array[OpenAI::Beta::Threads::Message::Attachment::Tool::Variants]}
              )
            end
            def to_hash
            end
            ...
            module Tool
              ...
              sig { override.returns(T::Array[OpenAI::Beta::Threads::Message::Attachment::Tool::Variants]) }
              def self.variants
              end
          ...
          class IncompleteDetails < OpenAI::Internal::Type::BaseModel
            ...
            sig do
              override.returns(
                {reason: OpenAI::Beta::Threads::Message::IncompleteDetails::Reason::TaggedSymbol}
              )
            end
            def to_hash
            end
            ...
            module Reason
              ...
              TaggedSymbol = T.type_alias { T.all(Symbol, OpenAI::Beta::Threads::Message::IncompleteDetails::Reason) }
              ...
              MAX_TOKENS = T.let(:max_tokens, OpenAI::Beta::Threads::Message::IncompleteDetails::Reason::TaggedSymbol)
              RUN_CANCELLED = T.let(
                :run_cancelled,
                OpenAI::Beta::Threads::Message::IncompleteDetails::Reason::TaggedSymbol
              )
          ...
          module Role
            ...
            TaggedSymbol = T.type_alias { T.all(Symbol, OpenAI::Beta::Threads::Message::Role) }
            OrSymbol = T.type_alias { T.any(Symbol, String) }

            USER = T.let(:user, OpenAI::Beta::Threads::Message::Role::TaggedSymbol)
            ASSISTANT = T.let(:assistant, OpenAI::Beta::Threads::Message::Role::TaggedSymbol)
          ...
          module Status
            ...
            TaggedSymbol = T.type_alias { T.all(Symbol, OpenAI::Beta::Threads::Message::Status) }
            OrSymbol = T.type_alias { T.any(Symbol, String) }

            IN_PROGRESS = T.let(:in_progress, OpenAI::Beta::Threads::Message::Status::TaggedSymbol)
            INCOMPLETE = T.let(:incomplete, OpenAI::Beta::Threads::Message::Status::TaggedSymbol)
            COMPLETED = T.let(:completed, OpenAI::Beta::Threads::Message::Status::TaggedSymbol)
