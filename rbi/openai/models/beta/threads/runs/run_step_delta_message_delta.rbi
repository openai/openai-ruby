      ...
      module Threads
        ...
        module Runs
          ...
          class RunStepDeltaMessageDelta < OpenAI::Internal::Type::BaseModel
            ...
            sig { returns(T.nilable(OpenAI::Beta::Threads::Runs::RunStepDeltaMessageDelta::MessageCreation)) }
            attr_reader :message_creation

            sig {
              params(message_creation: OpenAI::Beta::Threads::Runs::RunStepDeltaMessageDelta::MessageCreation::OrHash)
                .void
            }
            ...
            sig do
              override.returns(
                {type: Symbol, message_creation: OpenAI::Beta::Threads::Runs::RunStepDeltaMessageDelta::MessageCreation}
              )
            end
            def to_hash
            end
