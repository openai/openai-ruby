      ...
      module Threads
        ...
        module Runs
          ...
          class CodeInterpreterOutputImage < OpenAI::Internal::Type::BaseModel
            ...
            sig { returns(T.nilable(OpenAI::Beta::Threads::Runs::CodeInterpreterOutputImage::Image)) }
            attr_reader :image
            ...
            sig do
              override.returns(
                {index: Integer, type: Symbol, image: OpenAI::Beta::Threads::Runs::CodeInterpreterOutputImage::Image}
              )
            end
            def to_hash
            end
