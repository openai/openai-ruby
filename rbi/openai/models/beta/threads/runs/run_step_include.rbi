      ...
      module Threads
        ...
        module Runs
          ...
          module RunStepInclude
            ...
            TaggedSymbol = T.type_alias { T.all(Symbol, OpenAI::Beta::Threads::Runs::RunStepInclude) }
            ...
            sig { override.returns(T::Array[OpenAI::Beta::Threads::Runs::RunStepInclude::TaggedSymbol]) }
            def self.values
            end
          end
