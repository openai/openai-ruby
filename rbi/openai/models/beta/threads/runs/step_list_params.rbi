      ...
      module Threads
        ...
        module Runs
          ...
          class StepListParams < OpenAI::Internal::Type::BaseModel
            ...
            sig { returns(T.nilable(OpenAI::Beta::Threads::Runs::StepListParams::Order::OrSymbol)) }
            attr_reader :order
            ...
            module Order
              ...
              TaggedSymbol = T.type_alias { T.all(Symbol, OpenAI::Beta::Threads::Runs::StepListParams::Order) }
              OrSymbol = T.type_alias { T.any(Symbol, String) }

              ASC = T.let(:asc, OpenAI::Beta::Threads::Runs::StepListParams::Order::TaggedSymbol)
              DESC = T.let(:desc, OpenAI::Beta::Threads::Runs::StepListParams::Order::TaggedSymbol)

              sig { override.returns(T::Array[OpenAI::Beta::Threads::Runs::StepListParams::Order::TaggedSymbol]) }
              def self.values
              end
            end
