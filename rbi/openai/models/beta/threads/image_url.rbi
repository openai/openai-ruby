    ...
    module Beta
      ...
      module Threads
        ...
        class ImageURL < OpenAI::Internal::Type::BaseModel
          ...
          sig do
            override.returns(
              {url: String, detail: OpenAI::Beta::Threads::ImageURL::Detail::OrSymbol}
            )
          end
          def to_hash
          end
          ...
          module Detail
            ...
            TaggedSymbol = T.type_alias { T.all(Symbol, OpenAI::Beta::Threads::ImageURL::Detail) }
            OrSymbol = T.type_alias { T.any(Symbol, String) }

            AUTO = T.let(:auto, OpenAI::Beta::Threads::ImageURL::Detail::TaggedSymbol)
            LOW = T.let(:low, OpenAI::Beta::Threads::ImageURL::Detail::TaggedSymbol)
            HIGH = T.let(:high, OpenAI::Beta::Threads::ImageURL::Detail::TaggedSymbol)
