  ...
  module Models
    ...
    module Beta
      ...
      class BetaResponseMcpCallArgumentsDoneEvent < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(T.nilable(OpenAI::Beta::BetaResponseMcpCallArgumentsDoneEvent::Agent)) }
        attr_reader :agent

        sig { params(agent: T.nilable(OpenAI::Beta::BetaResponseMcpCallArgumentsDoneEvent::Agent::OrHash)).void }
        attr_writer :agent
