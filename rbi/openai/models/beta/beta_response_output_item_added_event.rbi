  ...
  module Models
    ...
    module Beta
      ...
      class BetaResponseOutputItemAddedEvent < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(T.nilable(OpenAI::Beta::BetaResponseOutputItemAddedEvent::Agent)) }
        attr_reader :agent

        sig { params(agent: T.nilable(OpenAI::Beta::BetaResponseOutputItemAddedEvent::Agent::OrHash)).void }
        attr_writer :agent
