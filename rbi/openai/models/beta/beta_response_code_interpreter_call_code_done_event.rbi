  ...
  module Models
    ...
    module Beta
      ...
      class BetaResponseCodeInterpreterCallCodeDoneEvent < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(T.nilable(OpenAI::Beta::BetaResponseCodeInterpreterCallCodeDoneEvent::Agent)) }
        attr_reader :agent

        sig {
          params(agent: T.nilable(OpenAI::Beta::BetaResponseCodeInterpreterCallCodeDoneEvent::Agent::OrHash)).void
        }
        attr_writer :agent
