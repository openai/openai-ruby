  ...
  module Models
    ...
    module Beta
      ...
      class BetaResponseShellCallCommandAddedEvent < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(T.nilable(OpenAI::Beta::BetaResponseShellCallCommandAddedEvent::Agent)) }
        attr_reader :agent

        sig { params(agent: OpenAI::Beta::BetaResponseShellCallCommandAddedEvent::Agent::OrHash).void }
        attr_writer :agent
