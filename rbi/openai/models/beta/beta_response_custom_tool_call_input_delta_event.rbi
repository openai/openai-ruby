  ...
  module Models
    ...
    module Beta
      ...
      class BetaResponseCustomToolCallInputDeltaEvent < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(T.nilable(OpenAI::Beta::BetaResponseCustomToolCallInputDeltaEvent::Agent)) }
        attr_reader :agent

        sig { params(agent: T.nilable(OpenAI::Beta::BetaResponseCustomToolCallInputDeltaEvent::Agent::OrHash)).void }
        attr_writer :agent
