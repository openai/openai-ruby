  ...
  module Models
    ...
    module Beta
      class BetaNamespaceTool < OpenAI::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(OpenAI::Beta::BetaNamespaceTool, OpenAI::Internal::AnyHash)
          end
        ...
        sig do
          params(
            ...
            tools:
              T::Array[
                T.any(
                  OpenAI::Beta::BetaNamespaceTool::Tool::Function::OrHash,
        ...
        module Tool
          ...
          class Function < OpenAI::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    OpenAI::Beta::BetaNamespaceTool::Tool::Function::AllowedCaller::OrSymbol
                  ]
                )
              )
            end
            ...
            module AllowedCaller
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    OpenAI::Beta::BetaNamespaceTool::Tool::Function::AllowedCaller
                  )
                end
          ...
          sig do
            override.returns(
              T::Array[OpenAI::Beta::BetaNamespaceTool::Tool::Variants]
            )
          end
          def self.variants
          end
