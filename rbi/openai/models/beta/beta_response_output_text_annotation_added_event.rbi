  ...
  module Models
    ...
    module Beta
      ...
      class BetaResponseOutputTextAnnotationAddedEvent < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(T.nilable(OpenAI::Beta::BetaResponseOutputTextAnnotationAddedEvent::Agent)) }
        attr_reader :agent

        sig { params(agent: T.nilable(OpenAI::Beta::BetaResponseOutputTextAnnotationAddedEvent::Agent::OrHash)).void }
        attr_writer :agent
        ...
        module Annotation
          ...
          sig {
            override.returns(T::Array[OpenAI::Beta::BetaResponseOutputTextAnnotationAddedEvent::Annotation::Variants])
          }
          def self.variants
          end
