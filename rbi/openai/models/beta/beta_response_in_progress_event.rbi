  ...
  module Models
    ...
    module Beta
      ...
      class BetaResponseInProgressEvent < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(T.nilable(OpenAI::Beta::BetaResponseInProgressEvent::Agent)) }
        attr_reader :agent

        sig { params(agent: T.nilable(OpenAI::Beta::BetaResponseInProgressEvent::Agent::OrHash)).void }
        attr_writer :agent
