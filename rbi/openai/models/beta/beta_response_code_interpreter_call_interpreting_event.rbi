  ...
  module Models
    ...
    module Beta
      ...
      class BetaResponseCodeInterpreterCallInterpretingEvent < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(T.nilable(OpenAI::Beta::BetaResponseCodeInterpreterCallInterpretingEvent::Agent)) }
        attr_reader :agent

        sig {
          params(agent: T.nilable(OpenAI::Beta::BetaResponseCodeInterpreterCallInterpretingEvent::Agent::OrHash)).void
        }
        attr_writer :agent
