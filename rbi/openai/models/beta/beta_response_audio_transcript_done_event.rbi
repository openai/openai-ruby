  ...
  module Models
    ...
    module Beta
      ...
      class BetaResponseAudioTranscriptDoneEvent < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(T.nilable(OpenAI::Beta::BetaResponseAudioTranscriptDoneEvent::Agent)) }
        attr_reader :agent

        sig { params(agent: T.nilable(OpenAI::Beta::BetaResponseAudioTranscriptDoneEvent::Agent::OrHash)).void }
        attr_writer :agent
