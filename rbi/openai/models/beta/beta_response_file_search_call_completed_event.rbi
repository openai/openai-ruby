  ...
  module Models
    ...
    module Beta
      ...
      class BetaResponseFileSearchCallCompletedEvent < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(T.nilable(OpenAI::Beta::BetaResponseFileSearchCallCompletedEvent::Agent)) }
        attr_reader :agent

        sig { params(agent: T.nilable(OpenAI::Beta::BetaResponseFileSearchCallCompletedEvent::Agent::OrHash)).void }
        attr_writer :agent
