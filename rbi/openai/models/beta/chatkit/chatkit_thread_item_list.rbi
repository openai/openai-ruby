    ...
    module Beta
      ...
      module ChatKit
        ...
        class ChatKitThreadItemList < OpenAI::Internal::Type::BaseModel
          ...
          # A list of items
          sig { returns(T::Array[OpenAI::Beta::ChatKit::ChatKitThreadItemList::Data::Variants]) }
          attr_accessor :data
          ...
          sig do
            override.returns(
              {
                data: T::Array[OpenAI::Beta::ChatKit::ChatKitThreadItemList::Data::Variants],
                first_id: T.nilable(String),
                has_more: T::Boolean,
                last_id: T.nilable(String),
                object: Symbol
          ...
          module Data
            ...
            class ChatKitClientToolCall < OpenAI::Internal::Type::BaseModel
              ...
              sig {
                returns(OpenAI::Beta::ChatKit::ChatKitThreadItemList::Data::ChatKitClientToolCall::Status::TaggedSymbol)
              }
              ...
              sig do
                params(
                  ...
                  status: OpenAI::Beta::ChatKit::ChatKitThreadItemList::Data::ChatKitClientToolCall::Status::OrSymbol,
                ...
                override.returns(
                  {
                    ...
                    object: Symbol,
                    output: T.nilable(String),
                    status: OpenAI::Beta::ChatKit::ChatKitThreadItemList::Data::ChatKitClientToolCall::Status::TaggedSymbol,
                    thread_id: String,
                    type: Symbol
                  }
                )
              ...
              module Status
                ...
                TaggedSymbol = T.type_alias {
                  T.all(Symbol, OpenAI::Beta::ChatKit::ChatKitThreadItemList::Data::ChatKitClientToolCall::Status)
                }
            ...
            class ChatKitTask < OpenAI::Internal::Type::BaseModel
              ...
              sig { returns(OpenAI::Beta::ChatKit::ChatKitThreadItemList::Data::ChatKitTask::TaskType::TaggedSymbol) }
              ...
              sig do
                params(
                  ...
                  task_type: OpenAI::Beta::ChatKit::ChatKitThreadItemList::Data::ChatKitTask::TaskType::OrSymbol,
                ...
                override.returns(
                  {
                    ...
                    object: Symbol,
                    summary: T.nilable(String),
                    task_type: OpenAI::Beta::ChatKit::ChatKitThreadItemList::Data::ChatKitTask::TaskType::TaggedSymbol,
                    thread_id: String,
                    type: Symbol
                  }
                )
              ...
              module TaskType
                ...
                TaggedSymbol = T.type_alias {
                  T.all(Symbol, OpenAI::Beta::ChatKit::ChatKitThreadItemList::Data::ChatKitTask::TaskType)
                }
                OrSymbol = T.type_alias { T.any(Symbol, String) }
                ...
                sig {
                  override.returns(
                    T::Array[OpenAI::Beta::ChatKit::ChatKitThreadItemList::Data::ChatKitTask::TaskType::TaggedSymbol]
                  )
                }
                def self.values
                end
            ...
            class ChatKitTaskGroup < OpenAI::Internal::Type::BaseModel
              ...
              sig { returns(T::Array[OpenAI::Beta::ChatKit::ChatKitThreadItemList::Data::ChatKitTaskGroup::Task]) }
              attr_accessor :tasks
              ...
              sig do
                params(
                  ...
                  tasks: T::Array[OpenAI::Beta::ChatKit::ChatKitThreadItemList::Data::ChatKitTaskGroup::Task::OrHash],
                ...
                override.returns(
                  {
                    ...
                    created_at: Integer,
                    object: Symbol,
                    tasks: T::Array[OpenAI::Beta::ChatKit::ChatKitThreadItemList::Data::ChatKitTaskGroup::Task],
                    thread_id: String,
                    type: Symbol
                  }
                )
              ...
              class Task < OpenAI::Internal::Type::BaseModel
                ...
                sig do
                  params(
                    ...
                    type: OpenAI::Beta::ChatKit::ChatKitThreadItemList::Data::ChatKitTaskGroup::Task::Type::OrSymbol
                  )
                    .returns(T.attached_class)
                end
                def self.new(
                  ...
                  override.returns(
                    {
                      heading: T.nilable(String),
                      summary: T.nilable(String),
                      type: OpenAI::Beta::ChatKit::ChatKitThreadItemList::Data::ChatKitTaskGroup::Task::Type::TaggedSymbol
                    }
                  )
                end
                def to_hash
                ...
                module Type
                  ...
                  TaggedSymbol = T.type_alias {
                    T.all(Symbol, OpenAI::Beta::ChatKit::ChatKitThreadItemList::Data::ChatKitTaskGroup::Task::Type)
                  }
                  OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            sig { override.returns(T::Array[OpenAI::Beta::ChatKit::ChatKitThreadItemList::Data::Variants]) }
            def self.variants
            end
