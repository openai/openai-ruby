    ...
    module Beta
      ...
      module ChatKit
        ...
        class ChatSessionWorkflowParam < OpenAI::Internal::Type::BaseModel
          ...
          sig {
            returns(
              T.nilable(T::Hash[Symbol, OpenAI::Beta::ChatKit::ChatSessionWorkflowParam::StateVariable::Variants])
            )
          }
          ...
          sig {
            params(
              state_variables: T::Hash[Symbol, OpenAI::Beta::ChatKit::ChatSessionWorkflowParam::StateVariable::Variants]
            )
              .void
          }
          ...
          # enabled by default.
          sig { returns(T.nilable(OpenAI::Beta::ChatKit::ChatSessionWorkflowParam::Tracing)) }
          attr_reader :tracing

          sig { params(tracing: OpenAI::Beta::ChatKit::ChatSessionWorkflowParam::Tracing::OrHash).void }
          attr_writer :tracing
          ...
          sig do
            params(
              ...
              tracing: OpenAI::Beta::ChatKit::ChatSessionWorkflowParam::Tracing::OrHash,
          ...
          module StateVariable
            ...
            sig {
              override.returns(T::Array[OpenAI::Beta::ChatKit::ChatSessionWorkflowParam::StateVariable::Variants])
            }
            def self.variants
            end
