    ...
    module Beta
      ...
      module ChatKit
        ...
        class ChatSessionChatKitConfigurationParam < OpenAI::Internal::Type::BaseModel
          ...
          sig {
            returns(T.nilable(OpenAI::Beta::ChatKit::ChatSessionChatKitConfigurationParam::AutomaticThreadTitling))
          }
          attr_reader :automatic_thread_titling

          sig {
            params(
              automatic_thread_titling: OpenAI::Beta::ChatKit::ChatSessionChatKitConfigurationParam::AutomaticThreadTitling::OrHash
            )
              .void
          }
          ...
          sig { returns(T.nilable(OpenAI::Beta::ChatKit::ChatSessionChatKitConfigurationParam::FileUpload)) }
          attr_reader :file_upload

          sig {
            params(file_upload: OpenAI::Beta::ChatKit::ChatSessionChatKitConfigurationParam::FileUpload::OrHash).void
          }
          ...
          sig { returns(T.nilable(OpenAI::Beta::ChatKit::ChatSessionChatKitConfigurationParam::History)) }
          attr_reader :history

          sig { params(history: OpenAI::Beta::ChatKit::ChatSessionChatKitConfigurationParam::History::OrHash).void }
          attr_writer :history
          ...
          sig do
            params(
              ...
              file_upload: OpenAI::Beta::ChatKit::ChatSessionChatKitConfigurationParam::FileUpload::OrHash,

              history: OpenAI::Beta::ChatKit::ChatSessionChatKitConfigurationParam::History::OrHash
            )
          ...
          class FileUpload < OpenAI::Internal::Type::BaseModel
            ...
            sig do
              override.returns(
                {enabled: T::Boolean, max_file_size: Integer, max_files: Integer}
              )
            end
            def to_hash
            end
          ...
          class History < OpenAI::Internal::Type::BaseModel
            ...
            sig do
              override.returns(
                {enabled: T::Boolean, recent_threads: Integer}
              )
            end
            def to_hash
            end
