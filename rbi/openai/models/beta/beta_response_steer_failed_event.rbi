  ...
  module Models
    ...
    module Beta
      ...
      class BetaResponseSteerFailedEvent < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(OpenAI::Beta::BetaResponseSteerFailedEvent::Error) }
        attr_reader :error

        sig { params(error: OpenAI::Beta::BetaResponseSteerFailedEvent::Error::OrHash).void }
        attr_writer :error
        ...
        sig { returns(OpenAI::Beta::BetaResponseSteerFailedEvent::Steer) }
        attr_reader :steer

        sig { params(steer: OpenAI::Beta::BetaResponseSteerFailedEvent::Steer::OrHash).void }
        attr_writer :steer
        ...
        sig do
          params(
            ...
            error: OpenAI::Beta::BetaResponseSteerFailedEvent::Error::OrHash,

            sequence_number: Integer,

            steer: OpenAI::Beta::BetaResponseSteerFailedEvent::Steer::OrHash,
        ...
        sig do
          override.returns(
            {
              error: OpenAI::Beta::BetaResponseSteerFailedEvent::Error,
              sequence_number: Integer,
        ...
        class Error < OpenAI::Internal::Type::BaseModel
          OrHash = T.type_alias do
            T.any(
              OpenAI::Beta::BetaResponseSteerFailedEvent::Error,
              OpenAI::Internal::AnyHash
            )
          end
          ...
          sig { returns(OpenAI::Beta::BetaResponseSteerErrorCode::Variants) }
          attr_accessor :code
          ...
          sig do
            params(
              ...
              code: T.any(OpenAI::Beta::BetaResponseSteerErrorCode::OrSymbol, String),
          ...
          sig do
            override.returns(
              {code: OpenAI::Beta::BetaResponseSteerErrorCode::Variants, message: String, type: Symbol}
            )
          end
          def to_hash
          end
        ...
        class Steer < OpenAI::Internal::Type::BaseModel
          OrHash = T.type_alias do
            T.any(
              OpenAI::Beta::BetaResponseSteerFailedEvent::Steer,
              OpenAI::Internal::AnyHash
            )
          end
          ...
          # steering.
          sig { returns(OpenAI::Beta::BetaResponseSteerInput::Variants) }
          attr_accessor :input
