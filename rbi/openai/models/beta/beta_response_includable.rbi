  ...
  module Models
    ...
    module Beta
      ...
      module BetaResponseIncludable
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, OpenAI::Beta::BetaResponseIncludable) }
        ...
        WEB_SEARCH_CALL_RESULTS = T.let(:"web_search_call.results", OpenAI::Beta::BetaResponseIncludable::TaggedSymbol)
        ...
        sig { override.returns(T::Array[OpenAI::Beta::BetaResponseIncludable::TaggedSymbol]) }
        def self.values
        end
      end
