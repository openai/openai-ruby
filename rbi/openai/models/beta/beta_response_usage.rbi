  ...
  module Models
    ...
    module Beta
      class BetaResponseUsage < OpenAI::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(OpenAI::Beta::BetaResponseUsage, OpenAI::Internal::AnyHash)
          end
        ...
        sig do
          params(
            input_tokens_details:
              OpenAI::Beta::BetaResponseUsage::InputTokensDetails::OrHash
          ).void
        end
        ...
        sig do
          params(
            output_tokens_details:
              OpenAI::Beta::BetaResponseUsage::OutputTokensDetails::OrHash
          ).void
        end
