  ...
  module Models
    ...
    module Beta
      ...
      class BetaResponseMcpCallCompletedEvent < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(T.nilable(OpenAI::Beta::BetaResponseMcpCallCompletedEvent::Agent)) }
        attr_reader :agent

        sig { params(agent: T.nilable(OpenAI::Beta::BetaResponseMcpCallCompletedEvent::Agent::OrHash)).void }
        attr_writer :agent
