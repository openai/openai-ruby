  ...
  module Models
    ...
    module Beta
      ...
      class BetaResponseOutputItemDoneEvent < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(T.nilable(OpenAI::Beta::BetaResponseOutputItemDoneEvent::Agent)) }
        attr_reader :agent

        sig { params(agent: T.nilable(OpenAI::Beta::BetaResponseOutputItemDoneEvent::Agent::OrHash)).void }
        attr_writer :agent
