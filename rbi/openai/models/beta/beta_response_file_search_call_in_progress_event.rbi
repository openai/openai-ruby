  ...
  module Models
    ...
    module Beta
      ...
      class BetaResponseFileSearchCallInProgressEvent < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(T.nilable(OpenAI::Beta::BetaResponseFileSearchCallInProgressEvent::Agent)) }
        attr_reader :agent

        sig { params(agent: T.nilable(OpenAI::Beta::BetaResponseFileSearchCallInProgressEvent::Agent::OrHash)).void }
        attr_writer :agent
