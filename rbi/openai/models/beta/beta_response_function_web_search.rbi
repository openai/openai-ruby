  ...
  module Models
    ...
    module Beta
      ...
      class BetaResponseFunctionWebSearch < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(OpenAI::Beta::BetaResponseFunctionWebSearch::Status::OrSymbol) }
        ...
        sig { returns(T.nilable(OpenAI::Beta::BetaResponseFunctionWebSearch::Agent)) }
        attr_reader :agent

        sig { params(agent: T.nilable(OpenAI::Beta::BetaResponseFunctionWebSearch::Agent::OrHash)).void }
        attr_writer :agent
        ...
        sig do
          params(
            ...
            status: OpenAI::Beta::BetaResponseFunctionWebSearch::Status::OrSymbol,

            agent: T.nilable(OpenAI::Beta::BetaResponseFunctionWebSearch::Agent::OrHash),
          ...
          override.returns(
            {
              ...
              status: OpenAI::Beta::BetaResponseFunctionWebSearch::Status::OrSymbol,
              type: Symbol,
              agent: T.nilable(OpenAI::Beta::BetaResponseFunctionWebSearch::Agent)
            }
          )
        end
        def to_hash
        ...
        module Action
          ...
          class Search < OpenAI::Internal::Type::BaseModel
            ...
            sig { returns(T.nilable(T::Array[OpenAI::Beta::BetaResponseFunctionWebSearch::Action::Search::Source])) }
            attr_reader :sources

            sig {
              params(sources: T::Array[OpenAI::Beta::BetaResponseFunctionWebSearch::Action::Search::Source::OrHash])
                .void
            }
            attr_writer :sources
            ...
            sig do
              params(
                ...
                sources: T::Array[OpenAI::Beta::BetaResponseFunctionWebSearch::Action::Search::Source::OrHash],
              ...
              override.returns(
                {
                  ...
                  queries: T::Array[String],
                  query: String,
                  sources: T::Array[OpenAI::Beta::BetaResponseFunctionWebSearch::Action::Search::Source]
                }
              )
            end
            def to_hash
          ...
          sig { override.returns(T::Array[OpenAI::Beta::BetaResponseFunctionWebSearch::Action::Variants]) }
          def self.variants
          end
        ...
        module Status
          ...
          TaggedSymbol = T.type_alias { T.all(Symbol, OpenAI::Beta::BetaResponseFunctionWebSearch::Status) }
          OrSymbol = T.type_alias { T.any(Symbol, String) }

          IN_PROGRESS = T.let(:in_progress, OpenAI::Beta::BetaResponseFunctionWebSearch::Status::TaggedSymbol)
