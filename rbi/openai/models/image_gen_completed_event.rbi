    ...
    class ImageGenCompletedEvent < OpenAI::Internal::Type::BaseModel
      ...
      sig do
        override.returns(
          {
            b64_json: String,
            background: OpenAI::ImageGenCompletedEvent::Background::TaggedSymbol,
            created_at: Integer,
      ...
      module Background
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, OpenAI::ImageGenCompletedEvent::Background) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        TRANSPARENT = T.let(:transparent, OpenAI::ImageGenCompletedEvent::Background::TaggedSymbol)
        OPAQUE = T.let(:opaque, OpenAI::ImageGenCompletedEvent::Background::TaggedSymbol)
      ...
      module OutputFormat
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, OpenAI::ImageGenCompletedEvent::OutputFormat) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        PNG = T.let(:png, OpenAI::ImageGenCompletedEvent::OutputFormat::TaggedSymbol)
        WEBP = T.let(:webp, OpenAI::ImageGenCompletedEvent::OutputFormat::TaggedSymbol)
        JPEG = T.let(:jpeg, OpenAI::ImageGenCompletedEvent::OutputFormat::TaggedSymbol)
      ...
      module Quality
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, OpenAI::ImageGenCompletedEvent::Quality) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module Size
        ...
        SIZE_1024X1536 = T.let(:"1024x1536", OpenAI::ImageGenCompletedEvent::Size::TaggedSymbol)
        ...
        sig { returns(T::Array[OpenAI::ImageGenCompletedEvent::Size::TaggedSymbol]) }
        def self.values
        end
      end
