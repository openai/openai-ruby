  ...
  module Models
    ...
    module VectorStores
      ...
      class FileUpdateParams < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(T.nilable(T::Hash[Symbol, OpenAI::VectorStores::FileUpdateParams::Attribute::Variants])) }
        ...
        module Attribute
          ...
          sig { override.returns(T::Array[OpenAI::VectorStores::FileUpdateParams::Attribute::Variants]) }
          def self.variants
          end
