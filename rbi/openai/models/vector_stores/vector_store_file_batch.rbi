    ...
    module VectorStores
      ...
      class VectorStoreFileBatch < OpenAI::Internal::Type::BaseModel
          ...
          override.returns(
            {
              ...
              object: Symbol,
              status: OpenAI::VectorStores::VectorStoreFileBatch::Status::TaggedSymbol,
              vector_store_id: String
            }
          )
        end
        ...
        class FileCounts < OpenAI::Internal::Type::BaseModel
          ...
          sig do
            override.returns(
              {cancelled: Integer, completed: Integer, failed: Integer, in_progress: Integer, total: Integer}
            )
          end
          def to_hash
          end
        ...
        module Status
          ...
          TaggedSymbol = T.type_alias { T.all(Symbol, OpenAI::VectorStores::VectorStoreFileBatch::Status) }
          OrSymbol = T.type_alias { T.any(Symbol, String) }

          IN_PROGRESS = T.let(:in_progress, OpenAI::VectorStores::VectorStoreFileBatch::Status::TaggedSymbol)
          COMPLETED = T.let(:completed, OpenAI::VectorStores::VectorStoreFileBatch::Status::TaggedSymbol)
          CANCELLED = T.let(:cancelled, OpenAI::VectorStores::VectorStoreFileBatch::Status::TaggedSymbol)
          FAILED = T.let(:failed, OpenAI::VectorStores::VectorStoreFileBatch::Status::TaggedSymbol)

          sig { override.returns(T::Array[OpenAI::VectorStores::VectorStoreFileBatch::Status::TaggedSymbol]) }
          def self.values
          end
        end
