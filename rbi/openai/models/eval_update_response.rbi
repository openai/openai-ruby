...
module OpenAI
  module Models
    ...
    class EvalUpdateResponse < OpenAI::Internal::Type::BaseModel
      ...
      sig { returns(T::Array[OpenAI::Models::EvalUpdateResponse::TestingCriterion::Variants]) }
        ...
        override.returns(
          {
            id: String,
            created_at: Integer,
            data_source_config: OpenAI::Models::EvalUpdateResponse::DataSourceConfig::Variants,
            metadata: T.nilable(T::Hash[Symbol, String]),
            name: String,
            object: Symbol,
            testing_criteria: T::Array[OpenAI::Models::EvalUpdateResponse::TestingCriterion::Variants]
          }
        )
      end
      def to_hash
      ...
      module DataSourceConfig
        ...
        sig { override.returns(T::Array[OpenAI::Models::EvalUpdateResponse::DataSourceConfig::Variants]) }
        def self.variants
        end
      ...
      module TestingCriterion
        ...
        sig { override.returns(T::Array[OpenAI::Models::EvalUpdateResponse::TestingCriterion::Variants]) }
        def self.variants
        end
