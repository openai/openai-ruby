  ...
  module Models
    ...
    module Realtime
      ...
      class RealtimeTranscriptionSessionCreateResponse < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(T.nilable(OpenAI::Realtime::RealtimeTranscriptionSessionCreateResponse::Audio)) }
        attr_reader :audio

        sig { params(audio: OpenAI::Realtime::RealtimeTranscriptionSessionCreateResponse::Audio::OrHash).void }
        attr_writer :audio
        ...
        sig {
          returns(
            T.nilable(T::Array[OpenAI::Realtime::RealtimeTranscriptionSessionCreateResponse::Include::TaggedSymbol])
          )
        }
        attr_reader :include

        sig {
          params(include: T::Array[OpenAI::Realtime::RealtimeTranscriptionSessionCreateResponse::Include::OrSymbol])
            .void
        }
        attr_writer :include
        ...
        sig do
          params(
            ...
            audio: OpenAI::Realtime::RealtimeTranscriptionSessionCreateResponse::Audio::OrHash,

            expires_at: Integer,

            include: T::Array[OpenAI::Realtime::RealtimeTranscriptionSessionCreateResponse::Include::OrSymbol],
          ...
          override.returns(
            {
              ...
              expires_at: Integer,
              include: T::Array[OpenAI::Realtime::RealtimeTranscriptionSessionCreateResponse::Include::TaggedSymbol]
            }
          )
        end
        def to_hash
        ...
        class Audio < OpenAI::Internal::Type::BaseModel
          ...
          sig { returns(T.nilable(OpenAI::Realtime::RealtimeTranscriptionSessionCreateResponse::Audio::Input)) }
          attr_reader :input

          sig {
            params(input: OpenAI::Realtime::RealtimeTranscriptionSessionCreateResponse::Audio::Input::OrHash).void
          }
          attr_writer :input
          ...
          sig do
            params(
              ...
              input: OpenAI::Realtime::RealtimeTranscriptionSessionCreateResponse::Audio::Input::OrHash
            )
              .returns(T.attached_class)
          end
          def self.new(
          ...
          class Input < OpenAI::Internal::Type::BaseModel
            ...
            sig {
              returns(
                T.nilable(OpenAI::Realtime::RealtimeTranscriptionSessionCreateResponse::Audio::Input::NoiseReduction)
              )
            }
            ...
            sig {
              params(
                noise_reduction: OpenAI::Realtime::RealtimeTranscriptionSessionCreateResponse::Audio::Input::NoiseReduction::OrHash
              )
                .void
            }
            ...
            sig { returns(T.nilable(OpenAI::Realtime::RealtimeTranscriptionSessionTurnDetection)) }
            attr_reader :turn_detection

            sig {
              params(turn_detection: T.nilable(OpenAI::Realtime::RealtimeTranscriptionSessionTurnDetection::OrHash))
                .void
            }
            ...
            sig do
              params(
                ...
                turn_detection: T.nilable(OpenAI::Realtime::RealtimeTranscriptionSessionTurnDetection::OrHash)
              )
                .returns(T.attached_class)
            end
            def self.new(
              ...
              override.returns(
                {
                  ...
                  turn_detection: T.nilable(OpenAI::Realtime::RealtimeTranscriptionSessionTurnDetection)
                }
              )
            end
            def to_hash
        ...
        module Include
          ...
          TaggedSymbol = T.type_alias {
            T.all(Symbol, OpenAI::Realtime::RealtimeTranscriptionSessionCreateResponse::Include)
          }
          ...
          sig {
            override.returns(
              T::Array[OpenAI::Realtime::RealtimeTranscriptionSessionCreateResponse::Include::TaggedSymbol]
            )
          }
          def self.values
          end
