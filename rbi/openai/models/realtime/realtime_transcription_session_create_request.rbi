  ...
  module Models
    ...
    module Realtime
      ...
      class RealtimeTranscriptionSessionCreateRequest < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(T.nilable(OpenAI::Realtime::RealtimeTranscriptionSessionAudio)) }
        attr_reader :audio

        sig { params(audio: OpenAI::Realtime::RealtimeTranscriptionSessionAudio::OrHash).void }
        attr_writer :audio
        ...
        # transcription.
        sig {
          returns(T.nilable(T::Array[OpenAI::Realtime::RealtimeTranscriptionSessionCreateRequest::Include::OrSymbol]))
        }
        attr_reader :include

        sig {
          params(include: T::Array[OpenAI::Realtime::RealtimeTranscriptionSessionCreateRequest::Include::OrSymbol]).void
        }
        attr_writer :include
        ...
        module Include
          ...
          TaggedSymbol = T.type_alias {
            T.all(Symbol, OpenAI::Realtime::RealtimeTranscriptionSessionCreateRequest::Include)
          }
          ...
          sig {
            override.returns(
              T::Array[OpenAI::Realtime::RealtimeTranscriptionSessionCreateRequest::Include::TaggedSymbol]
            )
          }
          def self.values
          end
