  ...
  module Models
    ...
    module Realtime
      ...
      class RealtimeResponseCreateParams < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(T.nilable(OpenAI::Realtime::RealtimeResponseCreateAudioOutput)) }
        attr_reader :audio

        sig { params(audio: OpenAI::Realtime::RealtimeResponseCreateAudioOutput::OrHash).void }
        attr_writer :audio
        ...
        # conversation.
        sig {
          returns(T.nilable(T.any(String, OpenAI::Realtime::RealtimeResponseCreateParams::Conversation::OrSymbol)))
        }
        attr_reader :conversation

        sig {
          params(conversation: T.any(String, OpenAI::Realtime::RealtimeResponseCreateParams::Conversation::OrSymbol))
            .void
        }
        ...
        # model.
        sig { returns(T.nilable(T::Array[OpenAI::Realtime::RealtimeResponseCreateParams::OutputModality::OrSymbol])) }
        attr_reader :output_modalities

        sig {
          params(output_modalities: T::Array[OpenAI::Realtime::RealtimeResponseCreateParams::OutputModality::OrSymbol])
            .void
        }
        ...
        sig {
          returns(
            T.nilable(
              T::Array[T.any(OpenAI::Realtime::RealtimeFunctionTool, OpenAI::Realtime::RealtimeResponseCreateMcpTool)]
            )
          )
        }
        attr_reader :tools
        ...
        sig do
          params(
            ...
            conversation: T.any(String, OpenAI::Realtime::RealtimeResponseCreateParams::Conversation::OrSymbol),
            ...
            output_modalities: T::Array[OpenAI::Realtime::RealtimeResponseCreateParams::OutputModality::OrSymbol],
          ...
          override.returns(
            {
              ...
              tools: T::Array[
                T.any(OpenAI::Realtime::RealtimeFunctionTool, OpenAI::Realtime::RealtimeResponseCreateMcpTool)
              ]
            }
          )
        end
        ...
        module Conversation
          ...
          Variants = T.type_alias {
            T.any(String, OpenAI::Realtime::RealtimeResponseCreateParams::Conversation::TaggedSymbol)
          }

          sig { override.returns(T::Array[OpenAI::Realtime::RealtimeResponseCreateParams::Conversation::Variants]) }
          def self.variants
          end

          TaggedSymbol = T.type_alias do
            T.all(Symbol, OpenAI::Realtime::RealtimeResponseCreateParams::Conversation)
          end

          OrSymbol = T.type_alias { T.any(Symbol, String) }

          AUTO = T.let(:auto, OpenAI::Realtime::RealtimeResponseCreateParams::Conversation::TaggedSymbol)
          NONE = T.let(:none, OpenAI::Realtime::RealtimeResponseCreateParams::Conversation::TaggedSymbol)
        ...
        module MaxOutputTokens
          ...
          sig { override.returns(T::Array[OpenAI::Realtime::RealtimeResponseCreateParams::MaxOutputTokens::Variants]) }
          def self.variants
          end
        ...
        module OutputModality
          ...
          TaggedSymbol = T.type_alias { T.all(Symbol, OpenAI::Realtime::RealtimeResponseCreateParams::OutputModality) }
          OrSymbol = T.type_alias { T.any(Symbol, String) }

          TEXT = T.let(:text, OpenAI::Realtime::RealtimeResponseCreateParams::OutputModality::TaggedSymbol)
          AUDIO = T.let(:audio, OpenAI::Realtime::RealtimeResponseCreateParams::OutputModality::TaggedSymbol)

          sig {
            override.returns(T::Array[OpenAI::Realtime::RealtimeResponseCreateParams::OutputModality::TaggedSymbol])
          }
          def self.values
          end
        end
        ...
        module ToolChoice
          ...
          sig { override.returns(T::Array[OpenAI::Realtime::RealtimeResponseCreateParams::ToolChoice::Variants]) }
          def self.variants
          end
        ...
        module Tool
          ...
          sig { override.returns(T::Array[OpenAI::Realtime::RealtimeResponseCreateParams::Tool::Variants]) }
          def self.variants
          end
