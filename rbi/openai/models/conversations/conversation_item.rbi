    ...
    module Conversations
      ...
      module ConversationItem
        ...
        class ImageGenerationCall < OpenAI::Internal::Type::BaseModel
          ...
          sig {
            returns(T.nilable(OpenAI::Conversations::ConversationItem::ImageGenerationCall::Action::TaggedSymbol))
          }
          attr_accessor :action

          # The background setting used for generation.
          sig {
            returns(T.nilable(OpenAI::Conversations::ConversationItem::ImageGenerationCall::Background::TaggedSymbol))
          }
          attr_accessor :background

          # The output format used for generation.
          sig {
            returns(T.nilable(OpenAI::Conversations::ConversationItem::ImageGenerationCall::OutputFormat::TaggedSymbol))
          }
          ...
          sig do
            params(
              ...
              action: T.nilable(OpenAI::Conversations::ConversationItem::ImageGenerationCall::Action::OrSymbol),

              background: T.nilable(OpenAI::Conversations::ConversationItem::ImageGenerationCall::Background::OrSymbol),

              output_format: T.nilable(
                OpenAI::Conversations::ConversationItem::ImageGenerationCall::OutputFormat::OrSymbol
              ),
            ...
            override.returns(
              {
                ...
                type: Symbol,
                action: T.nilable(OpenAI::Conversations::ConversationItem::ImageGenerationCall::Action::TaggedSymbol),
                background: T.nilable(
                  OpenAI::Conversations::ConversationItem::ImageGenerationCall::Background::TaggedSymbol
                ),
                output_format: T.nilable(
                  OpenAI::Conversations::ConversationItem::ImageGenerationCall::OutputFormat::TaggedSymbol
                ),
          ...
          module Action
            ...
            TaggedSymbol = T.type_alias {
              T.all(Symbol, OpenAI::Conversations::ConversationItem::ImageGenerationCall::Action)
            }
            OrSymbol = T.type_alias { T.any(Symbol, String) }

            GENERATE = T.let(
              :generate,
              OpenAI::Conversations::ConversationItem::ImageGenerationCall::Action::TaggedSymbol
            )
            EDIT = T.let(:edit, OpenAI::Conversations::ConversationItem::ImageGenerationCall::Action::TaggedSymbol)
            AUTO = T.let(:auto, OpenAI::Conversations::ConversationItem::ImageGenerationCall::Action::TaggedSymbol)

            sig {
              override.returns(
                T::Array[OpenAI::Conversations::ConversationItem::ImageGenerationCall::Action::TaggedSymbol]
              )
            }
            def self.values
            end
          ...
          module Background
            ...
            TaggedSymbol = T.type_alias {
              T.all(Symbol, OpenAI::Conversations::ConversationItem::ImageGenerationCall::Background)
            }
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            AUTO = T.let(:auto, OpenAI::Conversations::ConversationItem::ImageGenerationCall::Background::TaggedSymbol)

            sig {
              override.returns(
                T::Array[OpenAI::Conversations::ConversationItem::ImageGenerationCall::Background::TaggedSymbol]
              )
            }
            def self.values
            end
          ...
          module OutputFormat
            ...
            TaggedSymbol = T.type_alias {
              T.all(Symbol, OpenAI::Conversations::ConversationItem::ImageGenerationCall::OutputFormat)
            }
            OrSymbol = T.type_alias { T.any(Symbol, String) }

            PNG = T.let(:png, OpenAI::Conversations::ConversationItem::ImageGenerationCall::OutputFormat::TaggedSymbol)
            WEBP = T.let(
              :webp,
              OpenAI::Conversations::ConversationItem::ImageGenerationCall::OutputFormat::TaggedSymbol
            )
            ...
            sig {
              override.returns(
                T::Array[OpenAI::Conversations::ConversationItem::ImageGenerationCall::OutputFormat::TaggedSymbol]
              )
            }
            def self.values
            end
