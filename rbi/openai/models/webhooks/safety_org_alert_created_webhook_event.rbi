  ...
  module Models
    ...
    module Webhooks
      ...
      class SafetyOrgAlertCreatedWebhookEvent < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(OpenAI::Webhooks::SafetyOrgAlertCreatedWebhookEvent::Data) }
        attr_reader :data

        sig { params(data: OpenAI::Webhooks::SafetyOrgAlertCreatedWebhookEvent::Data::OrHash).void }
        attr_writer :data
        ...
        sig do
          params(
            ...
            data: OpenAI::Webhooks::SafetyOrgAlertCreatedWebhookEvent::Data::OrHash,
          ...
          override.returns(
            {
              id: String,
              created_at: Integer,
              data: OpenAI::Webhooks::SafetyOrgAlertCreatedWebhookEvent::Data,
              object: Symbol,
              type: Symbol
            }
          )
        ...
        class Data < OpenAI::Internal::Type::BaseModel
          OrHash = T.type_alias do
            T.any(
              OpenAI::Webhooks::SafetyOrgAlertCreatedWebhookEvent::Data,
              OpenAI::Internal::AnyHash
            )
          end
