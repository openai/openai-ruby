  ...
  module Models
    ...
    module Webhooks
      ...
      class SafetyDeactivationIssuedWebhookEvent < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(OpenAI::Webhooks::SafetyDeactivationIssuedWebhookEvent::Data) }
        attr_reader :data

        sig { params(data: OpenAI::Webhooks::SafetyDeactivationIssuedWebhookEvent::Data::OrHash).void }
        attr_writer :data
        ...
        sig do
          params(
            ...
            data: OpenAI::Webhooks::SafetyDeactivationIssuedWebhookEvent::Data::OrHash,
          ...
          override.returns(
            {
              id: String,
              created_at: Integer,
              data: OpenAI::Webhooks::SafetyDeactivationIssuedWebhookEvent::Data,
              object: Symbol,
              type: Symbol
            }
          )
        ...
        class Data < OpenAI::Internal::Type::BaseModel
          OrHash = T.type_alias do
            T.any(
              OpenAI::Webhooks::SafetyDeactivationIssuedWebhookEvent::Data,
              OpenAI::Internal::AnyHash
            )
          end
