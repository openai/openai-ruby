  ...
  module Models
    ...
    module FineTuning
      ...
      class JobCreateParams < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(T.nilable(T::Array[OpenAI::FineTuning::JobCreateParams::Integration])) }
          ...
          override.returns(
            {
              ...
              integrations: T.nilable(T::Array[OpenAI::FineTuning::JobCreateParams::Integration]),
              metadata: T.nilable(T::Hash[Symbol, String]),
        ...
        module Model
          ...
          Variants = T.type_alias { T.any(String, OpenAI::FineTuning::JobCreateParams::Model::TaggedSymbol) }
          ...
          BABBAGE_002 = T.let(:"babbage-002", OpenAI::FineTuning::JobCreateParams::Model::TaggedSymbol)
          DAVINCI_002 = T.let(:"davinci-002", OpenAI::FineTuning::JobCreateParams::Model::TaggedSymbol)
          GPT_3_5_TURBO = T.let(:"gpt-3.5-turbo", OpenAI::FineTuning::JobCreateParams::Model::TaggedSymbol)
          GPT_4O_MINI = T.let(:"gpt-4o-mini", OpenAI::FineTuning::JobCreateParams::Model::TaggedSymbol)
        ...
        class Hyperparameters < OpenAI::Internal::Type::BaseModel
          ...
          module BatchSize
            ...
            sig {
              override.returns(T::Array[OpenAI::FineTuning::JobCreateParams::Hyperparameters::BatchSize::Variants])
            }
            def self.variants
            end
          ...
          module LearningRateMultiplier
            ...
            sig {
              override.returns(
                T::Array[OpenAI::FineTuning::JobCreateParams::Hyperparameters::LearningRateMultiplier::Variants]
              )
            }
            def self.variants
            end
          ...
          module NEpochs
            ...
            sig { override.returns(T::Array[OpenAI::FineTuning::JobCreateParams::Hyperparameters::NEpochs::Variants]) }
            def self.variants
            end
        ...
        class Integration < OpenAI::Internal::Type::BaseModel
          ...
          sig do
            override.returns(
              {type: Symbol, wandb: OpenAI::FineTuning::JobCreateParams::Integration::Wandb}
            )
          end
          def to_hash
          end
          ...
          class Wandb < OpenAI::Internal::Type::BaseModel
            ...
            sig do
              override.returns(
                {project: String, entity: T.nilable(String), name: T.nilable(String), tags: T::Array[String]}
              )
            end
            def to_hash
            end
        ...
        class Method < OpenAI::Internal::Type::BaseModel
          ...
          module Type
            ...
            TaggedSymbol = T.type_alias { T.all(Symbol, OpenAI::FineTuning::JobCreateParams::Method::Type) }
            OrSymbol = T.type_alias { T.any(Symbol, String) }

            SUPERVISED = T.let(:supervised, OpenAI::FineTuning::JobCreateParams::Method::Type::TaggedSymbol)
            DPO = T.let(:dpo, OpenAI::FineTuning::JobCreateParams::Method::Type::TaggedSymbol)
            REINFORCEMENT = T.let(:reinforcement, OpenAI::FineTuning::JobCreateParams::Method::Type::TaggedSymbol)

            sig { override.returns(T::Array[OpenAI::FineTuning::JobCreateParams::Method::Type::TaggedSymbol]) }
            def self.values
            end
          end
        end
