  ...
  module Models
    module FineTuning
      class SupervisedMethod < OpenAI::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(OpenAI::FineTuning::SupervisedMethod::Hyperparameters)
          )
        end
        ...
        sig do
          params(
            hyperparameters:
              OpenAI::FineTuning::SupervisedMethod::Hyperparameters::OrHash
          ).void
        end
        ...
        sig do
          override.returns(
            {
              hyperparameters:
                OpenAI::FineTuning::SupervisedMethod::Hyperparameters
            }
          )
        end
        def to_hash
        ...
        class Hyperparameters < OpenAI::Internal::Type::BaseModel
          ...
          module BatchSize
            ...
            sig do
              override.returns(
                T::Array[
                  OpenAI::FineTuning::SupervisedMethod::Hyperparameters::BatchSize::Variants
                ]
              )
            end
            def self.variants
          ...
          module LearningRateMultiplier
            ...
            sig do
              override.returns(
                T::Array[
                  OpenAI::FineTuning::SupervisedMethod::Hyperparameters::LearningRateMultiplier::Variants
                ]
              )
            end
            def self.variants
          ...
          module NEpochs
            ...
            sig do
              override.returns(
                T::Array[
                  OpenAI::FineTuning::SupervisedMethod::Hyperparameters::NEpochs::Variants
                ]
              )
            end
            def self.variants
