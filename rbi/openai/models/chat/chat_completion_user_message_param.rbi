  ...
  module Models
    ...
    module Chat
      ...
      class ChatCompletionUserMessageParam < OpenAI::Internal::Type::BaseModel
        ...
        sig do
          override.returns(
            {content: OpenAI::Chat::ChatCompletionUserMessageParam::Content::Variants, role: Symbol, name: String}
          )
        end
        def to_hash
        end
        ...
        module Content
          ...
          Variants = T.type_alias { T.any(String, T::Array[OpenAI::Chat::ChatCompletionContentPart::Variants]) }

          sig { override.returns(T::Array[OpenAI::Chat::ChatCompletionUserMessageParam::Content::Variants]) }
          def self.variants
          end
