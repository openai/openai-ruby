  ...
  module Models
    ...
    module Chat
      ...
      class ChatCompletionContentPartInputAudio < OpenAI::Internal::Type::BaseModel
        ...
        # token block.
        sig { returns(T.nilable(OpenAI::Chat::ChatCompletionContentPartInputAudio::PromptCacheBreakpoint)) }
        attr_reader :prompt_cache_breakpoint

        sig {
          params(
            prompt_cache_breakpoint: OpenAI::Chat::ChatCompletionContentPartInputAudio::PromptCacheBreakpoint::OrHash
          )
            .void
        }
          ...
          override.returns(
            {
              ...
              type: Symbol,
              prompt_cache_breakpoint: OpenAI::Chat::ChatCompletionContentPartInputAudio::PromptCacheBreakpoint
            }
          )
        end
        def to_hash
        ...
        class InputAudio < OpenAI::Internal::Type::BaseModel
          ...
          sig do
            override.returns(
              {data: String, format_: OpenAI::Chat::ChatCompletionContentPartInputAudio::InputAudio::Format::OrSymbol}
            )
          end
          def to_hash
          end
          ...
          module Format
            ...
            TaggedSymbol = T.type_alias {
              T.all(Symbol, OpenAI::Chat::ChatCompletionContentPartInputAudio::InputAudio::Format)
            }
            OrSymbol = T.type_alias { T.any(Symbol, String) }

            WAV = T.let(:wav, OpenAI::Chat::ChatCompletionContentPartInputAudio::InputAudio::Format::TaggedSymbol)
            MP3 = T.let(:mp3, OpenAI::Chat::ChatCompletionContentPartInputAudio::InputAudio::Format::TaggedSymbol)

            sig {
              override.returns(
                T::Array[OpenAI::Chat::ChatCompletionContentPartInputAudio::InputAudio::Format::TaggedSymbol]
              )
            }
            def self.values
            end
