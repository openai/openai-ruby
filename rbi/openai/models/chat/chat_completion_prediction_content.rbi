  ...
  module Models
    ...
    module Chat
      ...
      class ChatCompletionPredictionContent < OpenAI::Internal::Type::BaseModel
        ...
        sig do
          override.returns(
            {content: OpenAI::Chat::ChatCompletionPredictionContent::Content::Variants, type: Symbol}
          )
        end
        def to_hash
        end
        ...
        module Content
          ...
          sig { override.returns(T::Array[OpenAI::Chat::ChatCompletionPredictionContent::Content::Variants]) }
          def self.variants
          end
