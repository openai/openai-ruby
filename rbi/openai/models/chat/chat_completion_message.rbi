  ...
  module Models
    ...
    module Chat
      ...
      class ChatCompletionMessage < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(T.nilable(T::Array[OpenAI::Chat::ChatCompletionMessageToolCall::Variants])) }
        ...
        class Annotation < OpenAI::Internal::Type::BaseModel
          ...
          sig do
            override.returns(
              {type: Symbol, url_citation: OpenAI::Chat::ChatCompletionMessage::Annotation::URLCitation}
            )
          end
          def to_hash
          end
          ...
          class URLCitation < OpenAI::Internal::Type::BaseModel
            ...
            sig do
              override.returns(
                {end_index: Integer, start_index: Integer, title: String, url: String}
              )
            end
            def to_hash
            end
