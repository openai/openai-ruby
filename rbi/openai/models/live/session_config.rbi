  ...
  module Models
    ...
    module Live
      ...
      class SessionConfig < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(T.any(String, OpenAI::Live::SessionConfig::Model::OrSymbol)) }
        attr_accessor :model
        ...
        # startup.
        sig { returns(T.nilable(OpenAI::Live::SessionConfig::Audio)) }
        attr_reader :audio

        sig { params(audio: OpenAI::Live::SessionConfig::Audio::OrHash).void }
        attr_writer :audio
        ...
        sig {
          returns(T.nilable(T.any(OpenAI::Live::ClientDelegation, OpenAI::Live::SessionConfig::Delegation::Responses)))
        }
        ...
        sig do
          params(
            ...
            model: T.any(String, OpenAI::Live::SessionConfig::Model::OrSymbol),

            audio: OpenAI::Live::SessionConfig::Audio::OrHash,

            client: OpenAI::Live::ClientConfig::OrHash,

            delegation: T.nilable(
              T.any(OpenAI::Live::ClientDelegation::OrHash, OpenAI::Live::SessionConfig::Delegation::Responses::OrHash)
            ),
        ...
        sig do
          override.returns(
            {
              model: T.any(String, OpenAI::Live::SessionConfig::Model::OrSymbol),
              audio: OpenAI::Live::SessionConfig::Audio,
              client: OpenAI::Live::ClientConfig,
              delegation: T.nilable(
                T.any(OpenAI::Live::ClientDelegation, OpenAI::Live::SessionConfig::Delegation::Responses)
              ),
              input: T::Array[
                T.any(
                  OpenAI::Live::InitialItem::Developer,
        ...
        module Model
          ...
          Variants = T.type_alias { T.any(String, OpenAI::Live::SessionConfig::Model::TaggedSymbol) }

          sig { override.returns(T::Array[OpenAI::Live::SessionConfig::Model::Variants]) }
          def self.variants
          end

          TaggedSymbol = T.type_alias do
            T.all(Symbol, OpenAI::Live::SessionConfig::Model)
          end

          OrSymbol = T.type_alias { T.any(Symbol, String) }

          GPT_LIVE_1 = T.let(:"gpt-live-1", OpenAI::Live::SessionConfig::Model::TaggedSymbol)
        ...
        class Audio < OpenAI::Internal::Type::BaseModel
          OrHash = T.type_alias do
            T.any(
              OpenAI::Live::SessionConfig::Audio,
              OpenAI::Internal::AnyHash
            )
          end
          ...
          sig { returns(T.nilable(OpenAI::Live::SessionConfig::Audio::Output)) }
          attr_reader :output

          sig { params(output: OpenAI::Live::SessionConfig::Audio::Output::OrHash).void }
          attr_writer :output
          ...
          sig do
            params(
              ...
              output: OpenAI::Live::SessionConfig::Audio::Output::OrHash
            )
              .returns(T.attached_class)
          end
          def self.new(
            ...
            override.returns(
              {
                ...
                output: OpenAI::Live::SessionConfig::Audio::Output
              }
            )
          end
          def to_hash
          ...
          class Output < OpenAI::Internal::Type::BaseModel
            OrHash = T.type_alias do
              T.any(
                OpenAI::Live::SessionConfig::Audio::Output,
                OpenAI::Internal::AnyHash
              )
            end
            ...
            module Voice
              ...
              sig { override.returns(T::Array[OpenAI::Live::SessionConfig::Audio::Output::Voice::Variants]) }
              def self.variants
              end
        ...
        module Delegation
          ...
          class Responses < OpenAI::Internal::Type::BaseModel
            OrHash = T.type_alias do
              T.any(
                OpenAI::Live::SessionConfig::Delegation::Responses,
                OpenAI::Internal::AnyHash
              )
            end
          ...
          sig { override.returns(T::Array[OpenAI::Live::SessionConfig::Delegation::Variants]) }
          def self.variants
          end
