    ...
    module Live
      ...
      class SessionForkResponse < OpenAI::Internal::Type::BaseModel
        ...
        OrHash = T.type_alias do
          T.any(
            OpenAI::Models::Live::SessionForkResponse,
        ...
        # connections.
        sig { returns(OpenAI::Models::Live::SessionForkResponse::Session) }
        attr_reader :session

        sig { params(session: OpenAI::Models::Live::SessionForkResponse::Session::OrHash).void }
        attr_writer :session

        # WebRTC transport with the SDP answer.
        sig { returns(OpenAI::Models::Live::SessionForkResponse::Transport) }
        attr_reader :transport

        sig { params(transport: OpenAI::Models::Live::SessionForkResponse::Transport::OrHash).void }
        ...
        sig do
          params(
            ...
            session: OpenAI::Models::Live::SessionForkResponse::Session::OrHash,

            transport: OpenAI::Models::Live::SessionForkResponse::Transport::OrHash
          )
        ...
        class Session < OpenAI::Internal::Type::BaseModel
          OrHash = T.type_alias do
            T.any(
              OpenAI::Models::Live::SessionForkResponse::Session,
              OpenAI::Internal::AnyHash
            )
          end
        ...
        class Transport < OpenAI::Internal::Type::BaseModel
          OrHash = T.type_alias do
            T.any(
              OpenAI::Models::Live::SessionForkResponse::Transport,
              OpenAI::Internal::AnyHash
            )
          end
