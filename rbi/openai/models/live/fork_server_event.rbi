      ...
      module ForkServerEvent
        ...
        Variants = T.type_alias do
          T.any(
            ...
            OpenAI::Live::ForkServerEvent::SessionInputAudioAppend,
            ...
            OpenAI::Live::ForkServerEvent::TransportDtmfReceived,
            OpenAI::Live::ForkServerEvent::TransportDtmfSend,
            OpenAI::Live::ForkServerEvent::TransportRinging,
            OpenAI::Live::ForkServerEvent::TransportAnswered,
            OpenAI::Live::ForkServerEvent::TransportFailed
          )
        end
        ...
        class TransportFailed < OpenAI::Internal::Type::BaseModel
          ...
          sig { returns(OpenAI::Live::ForkServerEvent::TransportFailed::Error) }
          attr_reader :error

          sig { params(error: OpenAI::Live::ForkServerEvent::TransportFailed::Error::OrHash).void }
          attr_writer :error
          ...
          sig do
            params(
              ...
              error: OpenAI::Live::ForkServerEvent::TransportFailed::Error::OrHash,
          ...
          sig do
            override.returns(
              {
                error: OpenAI::Live::ForkServerEvent::TransportFailed::Error,
                event_id: String,
                session_id: String,
                type: Symbol
              }
          ...
          class Error < OpenAI::Internal::Type::BaseModel
            OrHash = T.type_alias do
              T.any(
                OpenAI::Live::ForkServerEvent::TransportFailed::Error,
                OpenAI::Internal::AnyHash
              )
            end
        ...
        sig { override.returns(T::Array[OpenAI::Live::ForkServerEvent::Variants]) }
        def self.variants
        end
