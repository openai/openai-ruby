    ...
    module Responses
      ...
      module ResponseStreamEvent
        ...
        class ResponseOutputTextAnnotationAdded < OpenAI::Internal::Type::BaseModel
          ...
          sig do
            returns(
              OpenAI::Responses::ResponseStreamEvent::ResponseOutputTextAnnotationAdded::Annotation::Variants
            )
          end
          ...
          sig do
            params(
              annotation:
                T.any(
                  OpenAI::Responses::ResponseStreamEvent::ResponseOutputTextAnnotationAdded::Annotation::FileCitation::OrHash,
                  OpenAI::Responses::ResponseStreamEvent::ResponseOutputTextAnnotationAdded::Annotation::URLCitation::OrHash,
                  OpenAI::Responses::ResponseStreamEvent::ResponseOutputTextAnnotationAdded::Annotation::FilePath::OrHash
                ),
