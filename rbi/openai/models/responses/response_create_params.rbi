  ...
  module Models
    ...
    module Responses
      ...
      class ResponseCreateParams < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(T.nilable(OpenAI::Responses::ResponseCreateParams::AccessPrograms)) }
        attr_reader :access_programs

        sig { params(access_programs: OpenAI::Responses::ResponseCreateParams::AccessPrograms::OrHash).void }
        ...
        sig do
          override.returns(
            {
              access_programs: OpenAI::Responses::ResponseCreateParams::AccessPrograms,
              background: T.nilable(T::Boolean),
        ...
        class AccessPrograms < OpenAI::Internal::Type::BaseModel
          ...
          sig { returns(T.nilable(OpenAI::Responses::ResponseCreateParams::AccessPrograms::Cyber::OrSymbol)) }
          attr_reader :cyber

          sig { params(cyber: OpenAI::Responses::ResponseCreateParams::AccessPrograms::Cyber::OrSymbol).void }
          attr_writer :cyber
          ...
          sig do
            params(
              ...
              cyber: OpenAI::Responses::ResponseCreateParams::AccessPrograms::Cyber::OrSymbol
            )
              .returns(T.attached_class)
          end
          def self.new(
          ...
          module Cyber
            ...
            TaggedSymbol = T.type_alias {
              T.all(Symbol, OpenAI::Responses::ResponseCreateParams::AccessPrograms::Cyber)
            }
            OrSymbol = T.type_alias { T.any(Symbol, String) }

            STANDARD = T.let(:standard, OpenAI::Responses::ResponseCreateParams::AccessPrograms::Cyber::TaggedSymbol)
            DAYBREAK_BLUE = T.let(
              :daybreak_blue,
              OpenAI::Responses::ResponseCreateParams::AccessPrograms::Cyber::TaggedSymbol
            )
            DAYBREAK_RED = T.let(
              :daybreak_red,
              OpenAI::Responses::ResponseCreateParams::AccessPrograms::Cyber::TaggedSymbol
            ...
            sig {
              override.returns(T::Array[OpenAI::Responses::ResponseCreateParams::AccessPrograms::Cyber::TaggedSymbol])
            }
            def self.values
            end
          end
