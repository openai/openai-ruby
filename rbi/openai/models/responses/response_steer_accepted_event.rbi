...
module OpenAI
  module Models
    ...
    module Responses
      ...
      class ResponseSteerAcceptedEvent < OpenAI::Internal::Type::BaseModel
        ...
        sig { returns(OpenAI::Responses::ResponseSteerAcceptedEvent::Steer) }
        attr_reader :steer

        sig { params(steer: OpenAI::Responses::ResponseSteerAcceptedEvent::Steer::OrHash).void }
        attr_writer :steer
        ...
        sig do
          params(
            ...
            steer: OpenAI::Responses::ResponseSteerAcceptedEvent::Steer::OrHash,
        ...
        sig do
          override.returns(
            {
              sequence_number: Integer,
              steer: OpenAI::Responses::ResponseSteerAcceptedEvent::Steer,
              type: Symbol,
              stream_id: String
            }
          )
        ...
        class Steer < OpenAI::Internal::Type::BaseModel
          OrHash = T.type_alias do
            T.any(
              OpenAI::Responses::ResponseSteerAcceptedEvent::Steer,
              OpenAI::Internal::AnyHash
            )
          end
