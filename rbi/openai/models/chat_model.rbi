...
module OpenAI
  module Models
    ...
    module ChatModel
      ...
      GPT_5_5_2026_04_23 = T.let(:"gpt-5.5-2026-04-23", OpenAI::ChatModel::TaggedSymbol)
      ...
      GPT_5_4_MINI_2026_03_17 = T.let(:"gpt-5.4-mini-2026-03-17", OpenAI::ChatModel::TaggedSymbol)
      GPT_5_4_NANO_2026_03_17 = T.let(:"gpt-5.4-nano-2026-03-17", OpenAI::ChatModel::TaggedSymbol)
      GPT_5_3_CHAT_LATEST = T.let(:"gpt-5.3-chat-latest", OpenAI::ChatModel::TaggedSymbol)
      GPT_5_2 = T.let(:"gpt-5.2", OpenAI::ChatModel::TaggedSymbol)
      GPT_5_2_2025_12_11 = T.let(:"gpt-5.2-2025-12-11", OpenAI::ChatModel::TaggedSymbol)
      GPT_5_2_CHAT_LATEST = T.let(:"gpt-5.2-chat-latest", OpenAI::ChatModel::TaggedSymbol)
      GPT_5_2_PRO = T.let(:"gpt-5.2-pro", OpenAI::ChatModel::TaggedSymbol)
      GPT_5_2_PRO_2025_12_11 = T.let(:"gpt-5.2-pro-2025-12-11", OpenAI::ChatModel::TaggedSymbol)
      ...
      GPT_5_2025_08_07 = T.let(:"gpt-5-2025-08-07", OpenAI::ChatModel::TaggedSymbol)
      GPT_5_MINI_2025_08_07 = T.let(:"gpt-5-mini-2025-08-07", OpenAI::ChatModel::TaggedSymbol)
      GPT_5_NANO_2025_08_07 = T.let(:"gpt-5-nano-2025-08-07", OpenAI::ChatModel::TaggedSymbol)
      GPT_5_CHAT_LATEST = T.let(:"gpt-5-chat-latest", OpenAI::ChatModel::TaggedSymbol)
      ...
      GPT_4O_AUDIO_PREVIEW_2025_06_03 = T.let(:"gpt-4o-audio-preview-2025-06-03", OpenAI::ChatModel::TaggedSymbol)
      ...
      GPT_4O_SEARCH_PREVIEW_2025_03_11 = T.let(:"gpt-4o-search-preview-2025-03-11", OpenAI::ChatModel::TaggedSymbol)
