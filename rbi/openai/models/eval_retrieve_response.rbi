...
module OpenAI
  module Models
    ...
    class EvalRetrieveResponse < OpenAI::Internal::Type::BaseModel
      ...
      sig { returns(T::Array[OpenAI::Models::EvalRetrieveResponse::TestingCriterion::Variants]) }
        ...
        override.returns(
          {
            id: String,
            created_at: Integer,
            data_source_config: OpenAI::Models::EvalRetrieveResponse::DataSourceConfig::Variants,
            metadata: T.nilable(T::Hash[Symbol, String]),
            name: String,
            object: Symbol,
            testing_criteria: T::Array[OpenAI::Models::EvalRetrieveResponse::TestingCriterion::Variants]
          }
        )
      end
      def to_hash
      ...
      module DataSourceConfig
        ...
        sig { override.returns(T::Array[OpenAI::Models::EvalRetrieveResponse::DataSourceConfig::Variants]) }
        def self.variants
        end
      ...
      module TestingCriterion
        ...
        sig { override.returns(T::Array[OpenAI::Models::EvalRetrieveResponse::TestingCriterion::Variants]) }
        def self.variants
        end
