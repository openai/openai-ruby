...
module OpenAI
  module Models
    ...
    class BatchCreateParams < OpenAI::Internal::Type::BaseModel
      ...
      sig { params(output_expires_after: OpenAI::BatchCreateParams::OutputExpiresAfter::OrHash).void }
      ...
      module CompletionWindow
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, OpenAI::BatchCreateParams::CompletionWindow) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        COMPLETION_WINDOW_24H = T.let(:"24h", OpenAI::BatchCreateParams::CompletionWindow::TaggedSymbol)
      ...
      module Endpoint
        ...
        V1_RESPONSES = T.let(:"/v1/responses", OpenAI::BatchCreateParams::Endpoint::TaggedSymbol)
        V1_CHAT_COMPLETIONS = T.let(:"/v1/chat/completions", OpenAI::BatchCreateParams::Endpoint::TaggedSymbol)
        V1_EMBEDDINGS = T.let(:"/v1/embeddings", OpenAI::BatchCreateParams::Endpoint::TaggedSymbol)
        V1_COMPLETIONS = T.let(:"/v1/completions", OpenAI::BatchCreateParams::Endpoint::TaggedSymbol)
        V1_MODERATIONS = T.let(:"/v1/moderations", OpenAI::BatchCreateParams::Endpoint::TaggedSymbol)
        V1_IMAGES_GENERATIONS = T.let(:"/v1/images/generations", OpenAI::BatchCreateParams::Endpoint::TaggedSymbol)
        V1_IMAGES_EDITS = T.let(:"/v1/images/edits", OpenAI::BatchCreateParams::Endpoint::TaggedSymbol)
        V1_VIDEOS = T.let(:"/v1/videos", OpenAI::BatchCreateParams::Endpoint::TaggedSymbol)
