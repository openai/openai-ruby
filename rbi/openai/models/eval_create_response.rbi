    ...
    class EvalCreateResponse < OpenAI::Internal::Type::BaseModel
      ...
      sig do
        params(
          ...
          testing_criteria:
            T::Array[
              T.any(
                OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel::OrHash,
                OpenAI::Models::EvalCreateResponse::TestingCriterion::StringCheck::OrHash,
                OpenAI::Models::EvalCreateResponse::TestingCriterion::TextSimilarity::OrHash,
      ...
      module TestingCriterion
        ...
        Variants =
          T.type_alias do
            T.any(
              OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel,
              OpenAI::Models::EvalCreateResponse::TestingCriterion::StringCheck,
              OpenAI::Models::EvalCreateResponse::TestingCriterion::TextSimilarity,
        ...
        class LabelModel < OpenAI::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T::Array[
                OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel::Input
              ]
            )
          end
          attr_accessor :input
          ...
          sig do
            params(
              input:
                T::Array[
                  OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel::Input::OrHash
                ],
          ...
          class Input < OpenAI::Internal::Type::BaseModel
            ...
            sig do
              returns(
                OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel::Input::Content::Variants
              )
            end
            ...
            sig do
              returns(
                OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel::Input::Role::TaggedSymbol
              )
            end
            attr_accessor :role
            ...
            sig do
              returns(
                T.nilable(
                  OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel::Input::Type::TaggedSymbol
                )
              )
            end
            attr_reader :type
            ...
            sig do
              params(
                type:
                  OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel::Input::Type::OrSymbol
              ).void
            end
            attr_writer :type
              ...
              params(
                content:
                  T.any(
                    ...
                    OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel::Input::Content::OutputText::OrHash
                  ),
                role:
                  OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel::Input::Role::OrSymbol,
                type:
                  OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel::Input::Type::OrSymbol
              ).returns(T.attached_class)
            end
            ...
            module Role
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel::Input::Role
                  )
                end
            ...
            module Type
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    OpenAI::Models::EvalCreateResponse::TestingCriterion::LabelModel::Input::Type
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class StringCheck < OpenAI::Internal::Type::BaseModel
          ...
          sig do
            returns(
              OpenAI::Models::EvalCreateResponse::TestingCriterion::StringCheck::Operation::TaggedSymbol
            )
          end
          ...
          sig do
            params(
              ...
              name: String,
              operation:
                OpenAI::Models::EvalCreateResponse::TestingCriterion::StringCheck::Operation::OrSymbol,
              reference: String,
              type: Symbol
            ).returns(T.attached_class)
          end
          ...
          module Operation
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  OpenAI::Models::EvalCreateResponse::TestingCriterion::StringCheck::Operation
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class TextSimilarity < OpenAI::Internal::Type::BaseModel
          ...
          sig do
            returns(
              OpenAI::Models::EvalCreateResponse::TestingCriterion::TextSimilarity::EvaluationMetric::TaggedSymbol
            )
          end
          ...
          sig do
            params(
              evaluation_metric:
                OpenAI::Models::EvalCreateResponse::TestingCriterion::TextSimilarity::EvaluationMetric::OrSymbol,
              input: String,
          ...
          module EvaluationMetric
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  OpenAI::Models::EvalCreateResponse::TestingCriterion::TextSimilarity::EvaluationMetric
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
