...
module OpenAI
  module Models
    ...
    class ResponseFormatJSONSchema < OpenAI::Internal::Type::BaseModel
      ...
      sig { params(json_schema: OpenAI::ResponseFormatJSONSchema::JSONSchema::OrHash).void }
      ...
      sig do
        override.returns(
          {json_schema: OpenAI::ResponseFormatJSONSchema::JSONSchema, type: Symbol}
        )
      end
      def to_hash
      end
      ...
      class JSONSchema < OpenAI::Internal::Type::BaseModel
        ...
        sig do
          override.returns(
            {name: String, description: String, schema: T::Hash[Symbol, T.anything], strict: T.nilable(T::Boolean)}
          )
        end
        def to_hash
        end
