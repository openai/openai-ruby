    ...
    module Containers
      ...
      class FileListParams < OpenAI::Internal::Type::BaseModel
        ...
        OrHash = T.type_alias do
          T.any(
            OpenAI::Containers::FileListParams,
        ...
        module Order
          ...
          TaggedSymbol = T.type_alias { T.all(Symbol, OpenAI::Containers::FileListParams::Order) }
          OrSymbol = T.type_alias { T.any(Symbol, String) }

          ASC = T.let(:asc, OpenAI::Containers::FileListParams::Order::TaggedSymbol)
          DESC = T.let(:desc, OpenAI::Containers::FileListParams::Order::TaggedSymbol)
