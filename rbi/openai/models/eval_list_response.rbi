  ...
  module Models
    ...
    class EvalListResponse < OpenAI::Internal::Type::BaseModel
        ...
        override.returns(
          {
            id: String,
            created_at: Integer,
            data_source_config: OpenAI::Models::EvalListResponse::DataSourceConfig::Variants,
            metadata: T.nilable(T::Hash[Symbol, String]),
            name: String,
            object: Symbol,
            testing_criteria: T::Array[OpenAI::Models::EvalListResponse::TestingCriterion::Variants]
          }
        )
      end
      def to_hash
      ...
      module DataSourceConfig
        ...
        sig { override.returns(T::Array[OpenAI::Models::EvalListResponse::DataSourceConfig::Variants]) }
        def self.variants
        end
      ...
      module TestingCriterion
        ...
        sig { override.returns(T::Array[OpenAI::Models::EvalListResponse::TestingCriterion::Variants]) }
        def self.variants
        end
