    ...
    module Evals
      module Runs
        class OutputItemListResponse < OpenAI::Internal::Type::BaseModel
          ...
          sig do
            params(
              sample: T.any(OpenAI::Models::Evals::Runs::OutputItemListResponse::Sample, OpenAI::Internal::AnyHash)
            )
              .void
          end
          attr_writer :sample
          ...
          class Sample < OpenAI::Internal::Type::BaseModel
            ...
            sig do
              params(
                usage: T.any(OpenAI::Models::Evals::Runs::OutputItemListResponse::Sample::Usage, OpenAI::Internal::AnyHash)
              )
                .void
            end
            attr_writer :usage
            ...
            sig do
              params(
                ...
                input: T::Array[T.any(OpenAI::Models::Evals::Runs::OutputItemListResponse::Sample::Input, OpenAI::Internal::AnyHash)],
                max_completion_tokens: Integer,
                model: String,
                output: T::Array[T.any(OpenAI::Models::Evals::Runs::OutputItemListResponse::Sample::Output, OpenAI::Internal::AnyHash)],
                seed: Integer,
                temperature: Float,
                top_p: Float,
                usage: T.any(OpenAI::Models::Evals::Runs::OutputItemListResponse::Sample::Usage, OpenAI::Internal::AnyHash)
