      ...
      class RunCancelResponse < OpenAI::Internal::Type::BaseModel
        ...
        sig do
          params(
            ...
            per_model_usage: T::Array[OpenAI::Models::Evals::RunCancelResponse::PerModelUsage::OrHash],
          ...
          override.returns(
            {
              id: String,
              created_at: Integer,
              data_source: OpenAI::Models::Evals::RunCancelResponse::DataSource::Variants,
        ...
        module DataSource
          ...
          class Responses < OpenAI::Internal::Type::BaseModel
            ...
            sig {
              returns(
                T.nilable(OpenAI::Models::Evals::RunCancelResponse::DataSource::Responses::InputMessages::Variants)
              )
            }
            ...
            sig { returns(T.nilable(OpenAI::Models::Evals::RunCancelResponse::DataSource::Responses::SamplingParams)) }
            ...
            sig do
              override.returns(
                {
                  source: OpenAI::Models::Evals::RunCancelResponse::DataSource::Responses::Source::Variants,
                  type: Symbol,
                  input_messages: OpenAI::Models::Evals::RunCancelResponse::DataSource::Responses::InputMessages::Variants,
                  model: String,
                  sampling_params: OpenAI::Models::Evals::RunCancelResponse::DataSource::Responses::SamplingParams
                }
              )
            end
            def to_hash
            ...
            module Source
              ...
              sig {
                override.returns(
                  T::Array[OpenAI::Models::Evals::RunCancelResponse::DataSource::Responses::Source::Variants]
                )
              }
              def self.variants
              end
            ...
            module InputMessages
                ...
                module Template
                  ...
                  class EvalItem < OpenAI::Internal::Type::BaseModel
                    ...
                    sig do
                      override.returns(
                        {
                          content: OpenAI::Models::Evals::RunCancelResponse::DataSource::Responses::InputMessages::Template::Template::EvalItem::Content::Variants,
                          role: OpenAI::Models::Evals::RunCancelResponse::DataSource::Responses::InputMessages::Template::Template::EvalItem::Role::TaggedSymbol,
                          type: OpenAI::Models::Evals::RunCancelResponse::DataSource::Responses::InputMessages::Template::Template::EvalItem::Type::TaggedSymbol
                        }
                      )
                    end
                    def to_hash
              ...
              sig {
                override.returns(
                  T::Array[OpenAI::Models::Evals::RunCancelResponse::DataSource::Responses::InputMessages::Variants]
                )
              }
              def self.variants
              end
            ...
            class SamplingParams < OpenAI::Internal::Type::BaseModel
              ...
              sig {
                returns(
                  T.nilable(OpenAI::Models::Evals::RunCancelResponse::DataSource::Responses::SamplingParams::Text)
                )
              }
              attr_reader :text
          ...
          sig { override.returns(T::Array[OpenAI::Models::Evals::RunCancelResponse::DataSource::Variants]) }
          def self.variants
          end
