  ...
  module Models
    ...
    module Audio
      ...
      class TranscriptionCreateParams < OpenAI::Internal::Type::BaseModel
        ...
        # seconds.
        sig {
          returns(T.nilable(T.any(Symbol, OpenAI::Audio::TranscriptionCreateParams::ChunkingStrategy::VadConfig)))
        }
        ...
        # `gpt-4o-transcribe-diarize`.
        sig { returns(T.nilable(T::Array[OpenAI::Audio::TranscriptionCreateParams::TimestampGranularity::OrSymbol])) }
        ...
        module Model
          ...
          sig { override.returns(T::Array[OpenAI::Audio::TranscriptionCreateParams::Model::Variants]) }
          def self.variants
          end
        ...
        module ChunkingStrategy
          ...
          class VadConfig < OpenAI::Internal::Type::BaseModel
            ...
            module Type
              ...
              TaggedSymbol = T.type_alias {
                T.all(Symbol, OpenAI::Audio::TranscriptionCreateParams::ChunkingStrategy::VadConfig::Type)
              }
              ...
              sig {
                override.returns(
                  T::Array[OpenAI::Audio::TranscriptionCreateParams::ChunkingStrategy::VadConfig::Type::TaggedSymbol]
                )
              }
              def self.values
              end
          ...
          sig { override.returns(T::Array[OpenAI::Audio::TranscriptionCreateParams::ChunkingStrategy::Variants]) }
          def self.variants
          end
        ...
        module TimestampGranularity
          ...
          TaggedSymbol = T.type_alias { T.all(Symbol, OpenAI::Audio::TranscriptionCreateParams::TimestampGranularity) }
          OrSymbol = T.type_alias { T.any(Symbol, String) }

          WORD = T.let(:word, OpenAI::Audio::TranscriptionCreateParams::TimestampGranularity::TaggedSymbol)
          SEGMENT = T.let(:segment, OpenAI::Audio::TranscriptionCreateParams::TimestampGranularity::TaggedSymbol)

          sig {
            override.returns(T::Array[OpenAI::Audio::TranscriptionCreateParams::TimestampGranularity::TaggedSymbol])
          }
          def self.values
          end
        end
