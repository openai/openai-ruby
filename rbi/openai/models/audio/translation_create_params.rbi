  ...
  module Models
    ...
    module Audio
      ...
      class TranslationCreateParams < OpenAI::Internal::Type::BaseModel
        ...
        # `verbose_json`, or `vtt`.
        sig { returns(T.nilable(OpenAI::Audio::TranslationCreateParams::ResponseFormat::OrSymbol)) }
        ...
        module ResponseFormat
          ...
          TaggedSymbol = T.type_alias { T.all(Symbol, OpenAI::Audio::TranslationCreateParams::ResponseFormat) }
          OrSymbol = T.type_alias { T.any(Symbol, String) }

          JSON = T.let(:json, OpenAI::Audio::TranslationCreateParams::ResponseFormat::TaggedSymbol)
          TEXT = T.let(:text, OpenAI::Audio::TranslationCreateParams::ResponseFormat::TaggedSymbol)
          SRT = T.let(:srt, OpenAI::Audio::TranslationCreateParams::ResponseFormat::TaggedSymbol)
          VERBOSE_JSON = T.let(:verbose_json, OpenAI::Audio::TranslationCreateParams::ResponseFormat::TaggedSymbol)
          VTT = T.let(:vtt, OpenAI::Audio::TranslationCreateParams::ResponseFormat::TaggedSymbol)

          sig { override.returns(T::Array[OpenAI::Audio::TranslationCreateParams::ResponseFormat::TaggedSymbol]) }
          def self.values
          end
        end
