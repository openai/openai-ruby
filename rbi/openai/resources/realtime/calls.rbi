...
module OpenAI
  module Resources
    class Realtime
      class Calls
        sig { returns(Calls::WithRawResponse) }
        ...
        class WithRawResponse
          ...
          sig { params(call_id: String, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[NilClass]) }
          def hangup(
            # The identifier for the call. For SIP calls, use the value provided in the
            # [`realtime.call.incoming`](https://platform.openai.com/docs/api-reference/webhook-events/realtime/call/incoming)
            # webhook. For WebRTC sessions, reuse the call ID returned in the `Location`
          ...
          sig { params(call_id: String, target_uri: String, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[NilClass]) }
          def refer(
            # The identifier for the call provided in the
            # [`realtime.call.incoming`](https://platform.openai.com/docs/api-reference/webhook-events/realtime/call/incoming)
            # webhook.
          ...
          sig { params(call_id: String, status_code: Integer, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[NilClass]) }
          def reject(
            # The identifier for the call provided in the
            # [`realtime.call.incoming`](https://platform.openai.com/docs/api-reference/webhook-events/realtime/call/incoming)
            # webhook.
          ...
          # @api private
          sig { params(resource: Calls).returns(T.attached_class) }
