...
module OpenAI
  module Resources
    class Beta
      ...
      class Threads
        sig { returns(Threads::WithRawResponse) }
        ...
        class WithRawResponse
          sig { returns(OpenAI::Resources::Beta::Threads::Runs::WithRawResponse) }
          attr_reader :runs

          sig { returns(OpenAI::Resources::Beta::Threads::Messages::WithRawResponse) }
          attr_reader :messages

          sig { params(messages: T::Array[OpenAI::Beta::ThreadCreateParams::Message::OrHash], metadata: T.nilable(T::Hash[Symbol, String]), tool_resources: T.nilable(OpenAI::Beta::ThreadCreateParams::ToolResources::OrHash), request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Beta::Thread]) }
          def create(
            # A list of [messages](https://platform.openai.com/docs/api-reference/messages) to
            # start the thread with.
            messages: nil,
          ...
          sig { params(thread_id: String, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Beta::Thread]) }
          def retrieve(
            # The ID of the thread to retrieve.
            thread_id,
            request_options: {}
          ...
          sig { params(thread_id: String, metadata: T.nilable(T::Hash[Symbol, String]), tool_resources: T.nilable(OpenAI::Beta::ThreadUpdateParams::ToolResources::OrHash), request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Beta::Thread]) }
          def update(
            # The ID of the thread to modify. Only the `metadata` can be modified.
            thread_id,
            # Set of 16 key-value pairs that can be attached to an object. This can be useful
          ...
          sig { params(thread_id: String, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Beta::ThreadDeleted]) }
          def delete(
            # The ID of the thread to delete.
            thread_id,
            request_options: {}
          ...
          sig { params(assistant_id: String, instructions: T.nilable(String), max_completion_tokens: T.nilable(Integer), max_prompt_tokens: T.nilable(Integer), metadata: T.nilable(T::Hash[Symbol, String]), model: T.nilable(T.any(String, OpenAI::ChatModel::OrSymbol)), parallel_tool_calls: T::Boolean, response_format: T.nilable(T.any(Symbol, OpenAI::ResponseFormatText::OrHash, OpenAI::ResponseFormatJSONObject::OrHash, OpenAI::ResponseFormatJSONSchema::OrHash)), temperature: T.nilable(Float), thread: OpenAI::Beta::ThreadCreateAndRunParams::Thread::OrHash, tool_choice: T.nilable(T.any(OpenAI::Beta::AssistantToolChoiceOption::Auto::OrSymbol, OpenAI::Beta::AssistantToolChoice::OrHash)), tool_resources: T.nilable(OpenAI::Beta::ThreadCreateAndRunParams::ToolResources::OrHash), tools: T.nilable(T::Array[T.any(OpenAI::Beta::CodeInterpreterTool::OrHash, OpenAI::Beta::FileSearchTool::OrHash, OpenAI::Beta::FunctionTool::OrHash)]), top_p: T.nilable(Float), truncation_strategy: T.nilable(OpenAI::Beta::ThreadCreateAndRunParams::TruncationStrategy::OrHash), stream: T.noreturn, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Internal::Stream[OpenAI::Beta::AssistantStreamEvent::Variants]]) }
          def stream_raw(
            # The ID of the
            # [assistant](https://platform.openai.com/docs/api-reference/assistants) to use to
            # execute this run.
          ...
          # @api private
          sig { params(resource: Threads).returns(T.attached_class) }
