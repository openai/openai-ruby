    ...
    class Beta
      class Threads
        class Runs
          ...
          class Steps
            sig { returns(Steps::WithRawResponse) }
            ...
            class WithRawResponse
              sig { params(step_id: String, thread_id: String, run_id: String, include: T::Array[OpenAI::Beta::Threads::Runs::RunStepInclude::OrSymbol], request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Beta::Threads::Runs::RunStep]) }
              def retrieve(
                # Path param: The ID of the run step to retrieve.
                step_id,
                # Path param: The ID of the thread to which the run and run step belongs.
              ...
              sig { params(run_id: String, thread_id: String, after: String, before: String, include: T::Array[OpenAI::Beta::Threads::Runs::RunStepInclude::OrSymbol], limit: Integer, order: OpenAI::Beta::Threads::Runs::StepListParams::Order::OrSymbol, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Internal::CursorPage[OpenAI::Beta::Threads::Runs::RunStep]]) }
              def list(
                # Path param: The ID of the run the run steps belong to.
                run_id,
                # Path param: The ID of the thread the run and run steps belong to.
              ...
              # @api private
              sig { params(resource: Steps).returns(T.attached_class) }
