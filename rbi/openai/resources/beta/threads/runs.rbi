  ...
  module Resources
    class Beta
      class Threads
        ...
        class Runs
          sig { returns(Runs::WithRawResponse) }
          ...
          class WithRawResponse
            sig { returns(OpenAI::Resources::Beta::Threads::Runs::Steps::WithRawResponse) }
            attr_reader :steps

            sig { params(thread_id: String, assistant_id: String, include: T::Array[OpenAI::Beta::Threads::Runs::RunStepInclude::OrSymbol], additional_instructions: T.nilable(String), additional_messages: T.nilable(T::Array[OpenAI::Beta::Threads::RunCreateParams::AdditionalMessage::OrHash]), instructions: T.nilable(String), max_completion_tokens: T.nilable(Integer), max_prompt_tokens: T.nilable(Integer), metadata: T.nilable(T::Hash[Symbol, String]), model: T.nilable(T.any(String, OpenAI::ChatModel::OrSymbol)), parallel_tool_calls: T::Boolean, reasoning_effort: T.nilable(OpenAI::ReasoningEffort::OrSymbol), response_format: T.nilable(T.any(Symbol, OpenAI::ResponseFormatText::OrHash, OpenAI::ResponseFormatJSONObject::OrHash, OpenAI::ResponseFormatJSONSchema::OrHash)), temperature: T.nilable(Float), tool_choice: T.nilable(T.any(OpenAI::Beta::AssistantToolChoiceOption::Auto::OrSymbol, OpenAI::Beta::AssistantToolChoice::OrHash)), tools: T.nilable(T::Array[T.any(OpenAI::Beta::CodeInterpreterTool::OrHash, OpenAI::Beta::FileSearchTool::OrHash, OpenAI::Beta::FunctionTool::OrHash)]), top_p: T.nilable(Float), truncation_strategy: T.nilable(OpenAI::Beta::Threads::RunCreateParams::TruncationStrategy::OrHash), stream: T.noreturn, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Beta::Threads::Run]) }
            def create(
              # Path param: The ID of the thread to run.
              thread_id,
              # Body param: The ID of the
            ...
            sig { params(thread_id: String, assistant_id: String, include: T::Array[OpenAI::Beta::Threads::Runs::RunStepInclude::OrSymbol], additional_instructions: T.nilable(String), additional_messages: T.nilable(T::Array[OpenAI::Beta::Threads::RunCreateParams::AdditionalMessage::OrHash]), instructions: T.nilable(String), max_completion_tokens: T.nilable(Integer), max_prompt_tokens: T.nilable(Integer), metadata: T.nilable(T::Hash[Symbol, String]), model: T.nilable(T.any(String, OpenAI::ChatModel::OrSymbol)), parallel_tool_calls: T::Boolean, reasoning_effort: T.nilable(OpenAI::ReasoningEffort::OrSymbol), response_format: T.nilable(T.any(Symbol, OpenAI::ResponseFormatText::OrHash, OpenAI::ResponseFormatJSONObject::OrHash, OpenAI::ResponseFormatJSONSchema::OrHash)), temperature: T.nilable(Float), tool_choice: T.nilable(T.any(OpenAI::Beta::AssistantToolChoiceOption::Auto::OrSymbol, OpenAI::Beta::AssistantToolChoice::OrHash)), tools: T.nilable(T::Array[T.any(OpenAI::Beta::CodeInterpreterTool::OrHash, OpenAI::Beta::FileSearchTool::OrHash, OpenAI::Beta::FunctionTool::OrHash)]), top_p: T.nilable(Float), truncation_strategy: T.nilable(OpenAI::Beta::Threads::RunCreateParams::TruncationStrategy::OrHash), stream: T.noreturn, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Internal::Stream[OpenAI::Beta::AssistantStreamEvent::Variants]]) }
            def create_stream_raw(
              # Path param: The ID of the thread to run.
              thread_id,
              # Body param: The ID of the
            ...
            sig { params(run_id: String, thread_id: String, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Beta::Threads::Run]) }
            def retrieve(
              # The ID of the run to retrieve.
              run_id,
              # The ID of the [thread](https://platform.openai.com/docs/api-reference/threads)
            ...
            sig { params(run_id: String, thread_id: String, metadata: T.nilable(T::Hash[Symbol, String]), request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Beta::Threads::Run]) }
            def update(
              # Path param: The ID of the run to modify.
              run_id,
              # Path param: The ID of the
            ...
            sig { params(thread_id: String, after: String, before: String, limit: Integer, order: OpenAI::Beta::Threads::RunListParams::Order::OrSymbol, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Internal::CursorPage[OpenAI::Beta::Threads::Run]]) }
            def list(
              # The ID of the thread the run belongs to.
              thread_id,
              # A cursor for use in pagination. `after` is an object ID that defines your place
            ...
            sig { params(run_id: String, thread_id: String, tool_outputs: T::Array[OpenAI::Beta::Threads::RunSubmitToolOutputsParams::ToolOutput::OrHash], stream: T.noreturn, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Beta::Threads::Run]) }
            def submit_tool_outputs(
              # Path param: The ID of the run that requires the tool output submission.
              run_id,
              # Path param: The ID of the
            ...
            sig { params(run_id: String, thread_id: String, tool_outputs: T::Array[OpenAI::Beta::Threads::RunSubmitToolOutputsParams::ToolOutput::OrHash], stream: T.noreturn, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Internal::Stream[OpenAI::Beta::AssistantStreamEvent::Variants]]) }
            def submit_tool_outputs_stream_raw(
              # Path param: The ID of the run that requires the tool output submission.
              run_id,
              # Path param: The ID of the
            ...
            # @api private
            sig { params(resource: Runs).returns(T.attached_class) }
