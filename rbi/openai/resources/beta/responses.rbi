    ...
    class Beta
      class Responses
        ...
        class WithRawResponse
          sig { returns(OpenAI::Resources::Beta::Responses::InputItems::WithRawResponse) }
          attr_reader :input_items

          sig { returns(OpenAI::Resources::Beta::Responses::InputTokens::WithRawResponse) }
          attr_reader :input_tokens
          ...
          sig do
            params(
              ...
              stream: T.noreturn,
              request_options: OpenAI::RequestOptions::OrHash
            ).returns(OpenAI::RawResponse[OpenAI::Beta::BetaResponse])
          end
          def create(
            # Body param: Whether to run the model response in the background.
            # [Learn more](https://platform.openai.com/docs/guides/background).
          ...
          sig do
            params(
              ...
              betas: T::Array[OpenAI::Beta::ResponseDeleteParams::Beta::OrSymbol],
              request_options: OpenAI::RequestOptions::OrHash
            ).returns(OpenAI::RawResponse[NilClass])
          end
          def delete(
            # The ID of the response to delete.
            response_id,
          ...
          sig do
            params(
              ...
              betas:
                T::Array[OpenAI::Beta::ResponseCompactParams::Beta::OrSymbol],
              request_options: OpenAI::RequestOptions::OrHash
            ).returns(OpenAI::RawResponse[OpenAI::Beta::BetaCompactedResponse])
          end
          def compact(
            # Body param: Model ID used to generate the response, like `gpt-5` or `o3`. OpenAI
            # offers a wide range of models with different capabilities, performance
