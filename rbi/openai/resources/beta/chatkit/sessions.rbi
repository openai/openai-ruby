...
module OpenAI
  module Resources
    class Beta
      class ChatKit
        class Sessions
          sig { returns(Sessions::WithRawResponse) }
          ...
          class WithRawResponse
            sig { params(user: String, workflow: OpenAI::Beta::ChatKit::ChatSessionWorkflowParam::OrHash, chatkit_configuration: OpenAI::Beta::ChatKit::ChatSessionChatKitConfigurationParam::OrHash, expires_after: OpenAI::Beta::ChatKit::ChatSessionExpiresAfterParam::OrHash, rate_limits: OpenAI::Beta::ChatKit::ChatSessionRateLimitsParam::OrHash, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Beta::ChatKit::ChatSession]) }
            def create(
              # A free-form string that identifies your end user; ensures this Session can
              # access other objects that have the same `user` scope.
              user:,
            ...
            sig { params(session_id: String, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Beta::ChatKit::ChatSession]) }
            def cancel(
              # Unique identifier for the ChatKit session to cancel.
              session_id,
              request_options: {}
            ...
            # @api private
            sig { params(resource: Sessions).returns(T.attached_class) }
