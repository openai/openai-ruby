...
module OpenAI
  module Resources
    ...
    class Images
      sig { returns(Images::WithRawResponse) }
      ...
      class WithRawResponse
        ...
        sig { params(image: OpenAI::ImageEditParams::Image::Variants, prompt: String, background: T.nilable(OpenAI::ImageEditParams::Background::OrSymbol), input_fidelity: T.nilable(OpenAI::ImageEditParams::InputFidelity::OrSymbol), mask: OpenAI::Internal::FileInput, model: T.nilable(T.any(String, OpenAI::ImageModel::OrSymbol)), n: T.nilable(Integer), output_compression: T.nilable(Integer), output_format: T.nilable(OpenAI::ImageEditParams::OutputFormat::OrSymbol), partial_images: T.nilable(Integer), quality: T.nilable(OpenAI::ImageEditParams::Quality::OrSymbol), response_format: T.nilable(OpenAI::ImageEditParams::ResponseFormat::OrSymbol), size: T.nilable(T.any(String, OpenAI::ImageEditParams::Size::OrSymbol)), user: String, stream: T.noreturn, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Internal::Stream[OpenAI::ImageEditStreamEvent::Variants]]) }
        def edit_stream_raw(
          # The image(s) to edit. Must be a supported image file or an array of images.
          #
          # For the GPT image models (`gpt-image-1`, `gpt-image-1-mini`, `gpt-image-1.5`,
        ...
        sig { params(prompt: String, background: T.nilable(OpenAI::ImageGenerateParams::Background::OrSymbol), model: T.nilable(T.any(String, OpenAI::ImageModel::OrSymbol)), moderation: T.nilable(OpenAI::ImageGenerateParams::Moderation::OrSymbol), n: T.nilable(Integer), output_compression: T.nilable(Integer), output_format: T.nilable(OpenAI::ImageGenerateParams::OutputFormat::OrSymbol), partial_images: T.nilable(Integer), quality: T.nilable(OpenAI::ImageGenerateParams::Quality::OrSymbol), response_format: T.nilable(OpenAI::ImageGenerateParams::ResponseFormat::OrSymbol), size: T.nilable(T.any(String, OpenAI::ImageGenerateParams::Size::OrSymbol)), style: T.nilable(OpenAI::ImageGenerateParams::Style::OrSymbol), user: String, stream: T.noreturn, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::ImagesResponse]) }
        def generate(
          # A text description of the desired image(s). The maximum length is 32000
          # characters for the GPT image models, 1000 characters for `dall-e-2` and 4000
          # characters for `dall-e-3`.
        ...
        sig { params(prompt: String, background: T.nilable(OpenAI::ImageGenerateParams::Background::OrSymbol), model: T.nilable(T.any(String, OpenAI::ImageModel::OrSymbol)), moderation: T.nilable(OpenAI::ImageGenerateParams::Moderation::OrSymbol), n: T.nilable(Integer), output_compression: T.nilable(Integer), output_format: T.nilable(OpenAI::ImageGenerateParams::OutputFormat::OrSymbol), partial_images: T.nilable(Integer), quality: T.nilable(OpenAI::ImageGenerateParams::Quality::OrSymbol), response_format: T.nilable(OpenAI::ImageGenerateParams::ResponseFormat::OrSymbol), size: T.nilable(T.any(String, OpenAI::ImageGenerateParams::Size::OrSymbol)), style: T.nilable(OpenAI::ImageGenerateParams::Style::OrSymbol), user: String, stream: T.noreturn, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Internal::Stream[OpenAI::ImageGenStreamEvent::Variants]]) }
        def generate_stream_raw(
          # A text description of the desired image(s). The maximum length is 32000
          # characters for the GPT image models, 1000 characters for `dall-e-2` and 4000
          # characters for `dall-e-3`.
        ...
        # @api private
        sig { params(resource: Images).returns(T.attached_class) }
