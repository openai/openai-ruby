...
module OpenAI
  module Resources
    ...
    class Batches
      sig { returns(Batches::WithRawResponse) }
      ...
      class WithRawResponse
        ...
        sig { params(batch_id: String, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Batch]) }
        def retrieve(
          # The ID of the batch to retrieve.
          batch_id,
          request_options: {}
        ...
        sig { params(after: String, limit: Integer, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Internal::CursorPage[OpenAI::Batch]]) }
        def list(
          # A cursor for use in pagination. `after` is an object ID that defines your place
          # in the list. For instance, if you make a list request and receive 100 objects,
          # ending with obj_foo, your subsequent call can include after=obj_foo in order to
        ...
        # @api private
        sig { params(resource: Batches).returns(T.attached_class) }
