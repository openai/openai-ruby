  ...
  module Resources
    class Evals
      class Runs
        ...
        class OutputItems
          sig { returns(OutputItems::WithRawResponse) }
          ...
          class WithRawResponse
            sig { params(output_item_id: String, eval_id: String, run_id: String, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Models::Evals::Runs::OutputItemRetrieveResponse]) }
            def retrieve(
              # The ID of the output item to retrieve.
              output_item_id,
              # The ID of the evaluation to retrieve runs for.
            ...
            sig { params(run_id: String, eval_id: String, after: String, limit: Integer, order: OpenAI::Evals::Runs::OutputItemListParams::Order::OrSymbol, status: OpenAI::Evals::Runs::OutputItemListParams::Status::OrSymbol, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Internal::CursorPage[OpenAI::Models::Evals::Runs::OutputItemListResponse]]) }
            def list(
              # Path param: The ID of the run to retrieve output items for.
              run_id,
              # Path param: The ID of the evaluation to retrieve runs for.
            ...
            # @api private
            sig { params(resource: OutputItems).returns(T.attached_class) }
