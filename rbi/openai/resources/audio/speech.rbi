...
module OpenAI
  module Resources
    class Audio
      ...
      class Speech
        sig { returns(Speech::WithRawResponse) }
        ...
        class WithRawResponse
          sig { params(input: String, model: T.any(String, OpenAI::Audio::SpeechModel::OrSymbol), voice: T.any(String, OpenAI::Audio::SpeechCreateParams::Voice::OrSymbol, OpenAI::Audio::SpeechCreateParams::Voice::ID::OrHash), instructions: String, response_format: OpenAI::Audio::SpeechCreateParams::ResponseFormat::OrSymbol, speed: Float, stream_format: OpenAI::Audio::SpeechCreateParams::StreamFormat::OrSymbol, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[StringIO]) }
          def create(
            # The text to generate audio for. The maximum length is 4096 characters.
            input:,
            # One of the available [TTS models](https://platform.openai.com/docs/models#tts):
          ...
          # @api private
          sig { params(resource: Speech).returns(T.attached_class) }
