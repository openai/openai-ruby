  ...
  module Resources
    class Audio
      ...
      class Transcriptions
        sig { returns(Transcriptions::WithRawResponse) }
        ...
        class WithRawResponse
          sig { params(file: OpenAI::Internal::FileInput, model: T.any(String, OpenAI::AudioModel::OrSymbol), chunking_strategy: T.nilable(T.any(Symbol, OpenAI::Audio::TranscriptionCreateParams::ChunkingStrategy::VadConfig::OrHash)), include: T::Array[OpenAI::Audio::TranscriptionInclude::OrSymbol], keywords: T::Array[String], known_speaker_names: T::Array[String], known_speaker_references: T::Array[String], language: String, languages: T::Array[String], prompt: String, response_format: OpenAI::AudioResponseFormat::OrSymbol, temperature: Float, timestamp_granularities: T::Array[OpenAI::Audio::TranscriptionCreateParams::TimestampGranularity::OrSymbol], stream: T.noreturn, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Models::Audio::TranscriptionCreateResponse::Variants]) }
          def create(
            # The audio file object (not file name) to transcribe, in one of these formats:
            # flac, mp3, mp4, mpeg, mpga, m4a, ogg, wav, or webm.
            file:,
          ...
          sig { params(file: OpenAI::Internal::FileInput, model: T.any(String, OpenAI::AudioModel::OrSymbol), chunking_strategy: T.nilable(T.any(Symbol, OpenAI::Audio::TranscriptionCreateParams::ChunkingStrategy::VadConfig::OrHash)), include: T::Array[OpenAI::Audio::TranscriptionInclude::OrSymbol], keywords: T::Array[String], known_speaker_names: T::Array[String], known_speaker_references: T::Array[String], language: String, languages: T::Array[String], prompt: String, response_format: OpenAI::AudioResponseFormat::OrSymbol, temperature: Float, timestamp_granularities: T::Array[OpenAI::Audio::TranscriptionCreateParams::TimestampGranularity::OrSymbol], stream: T.noreturn, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Internal::Stream[OpenAI::Audio::TranscriptionStreamEvent::Variants]]) }
          def create_streaming(
            # The audio file object (not file name) to transcribe, in one of these formats:
            # flac, mp3, mp4, mpeg, mpga, m4a, ogg, wav, or webm.
            file:,
          ...
          # @api private
          sig { params(resource: Transcriptions).returns(T.attached_class) }
