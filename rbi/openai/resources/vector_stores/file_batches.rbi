...
module OpenAI
  module Resources
    class VectorStores
      class FileBatches
        sig { returns(FileBatches::WithRawResponse) }
        ...
        class WithRawResponse
          sig { params(vector_store_id: String, attributes: T.nilable(T::Hash[Symbol, OpenAI::VectorStores::FileBatchCreateParams::Attribute::Variants]), chunking_strategy: T.any(OpenAI::AutoFileChunkingStrategyParam::OrHash, OpenAI::StaticFileChunkingStrategyObjectParam::OrHash), file_ids: T::Array[String], files: T::Array[OpenAI::VectorStores::FileBatchCreateParams::File::OrHash], request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::VectorStores::VectorStoreFileBatch]) }
          def create(
            # The ID of the vector store for which to create a File Batch.
            vector_store_id,
            # Set of 16 key-value pairs that can be attached to an object. This can be useful
          ...
          sig { params(batch_id: String, vector_store_id: String, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::VectorStores::VectorStoreFileBatch]) }
          def retrieve(
            # The ID of the file batch being retrieved.
            batch_id,
            # The ID of the vector store that the file batch belongs to.
          ...
          sig { params(batch_id: String, vector_store_id: String, after: String, before: String, filter: OpenAI::VectorStores::FileBatchListFilesParams::Filter::OrSymbol, limit: Integer, order: OpenAI::VectorStores::FileBatchListFilesParams::Order::OrSymbol, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Internal::CursorPage[OpenAI::VectorStores::VectorStoreFile]]) }
          def list_files(
            # Path param: The ID of the file batch that the files belong to.
            batch_id,
            # Path param: The ID of the vector store that the files belong to.
          ...
          # @api private
          sig { params(resource: FileBatches).returns(T.attached_class) }
