...
module OpenAI
  module Resources
    class Conversations
      ...
      class Items
        sig { returns(Items::WithRawResponse) }
        ...
        class WithRawResponse
          sig { params(conversation_id: String, items: T::Array[T.any(OpenAI::Responses::EasyInputMessage::OrHash, OpenAI::Responses::ResponseInputItem::Message::OrHash, OpenAI::Responses::ResponseOutputMessage::OrHash, OpenAI::Responses::ResponseFileSearchToolCall::OrHash, OpenAI::Responses::ResponseComputerToolCall::OrHash, OpenAI::Responses::ResponseInputItem::ComputerCallOutput::OrHash, OpenAI::Responses::ResponseFunctionWebSearch::OrHash, OpenAI::Responses::ResponseFunctionToolCall::OrHash, OpenAI::Responses::ResponseInputItem::FunctionCallOutput::OrHash, OpenAI::Responses::ResponseInputItem::ToolSearchCall::OrHash, OpenAI::Responses::ResponseToolSearchOutputItemParam::OrHash, OpenAI::Responses::ResponseInputItem::AdditionalTools::OrHash, OpenAI::Responses::ResponseReasoningItem::OrHash, OpenAI::Responses::ResponseCompactionItemParam::OrHash, OpenAI::Responses::ResponseInputItem::ImageGenerationCall::OrHash, OpenAI::Responses::ResponseCodeInterpreterToolCall::OrHash, OpenAI::Responses::ResponseInputItem::LocalShellCall::OrHash, OpenAI::Responses::ResponseInputItem::LocalShellCallOutput::OrHash, OpenAI::Responses::ResponseInputItem::ShellCall::OrHash, OpenAI::Responses::ResponseInputItem::ShellCallOutput::OrHash, OpenAI::Responses::ResponseInputItem::ApplyPatchCall::OrHash, OpenAI::Responses::ResponseInputItem::ApplyPatchCallOutput::OrHash, OpenAI::Responses::ResponseInputItem::McpListTools::OrHash, OpenAI::Responses::ResponseInputItem::McpApprovalRequest::OrHash, OpenAI::Responses::ResponseInputItem::McpApprovalResponse::OrHash, OpenAI::Responses::ResponseInputItem::McpCall::OrHash, OpenAI::Responses::ResponseCustomToolCallOutput::OrHash, OpenAI::Responses::ResponseCustomToolCall::OrHash, OpenAI::Responses::ResponseInputItem::CompactionTrigger::OrHash, OpenAI::Responses::ResponseInputItem::ItemReference::OrHash, OpenAI::Responses::ResponseInputItem::Program::OrHash, OpenAI::Responses::ResponseInputItem::ProgramOutput::OrHash)], include: T::Array[OpenAI::Responses::ResponseIncludable::OrSymbol], request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Conversations::ConversationItemList]) }
          def create(
            # Path param: The ID of the conversation to add the item to.
            conversation_id,
            # Body param: The items to add to the conversation. You may add up to 20 items at
          ...
          sig { params(item_id: String, conversation_id: String, include: T::Array[OpenAI::Responses::ResponseIncludable::OrSymbol], request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Conversations::ConversationItem::Variants]) }
          def retrieve(
            # Path param: The ID of the item to retrieve.
            item_id,
            # Path param: The ID of the conversation that contains the item.
          ...
          sig { params(conversation_id: String, after: String, include: T::Array[OpenAI::Responses::ResponseIncludable::OrSymbol], limit: Integer, order: OpenAI::Conversations::ItemListParams::Order::OrSymbol, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Internal::ConversationCursorPage[OpenAI::Conversations::ConversationItem::Variants]]) }
          def list(
            # The ID of the conversation to list items for.
            conversation_id,
            # An item ID to list items after, used in pagination.
          ...
          sig { params(item_id: String, conversation_id: String, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Conversations::Conversation]) }
          def delete(
            # The ID of the item to delete.
            item_id,
            # The ID of the conversation that contains the item.
          ...
          # @api private
          sig { params(resource: Items).returns(T.attached_class) }
