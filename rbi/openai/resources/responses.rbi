...
module OpenAI
  module Resources
    class Responses
      sig { returns(Responses::WithRawResponse) }
      ...
      class WithRawResponse
        sig { returns(OpenAI::Resources::Responses::InputItems::WithRawResponse) }
        attr_reader :input_items

        sig { returns(OpenAI::Resources::Responses::InputTokens::WithRawResponse) }
        attr_reader :input_tokens

        sig { params(background: T.nilable(T::Boolean), context_management: T.nilable(T::Array[OpenAI::Responses::ResponseCreateParams::ContextManagement::OrHash]), conversation: T.nilable(T.any(String, OpenAI::Responses::ResponseConversationParam::OrHash)), include: T.nilable(T::Array[OpenAI::Responses::ResponseIncludable::OrSymbol]), input: OpenAI::Responses::ResponseCreateParams::Input::Variants, instructions: T.nilable(String), max_output_tokens: T.nilable(Integer), max_tool_calls: T.nilable(Integer), metadata: T.nilable(T::Hash[Symbol, String]), model: T.any(String, OpenAI::ChatModel::OrSymbol, OpenAI::ResponsesModel::ResponsesOnlyModel::OrSymbol), moderation: T.nilable(OpenAI::Responses::ResponseCreateParams::Moderation::OrHash), parallel_tool_calls: T.nilable(T::Boolean), previous_response_id: T.nilable(String), prompt: T.nilable(OpenAI::Responses::ResponsePrompt::OrHash), prompt_cache_key: T.nilable(String), prompt_cache_options: OpenAI::Responses::ResponseCreateParams::PromptCacheOptions::OrHash, prompt_cache_retention: T.nilable(OpenAI::Responses::ResponseCreateParams::PromptCacheRetention::OrSymbol), reasoning: T.nilable(OpenAI::Reasoning::OrHash), safety_identifier: T.nilable(String), service_tier: T.nilable(OpenAI::Responses::ResponseCreateParams::ServiceTier::OrSymbol), store: T.nilable(T::Boolean), stream_options: T.nilable(OpenAI::Responses::ResponseCreateParams::StreamOptions::OrHash), temperature: T.nilable(Float), text: OpenAI::Responses::ResponseTextConfig::OrHash, tool_choice: T.any(OpenAI::Responses::ToolChoiceAllowed::OrHash, OpenAI::Responses::ToolChoiceFunction::OrHash, OpenAI::Responses::ToolChoiceMcp::OrHash, OpenAI::Responses::ToolChoiceCustom::OrHash, OpenAI::Responses::ResponseCreateParams::ToolChoice::SpecificProgrammaticToolCallingParam::OrHash, OpenAI::Responses::ToolChoiceApplyPatch::OrHash, OpenAI::Responses::ToolChoiceShell::OrHash, OpenAI::Responses::ToolChoiceOptions::OrSymbol, OpenAI::Responses::ToolChoiceTypes::OrHash), tools: T::Array[T.any(OpenAI::Responses::FunctionTool::OrHash, OpenAI::Responses::FileSearchTool::OrHash, OpenAI::Responses::ComputerTool::OrHash, OpenAI::Responses::ComputerUsePreviewTool::OrHash, OpenAI::Responses::Tool::Mcp::OrHash, OpenAI::Responses::Tool::CodeInterpreter::OrHash, OpenAI::Responses::Tool::ProgrammaticToolCalling::OrHash, OpenAI::Responses::Tool::ImageGeneration::OrHash, OpenAI::Responses::Tool::LocalShell::OrHash, OpenAI::Responses::FunctionShellTool::OrHash, OpenAI::Responses::CustomTool::OrHash, OpenAI::Responses::NamespaceTool::OrHash, OpenAI::Responses::ToolSearchTool::OrHash, OpenAI::Responses::ApplyPatchTool::OrHash, OpenAI::Responses::WebSearchTool::OrHash, OpenAI::Responses::WebSearchPreviewTool::OrHash)], top_logprobs: T.nilable(Integer), top_p: T.nilable(Float), truncation: T.nilable(OpenAI::Responses::ResponseCreateParams::Truncation::OrSymbol), user: String, stream: T.noreturn, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Responses::Response]) }
        def create(
          # Whether to run the model response in the background.
          # [Learn more](https://platform.openai.com/docs/guides/background).
          background: nil,
        ...
        sig { params(background: T.nilable(T::Boolean), context_management: T.nilable(T::Array[OpenAI::Responses::ResponseCreateParams::ContextManagement::OrHash]), conversation: T.nilable(T.any(String, OpenAI::Responses::ResponseConversationParam::OrHash)), include: T.nilable(T::Array[OpenAI::Responses::ResponseIncludable::OrSymbol]), input: OpenAI::Responses::ResponseCreateParams::Input::Variants, instructions: T.nilable(String), max_output_tokens: T.nilable(Integer), max_tool_calls: T.nilable(Integer), metadata: T.nilable(T::Hash[Symbol, String]), model: T.any(String, OpenAI::ChatModel::OrSymbol, OpenAI::ResponsesModel::ResponsesOnlyModel::OrSymbol), moderation: T.nilable(OpenAI::Responses::ResponseCreateParams::Moderation::OrHash), parallel_tool_calls: T.nilable(T::Boolean), previous_response_id: T.nilable(String), prompt: T.nilable(OpenAI::Responses::ResponsePrompt::OrHash), prompt_cache_key: T.nilable(String), prompt_cache_options: OpenAI::Responses::ResponseCreateParams::PromptCacheOptions::OrHash, prompt_cache_retention: T.nilable(OpenAI::Responses::ResponseCreateParams::PromptCacheRetention::OrSymbol), reasoning: T.nilable(OpenAI::Reasoning::OrHash), safety_identifier: T.nilable(String), service_tier: T.nilable(OpenAI::Responses::ResponseCreateParams::ServiceTier::OrSymbol), store: T.nilable(T::Boolean), stream_options: T.nilable(OpenAI::Responses::ResponseCreateParams::StreamOptions::OrHash), temperature: T.nilable(Float), text: OpenAI::Responses::ResponseTextConfig::OrHash, tool_choice: T.any(OpenAI::Responses::ToolChoiceAllowed::OrHash, OpenAI::Responses::ToolChoiceFunction::OrHash, OpenAI::Responses::ToolChoiceMcp::OrHash, OpenAI::Responses::ToolChoiceCustom::OrHash, OpenAI::Responses::ResponseCreateParams::ToolChoice::SpecificProgrammaticToolCallingParam::OrHash, OpenAI::Responses::ToolChoiceApplyPatch::OrHash, OpenAI::Responses::ToolChoiceShell::OrHash, OpenAI::Responses::ToolChoiceOptions::OrSymbol, OpenAI::Responses::ToolChoiceTypes::OrHash), tools: T::Array[T.any(OpenAI::Responses::FunctionTool::OrHash, OpenAI::Responses::FileSearchTool::OrHash, OpenAI::Responses::ComputerTool::OrHash, OpenAI::Responses::ComputerUsePreviewTool::OrHash, OpenAI::Responses::Tool::Mcp::OrHash, OpenAI::Responses::Tool::CodeInterpreter::OrHash, OpenAI::Responses::Tool::ProgrammaticToolCalling::OrHash, OpenAI::Responses::Tool::ImageGeneration::OrHash, OpenAI::Responses::Tool::LocalShell::OrHash, OpenAI::Responses::FunctionShellTool::OrHash, OpenAI::Responses::CustomTool::OrHash, OpenAI::Responses::NamespaceTool::OrHash, OpenAI::Responses::ToolSearchTool::OrHash, OpenAI::Responses::ApplyPatchTool::OrHash, OpenAI::Responses::WebSearchTool::OrHash, OpenAI::Responses::WebSearchPreviewTool::OrHash)], top_logprobs: T.nilable(Integer), top_p: T.nilable(Float), truncation: T.nilable(OpenAI::Responses::ResponseCreateParams::Truncation::OrSymbol), user: String, stream: T.noreturn, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Internal::Stream[OpenAI::Responses::ResponseStreamEvent::Variants]]) }
        def stream_raw(
          # Whether to run the model response in the background.
          # [Learn more](https://platform.openai.com/docs/guides/background).
          background: nil,
        ...
        sig { params(response_id: String, include: T::Array[OpenAI::Responses::ResponseIncludable::OrSymbol], include_obfuscation: T::Boolean, starting_after: Integer, stream: T.noreturn, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Responses::Response]) }
        def retrieve(
          # The ID of the response to retrieve.
          response_id,
          # Additional fields to include in the response. See the `include` parameter for
        ...
        sig { params(response_id: String, include: T::Array[OpenAI::Responses::ResponseIncludable::OrSymbol], include_obfuscation: T::Boolean, starting_after: Integer, stream: T.noreturn, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Internal::Stream[OpenAI::Responses::ResponseStreamEvent::Variants]]) }
        def retrieve_streaming(
          # The ID of the response to retrieve.
          response_id,
          # Additional fields to include in the response. See the `include` parameter for
        ...
        sig { params(response_id: String, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[NilClass]) }
        def delete(
          # The ID of the response to delete.
          response_id,
          request_options: {}
        ...
        sig { params(response_id: String, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Responses::Response]) }
        def cancel(
          # The ID of the response to cancel.
          response_id,
          request_options: {}
        ...
        sig { params(model: T.nilable(T.any(OpenAI::Responses::ResponseCompactParams::Model::OrSymbol, String)), input: T.nilable(OpenAI::Responses::ResponseCompactParams::Input::Variants), instructions: T.nilable(String), previous_response_id: T.nilable(String), prompt_cache_key: T.nilable(String), prompt_cache_options: T.nilable(OpenAI::Responses::ResponseCompactParams::PromptCacheOptions::OrHash), prompt_cache_retention: T.nilable(OpenAI::Responses::ResponseCompactParams::PromptCacheRetention::OrSymbol), service_tier: T.nilable(OpenAI::Responses::ResponseCompactParams::ServiceTier::OrSymbol), request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Responses::CompactedResponse]) }
        def compact(
          # Model ID used to generate the response, like `gpt-5` or `o3`. OpenAI offers a
          # wide range of models with different capabilities, performance characteristics,
          # and price points. Refer to the
        ...
        # @api private
        sig { params(resource: Responses).returns(T.attached_class) }
