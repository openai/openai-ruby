...
module OpenAI
  module Resources
    class Chat
      ...
      # response.
      class Completions
        sig { returns(Completions::WithRawResponse) }
        ...
        class WithRawResponse
          ...
          sig { params(messages: T::Array[T.any(OpenAI::Chat::ChatCompletionDeveloperMessageParam::OrHash, OpenAI::Chat::ChatCompletionSystemMessageParam::OrHash, OpenAI::Chat::ChatCompletionUserMessageParam::OrHash, OpenAI::Chat::ChatCompletionAssistantMessageParam::OrHash, OpenAI::Chat::ChatCompletionToolMessageParam::OrHash, OpenAI::Chat::ChatCompletionFunctionMessageParam::OrHash)], model: T.any(String, OpenAI::ChatModel::OrSymbol), audio: T.nilable(OpenAI::Chat::ChatCompletionAudioParam::OrHash), frequency_penalty: T.nilable(Float), function_call: T.any(OpenAI::Chat::CompletionCreateParams::FunctionCall::FunctionCallMode::OrSymbol, OpenAI::Chat::ChatCompletionFunctionCallOption::OrHash), functions: T::Array[OpenAI::Chat::CompletionCreateParams::Function::OrHash], logit_bias: T.nilable(T::Hash[Symbol, Integer]), logprobs: T.nilable(T::Boolean), max_completion_tokens: T.nilable(Integer), max_tokens: T.nilable(Integer), metadata: T.nilable(T::Hash[Symbol, String]), modalities: T.nilable(T::Array[OpenAI::Chat::CompletionCreateParams::Modality::OrSymbol]), moderation: T.nilable(OpenAI::Chat::CompletionCreateParams::Moderation::OrHash), n: T.nilable(Integer), parallel_tool_calls: T::Boolean, prediction: T.nilable(OpenAI::Chat::ChatCompletionPredictionContent::OrHash), presence_penalty: T.nilable(Float), prompt_cache_key: T.nilable(String), prompt_cache_options: OpenAI::Chat::CompletionCreateParams::PromptCacheOptions::OrHash, prompt_cache_retention: T.nilable(OpenAI::Chat::CompletionCreateParams::PromptCacheRetention::OrSymbol), reasoning_effort: T.nilable(OpenAI::ReasoningEffort::OrSymbol), response_format: T.any(OpenAI::ResponseFormatText::OrHash, OpenAI::ResponseFormatJSONSchema::OrHash, OpenAI::ResponseFormatJSONObject::OrHash), safety_identifier: T.nilable(String), seed: T.nilable(Integer), service_tier: T.nilable(OpenAI::Chat::CompletionCreateParams::ServiceTier::OrSymbol), stop: T.nilable(OpenAI::Chat::CompletionCreateParams::Stop::Variants), store: T.nilable(T::Boolean), stream_options: T.nilable(OpenAI::Chat::ChatCompletionStreamOptions::OrHash), temperature: T.nilable(Float), tool_choice: T.any(OpenAI::Chat::ChatCompletionToolChoiceOption::Auto::OrSymbol, OpenAI::Chat::ChatCompletionAllowedToolChoice::OrHash, OpenAI::Chat::ChatCompletionNamedToolChoice::OrHash, OpenAI::Chat::ChatCompletionNamedToolChoiceCustom::OrHash), tools: T::Array[T.any(OpenAI::Chat::ChatCompletionFunctionTool::OrHash, OpenAI::Chat::ChatCompletionCustomTool::OrHash)], top_logprobs: T.nilable(Integer), top_p: T.nilable(Float), user: String, verbosity: T.nilable(OpenAI::Chat::CompletionCreateParams::Verbosity::OrSymbol), web_search_options: OpenAI::Chat::CompletionCreateParams::WebSearchOptions::OrHash, stream: T.noreturn, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Internal::Stream[OpenAI::Chat::ChatCompletionChunk]]) }
          def stream_raw(
            # A list of messages comprising the conversation so far. Depending on the
            # [model](https://platform.openai.com/docs/models) you use, different message
            # types (modalities) are supported, like
          ...
          sig { params(completion_id: String, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Chat::ChatCompletion]) }
          def retrieve(
            # The ID of the chat completion to retrieve.
            completion_id,
            request_options: {}
          ...
          sig { params(completion_id: String, metadata: T.nilable(T::Hash[Symbol, String]), request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Chat::ChatCompletion]) }
          def update(
            # The ID of the chat completion to update.
            completion_id,
            # Set of 16 key-value pairs that can be attached to an object. This can be useful
          ...
          sig { params(after: String, limit: Integer, metadata: T.nilable(T::Hash[Symbol, String]), model: String, order: OpenAI::Chat::CompletionListParams::Order::OrSymbol, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Internal::CursorPage[OpenAI::Chat::ChatCompletion]]) }
          def list(
            # Identifier for the last chat completion from the previous pagination request.
            after: nil,
            # Number of Chat Completions to retrieve.
          ...
          sig { params(completion_id: String, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Chat::ChatCompletionDeleted]) }
          def delete(
            # The ID of the chat completion to delete.
            completion_id,
            request_options: {}
          ...
          # @api private
          sig { params(resource: Completions).returns(T.attached_class) }
