  ...
  module Resources
    class Admin
      class Organization
        class Projects
          class RateLimits
            sig { returns(RateLimits::WithRawResponse) }
            ...
            class WithRawResponse
              sig { params(project_id: String, after: String, before: String, limit: Integer, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Internal::ConversationCursorPage[OpenAI::Admin::Organization::Projects::ProjectRateLimit]]) }
              def list_rate_limits(
                # The ID of the project.
                project_id,
                # A cursor for use in pagination. `after` is an object ID that defines your place
              ...
              sig { params(rate_limit_id: String, project_id: String, batch_1_day_max_input_tokens: Integer, max_audio_megabytes_per_1_minute: Integer, max_images_per_1_minute: Integer, max_requests_per_1_day: Integer, max_requests_per_1_minute: Integer, max_tokens_per_1_minute: Integer, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Admin::Organization::Projects::ProjectRateLimit]) }
              def update_rate_limit(
                # Path param: The ID of the rate limit.
                rate_limit_id,
                # Path param: The ID of the project.
              ...
              # @api private
              sig { params(resource: RateLimits).returns(T.attached_class) }
