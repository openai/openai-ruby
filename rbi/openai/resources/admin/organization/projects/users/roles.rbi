          ...
          class Users
            class Roles
              ...
              class WithRawResponse
                sig { params(user_id: String, project_id: String, role_id: String, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Models::Admin::Organization::Projects::Users::RoleCreateResponse]) }
                def create(
                  # Path param: The ID of the user that should receive the project role.
                  user_id,
                  # Path param: The ID of the project to update.
                ...
                sig { params(role_id: String, project_id: String, user_id: String, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Models::Admin::Organization::Projects::Users::RoleRetrieveResponse]) }
                def retrieve(
                  # The ID of the project role to retrieve for the user.
                  role_id,
                  # The ID of the project to inspect.
                ...
                sig { params(user_id: String, project_id: String, after: String, limit: Integer, order: OpenAI::Admin::Organization::Projects::Users::RoleListParams::Order::OrSymbol, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Internal::NextCursorPage[OpenAI::Models::Admin::Organization::Projects::Users::RoleListResponse]]) }
                def list(
                  # Path param: The ID of the user to inspect.
                  user_id,
                  # Path param: The ID of the project to inspect.
                ...
                sig { params(role_id: String, project_id: String, user_id: String, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Models::Admin::Organization::Projects::Users::RoleDeleteResponse]) }
                def delete(
                  # The ID of the project role to remove from the user.
                  role_id,
                  # The ID of the project to modify.
