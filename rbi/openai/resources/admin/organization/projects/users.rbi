      ...
      class Organization
        ...
        class Projects
          ...
          class Users
            ...
            sig { returns(OpenAI::Resources::Admin::Organization::Projects::Users::Roles) }
            attr_reader :roles
            ...
            sig {
              params(user_id: String, project_id: String, request_options: OpenAI::RequestOptions::OrHash).returns(
            ...
            sig {
              params(project_id: String, after: String, limit: Integer, request_options: OpenAI::RequestOptions::OrHash)
                .returns(OpenAI::Internal::ConversationCursorPage[OpenAI::Admin::Organization::Projects::ProjectUser])
            }
            def list(
              # The ID of the project.
              project_id,
