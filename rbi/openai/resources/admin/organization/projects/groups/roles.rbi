          ...
          class Groups
            class Roles
              ...
              class WithRawResponse
                sig { params(group_id: String, project_id: String, role_id: String, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Models::Admin::Organization::Projects::Groups::RoleCreateResponse]) }
                def create(
                  # Path param: The ID of the group that should receive the project role.
                  group_id,
                  # Path param: The ID of the project to update.
                ...
                sig { params(role_id: String, project_id: String, group_id: String, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Models::Admin::Organization::Projects::Groups::RoleRetrieveResponse]) }
                def retrieve(
                  # The ID of the project role to retrieve for the group.
                  role_id,
                  # The ID of the project to inspect.
                ...
                sig { params(group_id: String, project_id: String, after: String, limit: Integer, order: OpenAI::Admin::Organization::Projects::Groups::RoleListParams::Order::OrSymbol, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Internal::NextCursorPage[OpenAI::Models::Admin::Organization::Projects::Groups::RoleListResponse]]) }
                def list(
                  # Path param: The ID of the group to inspect.
                  group_id,
                  # Path param: The ID of the project to inspect.
                ...
                sig { params(role_id: String, project_id: String, group_id: String, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Models::Admin::Organization::Projects::Groups::RoleDeleteResponse]) }
                def delete(
                  # The ID of the project role to remove from the group.
                  role_id,
                  # The ID of the project to modify.
