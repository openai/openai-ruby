  ...
  module Resources
    class Admin
      class Organization
        ...
        class AuditLogs
          sig { returns(AuditLogs::WithRawResponse) }
          ...
          class WithRawResponse
            sig { params(actor_emails: T::Array[String], actor_ids: T::Array[String], after: String, before: String, effective_at: OpenAI::Admin::Organization::AuditLogListParams::EffectiveAt::OrHash, event_types: T::Array[OpenAI::Admin::Organization::AuditLogListParams::EventType::OrSymbol], limit: Integer, project_ids: T::Array[String], resource_ids: T::Array[String], tenant_only: T::Boolean, request_options: OpenAI::RequestOptions::OrHash).returns(OpenAI::RawResponse[OpenAI::Internal::ConversationCursorPage[OpenAI::Models::Admin::Organization::AuditLogListResponse]]) }
            def list(
              # Return only events performed by users with these emails.
              actor_emails: nil,
              # Return only events performed by these actors. Can be a user ID, a service
            ...
            # @api private
            sig { params(resource: AuditLogs).returns(T.attached_class) }
