  ...
  module Models
    module Beta
      class VectorStore < OpenAI::BaseModel
        ...
        sig { returns(OpenAI::Models::Beta::VectorStore::FileCounts) }
        def file_counts
        end

        sig do
          params(_: OpenAI::Models::Beta::VectorStore::FileCounts)
            .returns(OpenAI::Models::Beta::VectorStore::FileCounts)
        end
        def file_counts=(_)
        end
        ...
        sig { returns(T.nilable(OpenAI::Models::Beta::VectorStore::ExpiresAfter)) }
        def expires_after
        end

        sig do
          params(_: OpenAI::Models::Beta::VectorStore::ExpiresAfter)
            .returns(OpenAI::Models::Beta::VectorStore::ExpiresAfter)
        end
        def expires_after=(_)
        end
