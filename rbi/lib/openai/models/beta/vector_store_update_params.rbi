  ...
  module Models
    module Beta
      class VectorStoreUpdateParams < OpenAI::BaseModel
        ...
        sig { returns(T.nilable(OpenAI::Models::Beta::VectorStoreUpdateParams::ExpiresAfter)) }
        def expires_after
        end

        sig do
          params(_: T.nilable(OpenAI::Models::Beta::VectorStoreUpdateParams::ExpiresAfter))
            .returns(T.nilable(OpenAI::Models::Beta::VectorStoreUpdateParams::ExpiresAfter))
        end
        def expires_after=(_)
        end
