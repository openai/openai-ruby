  ...
  module Models
    module Beta
      class VectorStoreCreateParams < OpenAI::BaseModel
        ...
        sig { returns(T.nilable(OpenAI::Models::Beta::VectorStoreCreateParams::ExpiresAfter)) }
        def expires_after
        end

        sig do
          params(_: OpenAI::Models::Beta::VectorStoreCreateParams::ExpiresAfter)
            .returns(OpenAI::Models::Beta::VectorStoreCreateParams::ExpiresAfter)
        end
        def expires_after=(_)
        end
