    ...
    module Beta
      ...
      module VectorStores
        class VectorStoreFileBatch < OpenAI::BaseModel
          ...
          sig { returns(OpenAI::Models::Beta::VectorStores::VectorStoreFileBatch::FileCounts) }
          def file_counts
          end

          sig do
            params(_: OpenAI::Models::Beta::VectorStores::VectorStoreFileBatch::FileCounts)
              .returns(OpenAI::Models::Beta::VectorStores::VectorStoreFileBatch::FileCounts)
          end
          def file_counts=(_)
          end
