    ...
    class EvalCreateResponse < OpenAI::Internal::Type::BaseModel
      ...
      module TestingCriterion
        ...
        class ScoreModel < OpenAI::Internal::Type::BaseModel
          ...
          sig { returns(T::Array[OpenAI::Models::EvalCreateResponse::TestingCriterion::ScoreModel::Input]) }
          attr_accessor :input
          ...
          sig do
            params(
              input: T::Array[T.any(OpenAI::Models::EvalCreateResponse::TestingCriterion::ScoreModel::Input, OpenAI::Internal::AnyHash)],
              model: String,
              name: String,
              pass_threshold: Float,
              range: T::Array[Float],
          ...
          sig do
            override
              .returns(
                {
                  input: T::Array[OpenAI::Models::EvalCreateResponse::TestingCriterion::ScoreModel::Input],
                  model: String,
                  name: String,
                  type: Symbol,
                  pass_threshold: Float,
          ...
          class Input < OpenAI::Internal::Type::BaseModel
            ...
            # `developer`.
            sig { returns(OpenAI::Models::EvalCreateResponse::TestingCriterion::ScoreModel::Input::Role::TaggedSymbol) }
            attr_accessor :role

            # The type of the message input. Always `message`.
            sig do
              returns(
                T.nilable(OpenAI::Models::EvalCreateResponse::TestingCriterion::ScoreModel::Input::Type::TaggedSymbol)
              )
            end
            attr_reader :type

            sig { params(type: OpenAI::Models::EvalCreateResponse::TestingCriterion::ScoreModel::Input::Type::OrSymbol).void }
            attr_writer :type
            ...
            sig do
              params(
                ...
                role: OpenAI::Models::EvalCreateResponse::TestingCriterion::ScoreModel::Input::Role::OrSymbol,
                type: OpenAI::Models::EvalCreateResponse::TestingCriterion::ScoreModel::Input::Type::OrSymbol
              )
                .returns(T.attached_class)
            end
                ...
                .returns(
                  {
                    ...
                    role: OpenAI::Models::EvalCreateResponse::TestingCriterion::ScoreModel::Input::Role::TaggedSymbol,
                    type: OpenAI::Models::EvalCreateResponse::TestingCriterion::ScoreModel::Input::Type::TaggedSymbol
                  }
                )
            end
            def to_hash; end
            ...
            module Content
              ...
              sig do
                override
                  .returns(
                    [String, OpenAI::Models::Responses::ResponseInputText, OpenAI::Models::EvalCreateResponse::TestingCriterion::ScoreModel::Input::Content::OutputText]
                  )
              end
              def self.variants; end
            end
            ...
            module Role
              ...
              TaggedSymbol =
                T.type_alias { T.all(Symbol, OpenAI::Models::EvalCreateResponse::TestingCriterion::ScoreModel::Input::Role) }
              ...
              sig do
                override
                  .returns(
                    T::Array[OpenAI::Models::EvalCreateResponse::TestingCriterion::ScoreModel::Input::Role::TaggedSymbol]
                  )
              end
              def self.values; end
            end
            ...
            module Type
              ...
              TaggedSymbol =
                T.type_alias { T.all(Symbol, OpenAI::Models::EvalCreateResponse::TestingCriterion::ScoreModel::Input::Type) }
              OrSymbol = T.type_alias { T.any(Symbol, String) }
              ...
              sig do
                override
                  .returns(
                    T::Array[OpenAI::Models::EvalCreateResponse::TestingCriterion::ScoreModel::Input::Type::TaggedSymbol]
                  )
              end
              def self.values; end
            end
        ...
        sig do
          override
            .returns(
              [OpenAI::Models::EvalLabelModelGrader, OpenAI::Models::EvalStringCheckGrader, OpenAI::Models::EvalTextSimilarityGrader, OpenAI::Models::EvalCreateResponse::TestingCriterion::Python, OpenAI::Models::EvalCreateResponse::TestingCriterion::ScoreModel]
            )
        end
        def self.variants; end
      end
